...
spain.features = spain.features.map(f => {
    f.properties.clipped_strict = strictOuterCheck(f.geometry.coordinates, f.properties._tile, 512);
    return f
})

console.log('spain:', spain.features.filter(f => f.properties.clipped_strict).length, spain.features.length);
