const hn = 23283064365386963e-26, kn = 12, fn = typeof TextDecoder > "u" ? null : new TextDecoder("utf-8"), Q = 0, J = 1, K = 2, W = 5;
class Tn {
  /**
   ...
   * @param {number} [end]
   */
  readFields(n, e, s = this.length) {
    for (; this.pos < s; ) {
      const i = this.readVarint(), u = i >> 3, l = this.pos;
      this.type = i & 7, n(u, e, this), this.pos === l && this.skip(i);
    }
    return e;
  }
  /**
  ...
  readVarint(n) {
    const e = this.buf;
    let s, i;
    return i = e[this.pos++], s = i & 127, i < 128 || (i = e[this.pos++], s |= (i & 127) << 7, i < 128) || (i = e[this.pos++], s |= (i & 127) << 14, i < 128) || (i = e[this.pos++], s |= (i & 127) << 21, i < 128) ? s : (i = e[this.pos], s |= (i & 15) << 28, Nn(s, n, this));
  }
  readVarint64() {
  ...
  readString() {
    ...
    return this.pos = n, n - e >= kn && fn ? fn.decode(this.buf.subarray(e, n)) : zn(this.buf, e, n);
  }
  readBytes() {
  ...
  readPackedVarint(n = [], e) {
    ...
    for (; this.pos < s; ) n.push(this.readVarint(e));
    return n;
  }
  /** @param {number[]} [arr] */
  readPackedSVarint(n = []) {
  ...
  readPackedEnd() {
    return this.type === K ? this.readVarint() + this.pos : this.pos + 1;
  }
  /** @param {number} val */
  skip(n) {
    const e = n & 7;
    if (e === Q) for (; this.buf[this.pos++] > 127; )
      ;
    else if (e === K) this.pos = this.readVarint() + this.pos;
    else if (e === W) this.pos += 4;
    else if (e === J) this.pos += 8;
  ...
  realloc(n) {
    ...
    if (e !== this.length) {
      ...
      s.set(this.buf), this.buf = s, this.dataView = new DataView(s.buffer), this.length = e;
    }
  }
  finish() {
  ...
  /** @param {number} val */
  writeFixed64(n) {
    this.realloc(8), this.dataView.setInt32(this.pos, n & -1, !0), this.dataView.setInt32(this.pos + 4, Math.floor(n * hn), !0), this.pos += 8;
  }
  /** @param {number} val */
  writeSFixed64(n) {
    this.realloc(8), this.dataView.setInt32(this.pos, n & -1, !0), this.dataView.setInt32(this.pos + 4, Math.floor(n * hn), !0), this.pos += 8;
  ...
  writeString(n) {
    ...
    const e = this.pos;
    this.pos = Kn(this.buf, n, this.pos);
    const s = this.pos - e;
    s >= 128 && cn(e, s, this), this.pos = e - 1, this.writeVarint(s), this.pos += s;
  }
  /** @param {number} val */
  writeFloat(n) {
  ...
  writeBytes(n) {
    ...
    for (let s = 0; s < e; s++) this.buf[this.pos++] = n[s];
  }
  /**
   * @template T
  ...
  writeRawMessage(n, e) {
    ...
    n(e, this);
    const i = this.pos - s;
    i >= 128 && cn(s, i, this), this.pos = s - 1, this.writeVarint(i), this.pos += i;
  }
  /**
   * @template T
   * @param {number} tag
   ...
   */
  writeMessage(n, e, s) {
    this.writeTag(n, K), this.writeRawMessage(e, s);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedVarint(n, e) {
    e.length && this.writeMessage(n, Cn, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedSVarint(n, e) {
    e.length && this.writeMessage(n, Vn, e);
  }
  /**
   * @param {number} tag
   * @param {boolean[]} arr
  ...
  writePackedBoolean(n, e) {
    e.length && this.writeMessage(n, Dn, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedFloat(n, e) {
    e.length && this.writeMessage(n, In, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedDouble(n, e) {
    e.length && this.writeMessage(n, Gn, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedFixed32(n, e) {
    e.length && this.writeMessage(n, Un, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedSFixed32(n, e) {
    e.length && this.writeMessage(n, qn, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedFixed64(n, e) {
    e.length && this.writeMessage(n, Hn, e);
  }
  /**
   * @param {number} tag
   * @param {number[]} arr
  ...
  writePackedSFixed64(n, e) {
    e.length && this.writeMessage(n, jn, e);
  }
  /**
   * @param {number} tag
   * @param {Uint8Array} buffer
   */
  writeBytesField(n, e) {
    this.writeTag(n, K), this.writeBytes(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeFixed32Field(n, e) {
    this.writeTag(n, W), this.writeFixed32(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeSFixed32Field(n, e) {
    this.writeTag(n, W), this.writeSFixed32(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeFixed64Field(n, e) {
    this.writeTag(n, J), this.writeFixed64(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeSFixed64Field(n, e) {
    this.writeTag(n, J), this.writeSFixed64(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeVarintField(n, e) {
    this.writeTag(n, Q), this.writeVarint(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeSVarintField(n, e) {
    this.writeTag(n, Q), this.writeSVarint(e);
  }
  /**
   * @param {number} tag
   * @param {string} str
  ...
  writeStringField(n, e) {
    this.writeTag(n, K), this.writeString(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
   */
  writeFloatField(n, e) {
    this.writeTag(n, W), this.writeFloat(e);
  }
  /**
   * @param {number} tag
   * @param {number} val
  ...
  writeDoubleField(n, e) {
    this.writeTag(n, J), this.writeDouble(e);
  }
  /**
   * @param {number} tag
   * @param {boolean} val
...
function Nn(r, n, e) {
  const s = e.buf;
  let i, u;
  if (u = s[e.pos++], i = (u & 112) >> 4, u < 128 || (u = s[e.pos++], i |= (u & 127) << 3, u < 128) || (u = s[e.pos++], i |= (u & 127) << 10, u < 128) || (u = s[e.pos++], i |= (u & 127) << 17, u < 128) || (u = s[e.pos++], i |= (u & 127) << 24, u < 128) || (u = s[e.pos++], i |= (u & 1) << 31, u < 128)) return q(r, i, n);
  throw new Error("Expected varint not more than 10 bytes");
}
function q(r, n, e) {
  return e ? n * 4294967296 + (r >>> 0) : (n >>> 0) * 4294967296 + (r >>> 0);
}
function Bn(r, n) {
  let e, s;
  if (r >= 0 ? (e = r % 4294967296 | 0, s = r / 4294967296 | 0) : (e = ~(-r % 4294967296), s = ~(-r / 4294967296), e ^ 4294967295 ? e = e + 1 | 0 : (e = 0, s = s + 1 | 0)), r >= 18446744073709552e3 || r < -18446744073709552e3)
    throw new Error("Given varint doesn't fit into 10 bytes");
  n.realloc(10), On(e, s, n), Rn(s, n);
}
function On(r, n, e) {
  e.buf[e.pos++] = r & 127 | 128, r >>>= 7, e.buf[e.pos++] = r & 127 | 128, r >>>= 7, e.buf[e.pos++] = r & 127 | 128, r >>>= 7, e.buf[e.pos++] = r & 127 | 128, r >>>= 7, e.buf[e.pos] = r & 127;
}
function Rn(r, n) {
  const e = (r & 7) << 4;
  n.buf[n.pos++] |= e | ((r >>>= 3) ? 128 : 0), r && (n.buf[n.pos++] = r & 127 | ((r >>>= 7) ? 128 : 0), r && (n.buf[n.pos++] = r & 127 | ((r >>>= 7) ? 128 : 0), r && (n.buf[n.pos++] = r & 127 | ((r >>>= 7) ? 128 : 0), r && (n.buf[n.pos++] = r & 127 | ((r >>>= 7) ? 128 : 0), r && (n.buf[n.pos++] = r & 127)))));
}
function cn(r, n, e) {
  const s = n <= 16383 ? 1 : n <= 2097151 ? 2 : n <= 268435455 ? 3 : Math.floor(Math.log(n) / (Math.LN2 * 7));
  e.realloc(s);
  for (let i = e.pos - 1; i >= r; i--) e.buf[i + s] = e.buf[i];
}
function Cn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeVarint(r[e]);
}
function Vn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeSVarint(r[e]);
}
function In(r, n) {
  for (let e = 0; e < r.length; e++) n.writeFloat(r[e]);
}
function Gn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeDouble(r[e]);
}
function Dn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeBoolean(r[e]);
}
function Un(r, n) {
  for (let e = 0; e < r.length; e++) n.writeFixed32(r[e]);
}
function qn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeSFixed32(r[e]);
}
function Hn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeFixed64(r[e]);
}
function jn(r, n) {
  for (let e = 0; e < r.length; e++) n.writeSFixed64(r[e]);
}
function zn(r, n, e) {
  let s = "", i = n;
  for (; i < e; ) {
    const u = r[i];
    let l = null, c = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
    if (i + c > e) break;
    let p, y, g;
    c === 1 ? u < 128 && (l = u) : c === 2 ? (p = r[i + 1], (p & 192) === 128 && (l = (u & 31) << 6 | p & 63, l <= 127 && (l = null))) : c === 3 ? (p = r[i + 1], y = r[i + 2], (p & 192) === 128 && (y & 192) === 128 && (l = (u & 15) << 12 | (p & 63) << 6 | y & 63, (l <= 2047 || l >= 55296 && l <= 57343) && (l = null))) : c === 4 && (p = r[i + 1], y = r[i + 2], g = r[i + 3], (p & 192) === 128 && (y & 192) === 128 && (g & 192) === 128 && (l = (u & 15) << 18 | (p & 63) << 12 | (y & 63) << 6 | g & 63, (l <= 65535 || l >= 1114112) && (l = null))), l === null ? (l = 65533, c = 1) : l > 65535 && (l -= 65536, s += String.fromCharCode(l >>> 10 & 1023 | 55296), l = 56320 | l & 1023), s += String.fromCharCode(l), i += c;
  }
  return s;
}
function Kn(r, n, e) {
  for (let s = 0, i, u; s < n.length; s++) {
    if (i = n.charCodeAt(s), i > 55295 && i < 57344)
      if (u)
        if (i < 56320) {
          r[e++] = 239, r[e++] = 191, r[e++] = 189, u = i;
          continue;
        } else
          i = u - 55296 << 10 | i - 56320 | 65536, u = null;
      else {
        i > 56319 || s + 1 === n.length ? (r[e++] = 239, r[e++] = 191, r[e++] = 189) : u = i;
        continue;
      }
    else u && (r[e++] = 239, r[e++] = 191, r[e++] = 189, u = null);
    i < 128 ? r[e++] = i : (i < 2048 ? r[e++] = i >> 6 | 192 : (i < 65536 ? r[e++] = i >> 12 | 224 : (r[e++] = i >> 18 | 240, r[e++] = i >> 12 & 63 | 128), r[e++] = i >> 6 & 63 | 128), r[e++] = i & 63 | 128);
  }
  return e;
}
function I(r, n) {
...
I.prototype = {
   ...
   */
  rotateAround(r, n) {
    return this.clone()._rotateAround(r, n);
  },
  /**
   ...
   */
  distSqr(r) {
    const n = r.x - this.x, e = r.y - this.y;
    return n * n + e * e;
  },
  /**
  ...
  _matMult(r) {
    const n = r[0] * this.x + r[1] * this.y, e = r[2] * this.x + r[3] * this.y;
  ...
  /** @param {number} angle */
  _rotate(r) {
    const n = Math.cos(r), e = Math.sin(r), s = n * this.x - e * this.y, i = e * this.x + n * this.y;
   ...
   */
  _rotateAround(r, n) {
    const e = Math.cos(r), s = Math.sin(r), i = n.x + e * (this.x - n.x) - s * (this.y - n.y), u = n.y + s * (this.x - n.x) + e * (this.y - n.y);
    return this.x = i, this.y = u, this;
  },
  _round() {
...
class _n {
   ...
   */
  constructor(n, e, s, i, u) {
    this.properties = {}, this.extent = s, this.type = 0, this.id = void 0, this._pbf = n, this._geometry = -1, this._keys = i, this._values = u, n.readFields($n, this, e);
  }
  loadGeometry() {
    const n = this._pbf;
    n.pos = this._geometry;
    const e = n.readVarint() + n.pos, s = [];
    let i, u = 1, l = 0, c = 0, p = 0;
    for (; n.pos < e; ) {
      if (l <= 0) {
        const y = n.readVarint();
        u = y & 7, l = y >> 3;
      }
      if (l--, u === 1 || u === 2)
        c += n.readSVarint(), p += n.readSVarint(), u === 1 && (i && s.push(i), i = []), i && i.push(new I(c, p));
      else if (u === 7)
        i && i.push(i[0].clone());
      else
  ...
  bbox() {
    ...
    let s = 1, i = 0, u = 0, l = 0, c = 1 / 0, p = -1 / 0, y = 1 / 0, g = -1 / 0;
    for (; n.pos < e; ) {
      if (i <= 0) {
        const x = n.readVarint();
        s = x & 7, i = x >> 3;
      }
      if (i--, s === 1 || s === 2)
        u += n.readSVarint(), l += n.readSVarint(), u < c && (c = u), u > p && (p = u), l < y && (y = l), l > g && (g = l);
      else if (s !== 7)
   ...
   */
  toGeoJSON(n, e, s) {
    const i = this.extent * Math.pow(2, s), u = this.extent * n, l = this.extent * e, c = this.loadGeometry();
    function p(o) {
      return [
        (o.x + u) * 360 / i - 180,
        360 / Math.PI * Math.atan(Math.exp((1 - (o.y + l) * 2 / i) * Math.PI)) - 90
      ];
    }
    function y(o) {
      return o.map(p);
    ...
    if (this.type === 1) {
      ...
      for (const d of c)
        o.push(d[0]);
      const f = y(o);
      g = o.length === 1 ? { type: "Point", coordinates: f[0] } : { type: "MultiPoint", coordinates: f };
    } else if (this.type === 2) {
      const o = c.map(y);
      g = o.length === 1 ? { type: "LineString", coordinates: o[0] } : { type: "MultiLineString", coordinates: o };
    } else if (this.type === 3) {
      const o = Wn(c), f = [];
      for (const d of o)
        f.push(d.map(y));
      g = f.length === 1 ? { type: "Polygon", coordinates: f[0] } : { type: "MultiPolygon", coordinates: f };
    } else
    ...
    return this.id != null && (x.id = this.id), x;
  }
}
_n.types = ["Unknown", "Point", "LineString", "Polygon"];
function $n(r, n, e) {
  r === 1 ? n.id = e.readVarint() : r === 2 ? Jn(e, n) : r === 3 ? n.type = /** @type {0 | 1 | 2 | 3} */
  e.readVarint() : r === 4 && (n._geometry = e.pos);
}
function Jn(r, n) {
  const e = r.readVarint() + r.pos;
  for (; r.pos < e; ) {
    const s = n._keys[r.readVarint()], i = n._values[r.readVarint()];
    n.properties[s] = i;
  }
}
function Wn(r) {
  ...
  for (let u = 0; u < n; u++) {
    const l = Xn(r[u]);
    l !== 0 && (i === void 0 && (i = l < 0), i === l < 0 ? (s && e.push(s), s = [r[u]]) : s && s.push(r[u]));
  }
  return s && e.push(s), e;
}
function Xn(r) {
  let n = 0;
  for (let e = 0, s = r.length, i = s - 1, u, l; e < s; i = e++)
    u = r[e], l = r[i], n += (l.x - u.x) * (u.y + l.y);
  return n;
}
class Yn {
  /**
   ...
   */
  constructor(n, e) {
    this.version = 1, this.name = "", this.extent = 4096, this.length = 0, this._pbf = n, this._keys = [], this._values = [], this._features = [], n.readFields(Zn, this, e), this.length = this._features.length;
  }
  ...
  feature(n) {
    ...
    return new _n(this._pbf, e, this.extent, this._keys, this._values);
  }
}
function Zn(r, n, e) {
  r === 15 ? n.version = e.readVarint() : r === 1 ? n.name = e.readString() : r === 5 ? n.extent = e.readVarint() : r === 2 ? n._features.push(e.pos) : r === 3 ? n._keys.push(e.readString()) : r === 4 && n._values.push(Qn(e));
}
function Qn(r) {
  let n = null;
  const e = r.readVarint() + r.pos;
  for (; r.pos < e; ) {
    const s = r.readVarint() >> 3;
...
class ne {
   ...
   */
  constructor(n, e) {
    this.layers = n.readFields(ee, {}, e);
  }
}
function ee(r, n, e) {
  if (r === 3) {
    const s = new Yn(e, e.readVarint() + e.pos);
    s.length && (n[s.name] = s);
  }
}
function te(r) {
...
var pn;
function re() {
  return pn || (pn = 1, X.read = function(r, n, e, s, i) {
    var u, l, c = i * 8 - s - 1, p = (1 << c) - 1, y = p >> 1, g = -7, x = e ? i - 1 : 0, o = e ? -1 : 1, f = r[n + x];
    for (x += o, u = f & (1 << -g) - 1, f >>= -g, g += c; g > 0; u = u * 256 + r[n + x], x += o, g -= 8)
      ;
    for (l = u & (1 << -g) - 1, u >>= -g, g += s; g > 0; l = l * 256 + r[n + x], x += o, g -= 8)
      ;
    if (u === 0)
      u = 1 - y;
    else {
      ...
      l = l + Math.pow(2, s), u = u - y;
    }
    return (f ? -1 : 1) * l * Math.pow(2, u - s);
  }, X.write = function(r, n, e, s, i, u) {
    var l, c, p, y = u * 8 - i - 1, g = (1 << y) - 1, x = g >> 1, o = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f = s ? 0 : u - 1, d = s ? 1 : -1, v = n < 0 || n === 0 && 1 / n < 0 ? 1 : 0;
    for (n = Math.abs(n), isNaN(n) || n === 1 / 0 ? (c = isNaN(n) ? 1 : 0, l = g) : (l = Math.floor(Math.log(n) / Math.LN2), n * (p = Math.pow(2, -l)) < 1 && (l--, p *= 2), l + x >= 1 ? n += o / p : n += o * Math.pow(2, 1 - x), n * p >= 2 && (l++, p /= 2), l + x >= g ? (c = 0, l = g) : l + x >= 1 ? (c = (n * p - 1) * Math.pow(2, i), l = l + x) : (c = n * Math.pow(2, x - 1) * Math.pow(2, i), l = 0)); i >= 8; r[e + f] = c & 255, f += d, c /= 256, i -= 8)
      ;
    for (l = l << i | c, y += i; y > 0; r[e + f] = l & 255, f += d, l /= 256, y -= 8)
      ;
    r[e + f - d] |= v * 128;
  }), X;
}
...
function ie() {
  ...
  var e = 65536 * 65536, s = 1 / e, i = 12, u = typeof TextDecoder > "u" ? null : new TextDecoder("utf-8");
  n.prototype = {
    destroy: function() {
      this.buf = null;
    },
    // === READING =================================================================
    readFields: function(t, a, h) {
      for (h = h || this.length; this.pos < h; ) {
        var P = this.readVarint(), b = P >> 3, E = this.pos;
        this.type = P & 7, t(b, a, this), this.pos === E && this.skip(P);
      }
      return a;
    },
    readMessage: function(t, a) {
      return this.readFields(t, a, this.readVarint() + this.pos);
    },
    readFixed32: function() {
      var t = T(this.buf, this.pos);
      return this.pos += 4, t;
    },
    ...
    readFixed64: function() {
      var t = T(this.buf, this.pos) + T(this.buf, this.pos + 4) * e;
      return this.pos += 8, t;
    },
    readSFixed64: function() {
      var t = T(this.buf, this.pos) + A(this.buf, this.pos + 4) * e;
      return this.pos += 8, t;
    },
    readFloat: function() {
    ...
    readVarint: function(t) {
      var a = this.buf, h, P;
      return P = a[this.pos++], h = P & 127, P < 128 || (P = a[this.pos++], h |= (P & 127) << 7, P < 128) || (P = a[this.pos++], h |= (P & 127) << 14, P < 128) || (P = a[this.pos++], h |= (P & 127) << 21, P < 128) ? h : (P = a[this.pos], h |= (P & 15) << 28, l(h, t, this));
    },
    ...
    readString: function() {
      var t = this.readVarint() + this.pos, a = this.pos;
      return this.pos = t, t - a >= i && u ? B(this.buf, a, t) : k(this.buf, a, t);
    },
    readBytes: function() {
      var t = this.readVarint() + this.pos, a = this.buf.subarray(this.pos, t);
      return this.pos = t, a;
    },
    // verbose for performance reasons; doesn't affect gzipped size
    readPackedVarint: function(t, a) {
      if (this.type !== n.Bytes) return t.push(this.readVarint(a));
      var h = c(this);
      for (t = t || []; this.pos < h; ) t.push(this.readVarint(a));
      return t;
    },
    readPackedSVarint: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readSVarint());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readSVarint());
      return t;
    },
    readPackedBoolean: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readBoolean());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readBoolean());
      return t;
    },
    readPackedFloat: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readFloat());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readFloat());
      return t;
    },
    readPackedDouble: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readDouble());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readDouble());
      return t;
    },
    readPackedFixed32: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readFixed32());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readFixed32());
      return t;
    },
    readPackedSFixed32: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readSFixed32());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readSFixed32());
      return t;
    },
    readPackedFixed64: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readFixed64());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readFixed64());
      return t;
    },
    readPackedSFixed64: function(t) {
      if (this.type !== n.Bytes) return t.push(this.readSFixed64());
      var a = c(this);
      for (t = t || []; this.pos < a; ) t.push(this.readSFixed64());
      return t;
    },
    skip: function(t) {
      var a = t & 7;
      if (a === n.Varint) for (; this.buf[this.pos++] > 127; )
        ;
      else if (a === n.Bytes) this.pos = this.readVarint() + this.pos;
      else if (a === n.Fixed32) this.pos += 4;
      else if (a === n.Fixed64) this.pos += 8;
      else throw new Error("Unimplemented type: " + a);
    },
    // === WRITING =================================================================
    writeTag: function(t, a) {
      this.writeVarint(t << 3 | a);
    },
    realloc: function(t) {
      for (var a = this.length || 16; a < this.pos + t; ) a *= 2;
      if (a !== this.length) {
    ...
    writeFixed64: function(t) {
      this.realloc(8), M(this.buf, t & -1, this.pos), M(this.buf, Math.floor(t * s), this.pos + 4), this.pos += 8;
    },
    ...
    writeString: function(t) {
      ...
      var a = this.pos;
      this.pos = O(this.buf, t, this.pos);
      var h = this.pos - a;
      h >= 128 && o(a, h, this), this.pos = a - 1, this.writeVarint(h), this.pos += h;
    },
    ...
    writeBytes: function(t) {
      ...
      for (var h = 0; h < a; h++) this.buf[this.pos++] = t[h];
    },
    writeRawMessage: function(t, a) {
      this.pos++;
      var h = this.pos;
      t(a, this);
      var P = this.pos - h;
      P >= 128 && o(h, P, this), this.pos = h - 1, this.writeVarint(P), this.pos += P;
    },
    writeMessage: function(t, a, h) {
      this.writeTag(t, n.Bytes), this.writeRawMessage(a, h);
    },
    writePackedVarint: function(t, a) {
      a.length && this.writeMessage(t, f, a);
    },
    writePackedSVarint: function(t, a) {
      a.length && this.writeMessage(t, d, a);
    },
    writePackedBoolean: function(t, a) {
      a.length && this.writeMessage(t, S, a);
    },
    writePackedFloat: function(t, a) {
      a.length && this.writeMessage(t, v, a);
    },
    writePackedDouble: function(t, a) {
      a.length && this.writeMessage(t, m, a);
    },
    writePackedFixed32: function(t, a) {
      a.length && this.writeMessage(t, F, a);
    },
    writePackedSFixed32: function(t, a) {
      a.length && this.writeMessage(t, _, a);
    },
    writePackedFixed64: function(t, a) {
      a.length && this.writeMessage(t, w, a);
    },
    writePackedSFixed64: function(t, a) {
      a.length && this.writeMessage(t, L, a);
    },
    writeBytesField: function(t, a) {
      this.writeTag(t, n.Bytes), this.writeBytes(a);
    },
    writeFixed32Field: function(t, a) {
      this.writeTag(t, n.Fixed32), this.writeFixed32(a);
    },
    writeSFixed32Field: function(t, a) {
      this.writeTag(t, n.Fixed32), this.writeSFixed32(a);
    },
    writeFixed64Field: function(t, a) {
      this.writeTag(t, n.Fixed64), this.writeFixed64(a);
    },
    writeSFixed64Field: function(t, a) {
      this.writeTag(t, n.Fixed64), this.writeSFixed64(a);
    },
    writeVarintField: function(t, a) {
      this.writeTag(t, n.Varint), this.writeVarint(a);
    },
    writeSVarintField: function(t, a) {
      this.writeTag(t, n.Varint), this.writeSVarint(a);
    },
    writeStringField: function(t, a) {
      this.writeTag(t, n.Bytes), this.writeString(a);
    },
    writeFloatField: function(t, a) {
      this.writeTag(t, n.Fixed32), this.writeFloat(a);
    },
    writeDoubleField: function(t, a) {
      this.writeTag(t, n.Fixed64), this.writeDouble(a);
    },
    writeBooleanField: function(t, a) {
      this.writeVarintField(t, !!a);
    }
  };
  function l(t, a, h) {
    var P = h.buf, b, E;
    if (E = P[h.pos++], b = (E & 112) >> 4, E < 128 || (E = P[h.pos++], b |= (E & 127) << 3, E < 128) || (E = P[h.pos++], b |= (E & 127) << 10, E < 128) || (E = P[h.pos++], b |= (E & 127) << 17, E < 128) || (E = P[h.pos++], b |= (E & 127) << 24, E < 128) || (E = P[h.pos++], b |= (E & 1) << 31, E < 128)) return p(t, b, a);
    throw new Error("Expected varint not more than 10 bytes");
  }
  function c(t) {
  ...
  function p(t, a, h) {
    return h ? a * 4294967296 + (t >>> 0) : (a >>> 0) * 4294967296 + (t >>> 0);
  }
  function y(t, a) {
    var h, P;
    if (t >= 0 ? (h = t % 4294967296 | 0, P = t / 4294967296 | 0) : (h = ~(-t % 4294967296), P = ~(-t / 4294967296), h ^ 4294967295 ? h = h + 1 | 0 : (h = 0, P = P + 1 | 0)), t >= 18446744073709552e3 || t < -18446744073709552e3)
      throw new Error("Given varint doesn't fit into 10 bytes");
    a.realloc(10), g(h, P, a), x(P, a);
  }
  function g(t, a, h) {
    h.buf[h.pos++] = t & 127 | 128, t >>>= 7, h.buf[h.pos++] = t & 127 | 128, t >>>= 7, h.buf[h.pos++] = t & 127 | 128, t >>>= 7, h.buf[h.pos++] = t & 127 | 128, t >>>= 7, h.buf[h.pos] = t & 127;
  }
  function x(t, a) {
    var h = (t & 7) << 4;
    a.buf[a.pos++] |= h | ((t >>>= 3) ? 128 : 0), t && (a.buf[a.pos++] = t & 127 | ((t >>>= 7) ? 128 : 0), t && (a.buf[a.pos++] = t & 127 | ((t >>>= 7) ? 128 : 0), t && (a.buf[a.pos++] = t & 127 | ((t >>>= 7) ? 128 : 0), t && (a.buf[a.pos++] = t & 127 | ((t >>>= 7) ? 128 : 0), t && (a.buf[a.pos++] = t & 127)))));
  }
  function o(t, a, h) {
    var P = a <= 16383 ? 1 : a <= 2097151 ? 2 : a <= 268435455 ? 3 : Math.floor(Math.log(a) / (Math.LN2 * 7));
    h.realloc(P);
    for (var b = h.pos - 1; b >= t; b--) h.buf[b + P] = h.buf[b];
  }
  function f(t, a) {
    for (var h = 0; h < t.length; h++) a.writeVarint(t[h]);
  }
  function d(t, a) {
    for (var h = 0; h < t.length; h++) a.writeSVarint(t[h]);
  }
  function v(t, a) {
    for (var h = 0; h < t.length; h++) a.writeFloat(t[h]);
  }
  function m(t, a) {
    for (var h = 0; h < t.length; h++) a.writeDouble(t[h]);
  }
  function S(t, a) {
    for (var h = 0; h < t.length; h++) a.writeBoolean(t[h]);
  }
  function F(t, a) {
    for (var h = 0; h < t.length; h++) a.writeFixed32(t[h]);
  }
  function _(t, a) {
    for (var h = 0; h < t.length; h++) a.writeSFixed32(t[h]);
  }
  function w(t, a) {
    for (var h = 0; h < t.length; h++) a.writeFixed64(t[h]);
  }
  function L(t, a) {
    for (var h = 0; h < t.length; h++) a.writeSFixed64(t[h]);
  }
  function T(t, a) {
    return (t[a] | t[a + 1] << 8 | t[a + 2] << 16) + t[a + 3] * 16777216;
  }
  function M(t, a, h) {
    t[h] = a, t[h + 1] = a >>> 8, t[h + 2] = a >>> 16, t[h + 3] = a >>> 24;
  }
  function A(t, a) {
    return (t[a] | t[a + 1] << 8 | t[a + 2] << 16) + (t[a + 3] << 24);
  }
  function k(t, a, h) {
    for (var P = "", b = a; b < h; ) {
      var E = t[b], N = null, G = E > 239 ? 4 : E > 223 ? 3 : E > 191 ? 2 : 1;
      if (b + G > h) break;
      var V, U, Z;
      G === 1 ? E < 128 && (N = E) : G === 2 ? (V = t[b + 1], (V & 192) === 128 && (N = (E & 31) << 6 | V & 63, N <= 127 && (N = null))) : G === 3 ? (V = t[b + 1], U = t[b + 2], (V & 192) === 128 && (U & 192) === 128 && (N = (E & 15) << 12 | (V & 63) << 6 | U & 63, (N <= 2047 || N >= 55296 && N <= 57343) && (N = null))) : G === 4 && (V = t[b + 1], U = t[b + 2], Z = t[b + 3], (V & 192) === 128 && (U & 192) === 128 && (Z & 192) === 128 && (N = (E & 15) << 18 | (V & 63) << 12 | (U & 63) << 6 | Z & 63, (N <= 65535 || N >= 1114112) && (N = null))), N === null ? (N = 65533, G = 1) : N > 65535 && (N -= 65536, P += String.fromCharCode(N >>> 10 & 1023 | 55296), N = 56320 | N & 1023), P += String.fromCharCode(N), b += G;
    }
    return P;
  }
  function B(t, a, h) {
    return u.decode(t.subarray(a, h));
  }
  function O(t, a, h) {
    for (var P = 0, b, E; P < a.length; P++) {
      if (b = a.charCodeAt(P), b > 55295 && b < 57344)
        if (E)
          if (b < 56320) {
            t[h++] = 239, t[h++] = 191, t[h++] = 189, E = b;
            continue;
          } else
            b = E - 55296 << 10 | b - 56320 | 65536, E = null;
        else {
          b > 56319 || P + 1 === a.length ? (t[h++] = 239, t[h++] = 191, t[h++] = 189) : E = b;
          continue;
        }
      else E && (t[h++] = 239, t[h++] = 191, t[h++] = 189, E = null);
      b < 128 ? t[h++] = b : (b < 2048 ? t[h++] = b >> 6 | 192 : (b < 65536 ? t[h++] = b >> 12 | 224 : (t[h++] = b >> 18 | 240, t[h++] = b >> 12 & 63 | 128), t[h++] = b >> 6 & 63 | 128), t[h++] = b & 63 | 128);
    }
    return h;
  }
  return nn;
...
function En() {
  ...
  return r.prototype = {
    ...
    _matMult: function(n) {
      var e = n[0] * this.x + n[1] * this.y, s = n[2] * this.x + n[3] * this.y;
    ...
    _rotate: function(n) {
      var e = Math.cos(n), s = Math.sin(n), i = e * this.x - s * this.y, u = s * this.x + e * this.y;
      return this.x = i, this.y = u, this;
    },
    _rotateAround: function(n, e) {
      var s = Math.cos(n), i = Math.sin(n), u = e.x + s * (this.x - e.x) - i * (this.y - e.y), l = e.y + i * (this.x - e.x) + s * (this.y - e.y);
      return this.x = u, this.y = l, this;
    },
    _round: function() {
      return this.x = Math.round(this.x), this.y = Math.round(this.y), this;
    }
  }, r.convert = function(n) {
    return n instanceof r ? n : Array.isArray(n) ? new r(n[0], n[1]) : n;
  }, en;
}
var $ = {}, tn, yn;
function Mn() {
  ...
  var r = En();
  tn = n;
  function n(l, c, p, y, g) {
    this.properties = {}, this.extent = p, this.type = 0, this._pbf = l, this._geometry = -1, this._keys = y, this._values = g, l.readFields(e, this, c);
  }
  function e(l, c, p) {
    l == 1 ? c.id = p.readVarint() : l == 2 ? s(p, c) : l == 3 ? c.type = p.readVarint() : l == 4 && (c._geometry = p.pos);
  }
  function s(l, c) {
    for (var p = l.readVarint() + l.pos; l.pos < p; ) {
      var y = c._keys[l.readVarint()], g = c._values[l.readVarint()];
      c.properties[y] = g;
    }
  }
  n.types = ["Unknown", "Point", "LineString", "Polygon"], n.prototype.loadGeometry = function() {
    ...
    for (var c = l.readVarint() + l.pos, p = 1, y = 0, g = 0, x = 0, o = [], f; l.pos < c; ) {
      if (y <= 0) {
        var d = l.readVarint();
        p = d & 7, y = d >> 3;
      }
      if (y--, p === 1 || p === 2)
        g += l.readSVarint(), x += l.readSVarint(), p === 1 && (f && o.push(f), f = []), f.push(new r(g, x));
      else if (p === 7)
        f && f.push(f[0].clone());
      else
    ...
    var l = this._pbf;
    l.pos = this._geometry;
    for (var c = l.readVarint() + l.pos, p = 1, y = 0, g = 0, x = 0, o = 1 / 0, f = -1 / 0, d = 1 / 0, v = -1 / 0; l.pos < c; ) {
      if (y <= 0) {
        var m = l.readVarint();
        p = m & 7, y = m >> 3;
      }
      if (y--, p === 1 || p === 2)
        g += l.readSVarint(), x += l.readSVarint(), g < o && (o = g), g > f && (f = g), x < d && (d = x), x > v && (v = x);
      else if (p !== 7)
        throw new Error("unknown command " + p);
    }
    return [o, d, f, v];
  }, n.prototype.toGeoJSON = function(l, c, p) {
    var y = this.extent * Math.pow(2, p), g = this.extent * l, x = this.extent * c, o = this.loadGeometry(), f = n.types[this.type], d, v;
    function m(_) {
      for (var w = 0; w < _.length; w++) {
        var L = _[w], T = 180 - (L.y + x) * 360 / y;
        _[w] = [
          (L.x + g) * 360 / y - 180,
    ...
    switch (this.type) {
      ...
      case 2:
        ...
        break;
      case 3:
        for (o = i(o), d = 0; d < o.length; d++)
          for (v = 0; v < o[d].length; v++)
            m(o[d][v]);
        break;
    }
    o.length === 1 ? o = o[0] : f = "Multi" + f;
    var F = {
      type: "Feature",
      geometry: {
        type: f,
  ...
  function i(l) {
    var c = l.length;
    if (c <= 1) return [l];
    for (var p = [], y, g, x = 0; x < c; x++) {
      var o = u(l[x]);
      o !== 0 && (g === void 0 && (g = o < 0), g === o < 0 ? (y && p.push(y), y = [l[x]]) : y.push(l[x]));
    }
    return y && p.push(y), p;
  }
  function u(l) {
    for (var c = 0, p = 0, y = l.length, g = y - 1, x, o; p < y; g = p++)
      x = l[p], o = l[g], c += (o.x - x.x) * (x.y + o.y);
    return c;
  }
  return tn;
}
...
function An() {
  ...
  rn = n;
  function n(i, u) {
    this.version = 1, this.name = null, this.extent = 4096, this.length = 0, this._pbf = i, this._keys = [], this._values = [], this._features = [], i.readFields(e, this, u), this.length = this._features.length;
  }
  function e(i, u, l) {
    i === 15 ? u.version = l.readVarint() : i === 1 ? u.name = l.readString() : i === 5 ? u.extent = l.readVarint() : i === 2 ? u._features.push(l.pos) : i === 3 ? u._keys.push(l.readString()) : i === 4 && u._values.push(s(l));
  }
  function s(i) {
    for (var u = null, l = i.readVarint() + i.pos; i.pos < l; ) {
      var c = i.readVarint() >> 3;
      u = c === 1 ? i.readString() : c === 2 ? i.readFloat() : c === 3 ? i.readDouble() : c === 4 ? i.readVarint64() : c === 5 ? i.readVarint() : c === 6 ? i.readSVarint() : c === 7 ? i.readBoolean() : null;
    }
    return u;
  }
  return n.prototype.feature = function(i) {
...
var wn;
function oe() {
  return wn || (wn = 1, $.VectorTile = se(), $.VectorTileFeature = Mn(), $.VectorTileLayer = An()), $;
}
var on, bn;
function ae() {
  if (bn) return on;
  bn = 1;
  var r = En(), n = oe().VectorTileFeature;
  on = e;
  function e(i, u) {
    this.options = u || {}, this.features = i, this.length = i.length;
  }
  e.prototype.feature = function(i) {
    return new s(this.features[i], this.options.extent);
  };
  function s(i, u) {
    this.id = typeof i.id == "number" ? i.id : void 0, this.type = i.type, this.rawGeometry = i.type === 1 ? [i.geometry] : i.geometry, this.properties = i.tags, this.extent = u || 4096;
  }
  return s.prototype.loadGeometry = function() {
    var i = this.rawGeometry;
    this.geometry = [];
    for (var u = 0; u < i.length; u++) {
      for (var l = i[u], c = [], p = 0; p < l.length; p++)
        c.push(new r(l[p][0], l[p][1]));
      this.geometry.push(c);
    }
    return this.geometry;
  }, s.prototype.bbox = function() {
    this.geometry || this.loadGeometry();
    for (var i = this.geometry, u = 1 / 0, l = -1 / 0, c = 1 / 0, p = -1 / 0, y = 0; y < i.length; y++)
      for (var g = i[y], x = 0; x < g.length; x++) {
        var o = g[x];
        u = Math.min(u, o.x), l = Math.max(l, o.x), c = Math.min(c, o.y), p = Math.max(p, o.y);
      }
    return [u, c, l, p];
  }, s.prototype.toGeoJSON = n.prototype.toGeoJSON, on;
}
var vn;
function le() {
  if (vn) return H.exports;
  vn = 1;
  var r = ie(), n = ae();
  H.exports = e, H.exports.fromVectorTileJs = e, H.exports.fromGeojsonVt = s, H.exports.GeoJSONWrapper = n;
  function e(o) {
    var f = new r();
    return i(o, f), f.finish();
  }
  function s(o, f) {
    f = f || {};
    var d = {};
    for (var v in o)
      d[v] = new n(o[v].features, f), d[v].name = v, d[v].version = f.version, d[v].extent = f.extent;
    return e({ layers: d });
  }
  function i(o, f) {
    for (var d in o.layers)
      f.writeMessage(3, u, o.layers[d]);
  }
  function u(o, f) {
    f.writeVarintField(15, o.version || 1), f.writeStringField(1, o.name || ""), f.writeVarintField(5, o.extent || 4096);
    var d, v = {
      keys: [],
      values: [],
      keycache: {},
    ...
    for (d = 0; d < o.length; d++)
      v.feature = o.feature(d), f.writeMessage(2, l, v);
    var m = v.keys;
    for (d = 0; d < m.length; d++)
      f.writeStringField(3, m[d]);
    var S = v.values;
    for (d = 0; d < S.length; d++)
      f.writeMessage(4, x, S[d]);
  }
  function l(o, f) {
    var d = o.feature;
    d.id !== void 0 && f.writeVarintField(1, d.id), f.writeMessage(2, c, o), f.writeVarintField(3, d.type), f.writeMessage(4, g, d);
  }
  function c(o, f) {
    var d = o.feature, v = o.keys, m = o.values, S = o.keycache, F = o.valuecache;
    for (var _ in d.properties) {
      var w = d.properties[_], L = S[_];
      if (w !== null) {
        typeof L > "u" && (v.push(_), L = v.length - 1, S[_] = L), f.writeVarint(L);
        var T = typeof w;
        T !== "string" && T !== "boolean" && T !== "number" && (w = JSON.stringify(w));
        var M = T + ":" + w, A = F[M];
        typeof A > "u" && (m.push(w), A = m.length - 1, F[M] = A), f.writeVarint(A);
      }
    }
  }
  function p(o, f) {
  ...
  function g(o, f) {
    for (var d = o.loadGeometry(), v = o.type, m = 0, S = 0, F = d.length, _ = 0; _ < F; _++) {
      var w = d[_], L = 1;
      v === 1 && (L = w.length), f.writeVarint(p(1, L));
      for (var T = v === 3 ? w.length - 1 : w.length, M = 0; M < T; M++) {
        M === 1 && v !== 1 && f.writeVarint(p(2, T - 1));
        var A = w[M].x - m, k = w[M].y - S;
        f.writeVarint(y(A)), f.writeVarint(y(k)), m += A, S += k;
      }
      v === 3 && f.writeVarint(p(7, 1));
    }
  }
  function x(o, f) {
    var d = typeof o;
    d === "string" ? f.writeStringField(1, o) : d === "boolean" ? f.writeBooleanField(7, o) : d === "number" && (o % 1 !== 0 ? f.writeDoubleField(3, o) : o < 0 ? f.writeSVarintField(6, o) : f.writeVarintField(5, o));
  }
  return H.exports;
}
var ue = le();
const Sn = /* @__PURE__ */ te(ue), Ln = `var Yt = /^-?(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+-]?\\d+)?$/i, We = Math.ceil, re = Math.floor, Q = "[BigNumber Error] ", pt = Q + "Number primitive has more than 15 significant digits: ", se = 1e14, G = 14, Qe = 9007199254740991, je = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], ye = 1e7, X = 1e9;
function Bt(t) {
...
`, Pn = typeof self < "u" && self.Blob && new Blob(["URL.revokeObjectURL(import.meta.url);", Ln], { type: "text/javascript;charset=utf-8" });
function he(r) {
  let n;
  try {
    if (n = Pn && (self.URL || self.webkitURL).createObjectURL(Pn), !n) throw "";
...
class z {
  ...
  rent(n) {
    if (!n || n <= 0) return z.ZERO_BUFFER;
    const e = z._nextPow2(n), s = this.map.get(e);
    return s && s.length ? s.pop() : new ArrayBuffer(e);
  }
  release(n) {
    if (!n || !n.byteLength) return;
    const e = z._nextPow2(n.byteLength);
    let s = this.map.get(e);
    s || (s = [], this.map.set(e, s)), s.push(n);
  }
}
z.ZERO_BUFFER = new ArrayBuffer(0);
const ln = new TextEncoder(), un = new TextDecoder(), j = { keys: [], index: /* @__PURE__ */ new Map() }, fe = 2e3;
function ce() {
  j.keys = [], j.index = /* @__PURE__ */ new Map();
}
let C = !1;
function pe(r, n = {}) {
  const e = [], s = [], i = [], u = /* @__PURE__ */ new Map(), l = !!n.useSharedKeyTable;
  let c, p;
  l ? (c = j.keys, p = j.index) : (c = [], p = /* @__PURE__ */ new Map());
  let y = 0, g = 0;
  const x = (m) => {
    if (Array.isArray(m)) {
      const S = Number(m[0]), F = Number(m[1]);
      s.push(Number.isFinite(S) ? S : 0, Number.isFinite(F) ? F : 0);
    } else if (m && (typeof m.x == "number" || typeof m.y == "number")) {
      const S = Number(m.x), F = Number(m.y);
      s.push(Number.isFinite(S) ? S : 0, Number.isFinite(F) ? F : 0);
    } else
      s.push(0, 0);
  };
  for (const m of r) {
    const S = m.id == null ? "" : String(m.id), F = m.geometry || {}, _ = F.type || "Unknown", w = { id: S, type: _, coordsOffset: y, coordsLength: 0 };
    if (_ === "Point") {
      const M = F.coordinates || [];
      x(M), w.coordsLength = 2;
    } else if (_ === "LineString" || _ === "MultiPoint") {
      const M = F.coordinates || [];
      for (const A of M) x(A);
      w.coordsLength = (M.length || 0) * 2;
    } else if (_ === "Polygon") {
      const M = F.coordinates || [];
      w.ringLengths = [];
      for (const A of M) {
        w.ringLengths.push(A.length || 0);
        for (const k of A) x(k);
      }
      w.coordsLength = w.ringLengths.reduce((A, k) => A + k, 0) * 2;
    } else if (_ === "MultiPolygon") {
      const M = F.coordinates || [];
      w.polygonRingCounts = [], w.ringLengths = [];
      for (const A of M) {
        w.polygonRingCounts.push(A.length || 0);
        for (const k of A) {
          w.ringLengths.push(k.length || 0);
      ...
      w.coordsLength = 0;
    const L = m.properties || {}, T = [];
    for (const M of Object.keys(L)) {
      let A = p.get(M);
      A === void 0 && (A = c.length, c.push(M), p.set(M, A), l && c.length > fe && (ce(), c = j.keys, p = j.index));
      const k = L[M];
      let B;
      if (k === null || typeof k == "string" || typeof k == "number" || typeof k == "boolean") {
        const O = typeof k + "|" + String(k);
        if (B = u.get(O), !B) {
          const t = JSON.stringify(k);
          B = ln.encode(t), u.set(O, B);
        }
      } else {
        const O = JSON.stringify(k);
        B = ln.encode(O);
      }
      i.push(B), T.push([A, g, B.length]), g += B.length;
    }
    w.props = T, y += w.coordsLength, e.push(w);
  }
  let o;
  if (n.propsBuffer)
    n.propsBuffer instanceof Uint8Array ? o = n.propsBuffer.subarray(0, g) : o = new Uint8Array(n.propsBuffer, 0, g), o.byteLength < g && (o = new Uint8Array(g));
  else if (n.pool && g > 0) {
    const m = n.pool.rent(g);
    o = new Uint8Array(m, 0, g);
  } else
    o = new Uint8Array(g);
  let f = 0;
  for (const m of i)
    o.set(m, f), f += m.length;
  const d = s.length;
  let v;
  if (n.coordsBuffer)
    n.coordsBuffer instanceof ArrayBuffer ? v = new Float32Array(n.coordsBuffer, 0, d) : n.coordsBuffer instanceof Float32Array ? v = n.coordsBuffer.subarray(0, d) : v = new Float32Array(d), v.length < d && (v = new Float32Array(d));
  else if (n.pool && d > 0) {
    const m = n.pool.rent(d * 4);
    v = new Float32Array(m, 0, d);
  } else
    v = new Float32Array(d);
  return v.length > 0 && v.set(s), { meta: e, keys: c, propsBuffer: o, coordsArray: v };
}
function an(r, n, e, s) {
  const i = e instanceof Float32Array ? e : new Float32Array(e), u = n instanceof Uint8Array ? n : n ? new Uint8Array(n) : new Uint8Array(0), l = [];
  for (let c = 0; c < (r.length || 0); c++) {
    const p = r[c] || {}, y = p.id, g = {};
    if (Array.isArray(p.props) && p.props.length && s && s.length)
      for (const m of p.props) {
        const [S, F, _] = m;
        try {
          const w = u.subarray(F, F + _);
          g[s[S]] = JSON.parse(un.decode(w));
        } catch {
        }
      }
    const x = p.type || "Unknown";
    let o = p.coordsOffset || 0;
    const f = o + (p.coordsLength || 0);
    let d = null;
    if (x === "Point") {
      const m = i[o], S = i[o + 1], F = Number.isFinite(m) ? Math.max(-180, Math.min(180, m)) : 0, _ = Number.isFinite(S) ? Math.max(-90, Math.min(90, S)) : 0;
      if ((!Number.isFinite(m) || !Number.isFinite(S)) && !C) {
        C = !0;
        try {
          console.warn("decodeFeaturesBinary: encountered non-finite coordinate, replacing with safe value", { index: c, id: y, rawX: m, rawY: S });
        } catch {
        }
      }
      d = { type: "Point", coordinates: [F, _] };
    } else if (x === "LineString" || x === "MultiPoint") {
      const m = [];
      for (; o < f; o += 2) {
        const S = i[o], F = i[o + 1], _ = Number.isFinite(S) ? Math.max(-180, Math.min(180, S)) : 0, w = Number.isFinite(F) ? Math.max(-90, Math.min(90, F)) : 0;
        if ((!Number.isFinite(S) || !Number.isFinite(F)) && !C) {
          C = !0;
          try {
            console.warn("decodeFeaturesBinary: encountered non-finite coordinate in linestring/multipoint, replacing with safe value", { index: c, id: y, rawX: S, rawY: F });
          } catch {
          }
        }
        m.push([_, w]);
      }
      d = { type: x, coordinates: m };
    } else if (x === "Polygon") {
      const m = [], S = p.ringLengths || [];
      for (const F of S) {
        const _ = [];
        for (let w = 0; w < F; w++) {
          const L = i[o], T = i[o + 1], M = Number.isFinite(L) ? Math.max(-180, Math.min(180, L)) : 0, A = Number.isFinite(T) ? Math.max(-90, Math.min(90, T)) : 0;
          if ((!Number.isFinite(L) || !Number.isFinite(T)) && !C) {
            C = !0;
            try {
              console.warn("decodeFeaturesBinary: encountered non-finite coordinate in polygon, replacing with safe value", { index: c, id: y, rawX: L, rawY: T });
            } catch {
            }
          }
          _.push([M, A]), o += 2;
      ...
      d = { type: "Polygon", coordinates: m };
    } else if (x === "MultiPolygon") {
      const m = [], S = p.polygonRingCounts || [], F = p.ringLengths || [];
      let _ = 0;
      for (const w of S) {
        const L = [];
        for (let T = 0; T < w; T++) {
          const M = F[_++] || 0, A = [];
          for (let k = 0; k < M; k++) {
            const B = i[o], O = i[o + 1], t = Number.isFinite(B) ? Math.max(-180, Math.min(180, B)) : 0, a = Number.isFinite(O) ? Math.max(-90, Math.min(90, O)) : 0;
            if ((!Number.isFinite(B) || !Number.isFinite(O)) && !C) {
              C = !0;
              try {
                console.warn("decodeFeaturesBinary: encountered non-finite coordinate in multipolygon, replacing with safe value", { index: c, id: y, rawX: B, rawY: O });
              } catch {
              }
            }
            A.push([t, a]), o += 2;
      ...
      d = { type: "MultiPolygon", coordinates: m };
    } else if (o < f) {
      const m = i[o], S = i[o + 1], F = Number.isFinite(m) ? Math.max(-180, Math.min(180, m)) : 0, _ = Number.isFinite(S) ? Math.max(-90, Math.min(90, S)) : 0;
      if ((!Number.isFinite(m) || !Number.isFinite(S)) && !C) {
        C = !0;
        try {
          console.warn("decodeFeaturesBinary: encountered non-finite coordinate in fallback path, replacing with safe value", { index: c, id: y, rawX: m, rawY: S });
        } catch {
        }
      }
      d = { type: "Point", coordinates: [F, _] };
    }
    d == null && (d = { type: "Point", coordinates: [0, 0] });
    const v = g && typeof g == "object" ? g : {};
    l.push({ type: "Feature", id: y, geometry: d, properties: v });
  }
  return l;
}
const de = new ArrayBuffer(4), Fn = new DataView(de);
function ge() {
  return 2166136261;
}
function D(r, n) {
  return r ^= n >>> 0, r = Math.imul(r, 16777619) >>> 0, r;
}
function R(r, n) {
  const e = Number(n) || 0;
  return Fn.setFloat32(0, e, !0), r = D(r, Fn.getUint32(0, !0)), r;
}
function ye(r, n) {
  if (!n) return r;
...
function Y(r) {
  ...
  if (e === "Point") {
    ...
    return n = R(n, s[0]), n = R(n, s[1]), n;
  }
  if (e === "LineString" || e === "MultiPoint") {
    const s = r.coordinates || [];
    for (const i of s)
      n = R(n, i && i[0]), n = R(n, i && i[1]);
    return n;
  }
  if (e === "Polygon") {
    const s = r.coordinates || [];
  ...
  try {
    const s = r.coordinates || [];
    for (const i of s)
      Array.isArray(i) ? (n = R(n, i[0]), n = R(n, i[1])) : n = R(n, i);
  } catch {
  }
  return n;
}
class xe {
  constructor(n) {
    return this.map = n.map, this.source = n.source instanceof maplibregl.VectorTileSource ? n.source : this.map.getSource(n.source), this.sourceLayer = n.sourceLayer, this.fid = n.fid || "id", this.tiles = this.source.tiles.map((e) => e.split("{z}")[0]), this.tileSize = this.source.tileSize || 512, this.tolerance = n.tolerance || 1e-5, this.cacheSize = n.cacheSize || 1e4, this.minion = new he(), this._abPool = new z(), this._lastGeomHashes = /* @__PURE__ */ new Map(), this.minion.onmessage = (e) => {
      const s = e && e.data;
      if (s)
        if (s.type === "geojson_bin" && s.coords)
          try {
            const i = s.coords instanceof Uint8Array ? s.coords.buffer : s.coords, u = s.propsBuf !== void 0 ? s.propsBuf : null, l = an(s.meta || [], u, i, s.keys || []);
            this.gjsource.setData({ type: "FeatureCollection", features: l });
            try {
              for (const c of l)
                if (c && c.id != null)
                  try {
                    this._lastGeomHashes.set(String(c.id), Y(c.geometry));
                  } catch {
                    this._lastGeomHashes.set(String(c.id), 0);
                  }
            } catch {
            }
            try {
              u && this._abPool.release(u instanceof ArrayBuffer ? u : u.buffer);
            } catch {
            }
            try {
              i && this._abPool.release(i instanceof ArrayBuffer ? i : i.buffer);
            } catch {
            }
            try {
              this.minion.postMessage({ type: "diff_ack" });
            } catch {
            }
          } catch (i) {
            console.warn("Failed to decode binary worker response", i);
          }
        else if (s.type === "geojson_diff")
          try {
            const i = s && s.diff ? s.diff : {};
            if (this.gjsource && typeof this.gjsource.updateData == "function")
              try {
                this.gjsource.updateData(i);
                try {
                  this.minion.postMessage({ type: "diff_ack" });
                } catch {
                }
                ...
                try {
                  this.minion.postMessage({ type: "request_full" });
                } catch {
                }
                return;
              }
            ...
            console.warn("Failed to process geojson diff from worker", i);
          }
        else if (s.type === "geojson_diff_bin")
          try {
            const i = s.removeList || [], u = !!s.removeAll;
            let l = [];
            if (s.add && s.add.coords)
              try {
                const o = s.add.propsBuf !== void 0 ? s.add.propsBuf : null, f = s.add.coords;
                l = an(s.add.meta || [], o, f, s.add.keys || []);
                try {
                  o && this._abPool.release(o instanceof ArrayBuffer ? o : o.buffer);
                } catch {
                }
                try {
                  f && this._abPool.release(f instanceof ArrayBuffer ? f : f.buffer);
                } catch {
                }
              } catch (o) {
                console.warn("Failed to decode add-list from worker", o);
                try {
                  this.minion.postMessage({ type: "request_full" });
                } catch {
                }
            ...
            let c = [];
            if (s.update && s.update.coords)
              try {
                const o = s.update.propsBuf !== void 0 ? s.update.propsBuf : null, f = s.update.coords;
                c = an(s.update.meta || [], o, f, s.update.keys || []);
                try {
                  o && this._abPool.release(o instanceof ArrayBuffer ? o : o.buffer);
                } catch {
                }
                ...
                console.warn("Failed to decode update-list from worker", o);
                try {
                  this.minion.postMessage({ type: "request_full" });
                } catch {
                }
            ...
            let p = [];
            if (s.updateDiffs && Array.isArray(s.updateDiffs))
              p = s.updateDiffs;
            else if (s.updateDiffsMeta && Array.isArray(s.updateDiffsMeta))
              try {
                const o = s.updateKeys || [], f = s.updatePropsBuf !== void 0 ? s.updatePropsBuf : null, d = f ? f instanceof Uint8Array ? f : new Uint8Array(f) : new Uint8Array(0), v = un;
                for (const m of s.updateDiffsMeta) {
                  const S = { id: m.id };
                  if (m.removeAllProperties && (S.removeAllProperties = !0), Array.isArray(m.removeProperties) && m.removeProperties.length && (S.removeProperties = m.removeProperties.map((F) => o[F])), Array.isArray(m.addOrUpdate) && m.addOrUpdate.length) {
                    const F = [];
                    for (const _ of m.addOrUpdate) {
                      const [w, L, T] = _, M = o[w];
                      try {
                        const A = d.subarray(L, L + T), k = JSON.parse(v.decode(A));
                        F.push({ key: M, value: k });
                      } catch {
                      }
                    }
                    F.length && (S.addOrUpdateProperties = F);
                  }
                  p.push(S);
                }
                try {
                ...
                console.warn("Failed to decode compacted update diffs", o);
              }
            const y = new Map((c || []).map((o) => [String(o.id), o])), g = p.map((o) => {
              const f = { id: o.id }, d = y.get(String(o.id));
              return d && d.geometry && (f.newGeometry = d.geometry), o.removeAllProperties && (f.removeAllProperties = !0), o.removeProperties && (f.removeProperties = o.removeProperties), o.addOrUpdateProperties && (f.addOrUpdateProperties = o.addOrUpdateProperties), f;
            }).filter((o) => o != null), x = {};
            if (u ? x.removeAll = !0 : i.length && (x.remove = i), l.length && (x.add = l), g.length && (x.update = g), this.gjsource && typeof this.gjsource.updateData == "function")
              try {
                this.gjsource.updateData(x);
                try {
                  if (l && l.length) {
                    for (const o of l)
                      if (o && o.id != null)
                        try {
                          this._lastGeomHashes.set(String(o.id), Y(o.geometry));
                        } catch {
                          this._lastGeomHashes.set(String(o.id), 0);
                        }
                  }
                  if (c && c.length) {
                    for (const o of c)
                  ...
                  if (i && i.length)
                    for (const o of i) this._lastGeomHashes.delete(String(o));
                } catch {
                }
                try {
                  this.minion.postMessage({ type: "diff_ack" });
            ...
            console.warn("Failed to process binary geojson diff from worker", i);
          }
        else if (s.type === "geojson" && s.payload)
          try {
            const i = s.payload instanceof Uint8Array ? s.payload.buffer : s.payload, u = un.decode(i), l = JSON.parse(u);
            this.gjsource.setData(l);
          } catch (i) {
            console.warn("Failed to decode worker response", i);
          }
        else
          try {
            this.gjsource.setData(s);
          } catch (i) {
            console.warn("Failed to set worker data", i);
          }
      ...
      promoteId: this.fid,
      data: {}
    }), this.gjsource = this.map.getSource(this.source.id + "-proper"), maplibregl.addProtocol("proper", this._protocol), this.map.setTransformRequest((e, s) => this.tiles.some((u) => e.startsWith(u)) && s === "Tile" ? { url: "proper://" + e } : { url: e }), this._pendingPost = null, this._postTimer = null, this._postDelay = n.postDelay || 100, this.map.on("sourcedata", (e) => {
      if (e.sourceId === this.source.id && e.isSourceLoaded) {
        const s = this.map.querySourceFeatures(this.source.id, { sourceLayer: this.sourceLayer }), i = e.tile.tileID.canonical.z, u = this.tolerance * Math.pow(10, -0.301 * i + 5.19), l = {
          features: s.map((c) => ({ id: c.id, geometry: c.geometry, properties: c.properties })),
          tolerance: u
        };
        this._pendingPost = l, this._postTimer == null && (this._postTimer = setTimeout(() => {
          try {
            if (this._pendingPost) {
              const c = this._pendingPost.features || [], p = /* @__PURE__ */ new Map();
              let y = !0;
              if (this._lastGeomHashes && this._lastGeomHashes.size === c.length)
                for (const g of c) {
                  const x = String(g.id == null ? "" : g.id);
                  let o = 0;
                  try {
                    o = Y(g.geometry);
                  } catch {
                  ...
                  if (p.set(x, o), this._lastGeomHashes.get(x) !== o) {
                    y = !1;
                    break;
                  }
                }
                ...
                y = !1;
              if (y) {
                this._lastGeomHashes = p;
                return;
              }
              try {
                const { meta: g, keys: x, propsBuffer: o, coordsArray: f } = pe(this._pendingPost.features || [], { pool: this._abPool, useSharedKeyTable: !0 }), d = Object.fromEntries(p);
                this.minion.postMessage({ type: "features_bin", meta: g, keys: x, propsBuf: o.buffer, tolerance: this._pendingPost.tolerance, coords: f.buffer, cacheSize: this.cacheSize, promoteId: this.fid, hashes: d }, [o.buffer, f.buffer]), this._lastGeomHashes = p;
              } catch {
                try {
                  const x = Object.assign({}, this._pendingPost, { promoteId: this.fid }), o = JSON.stringify(x), f = ln.encode(o);
                  this.minion.postMessage({ type: "features", payload: f.buffer }, [f.buffer]);
                } catch {
                  const o = Object.assign({}, this._pendingPost, { promoteId: this.fid });
                  this.minion.postMessage(o);
                }
              }
            }
          } finally {
  ...
  _protocol = async (n) => {
    const s = n.url.replace("proper://", ""), i = n.url.split(/\/|\./i);
    if (i === null || i.length < 4)
      return console.warn(`Malformed URL: ${n.url}`), { data: null };
    const u = await fetch(s);
    let l;
    if (u.status === 200) {
      const c = i.length, [p, y, g] = i.slice(c - 4, c - 1).map((d) => d * 1), x = await u.arrayBuffer(), o = new ne(new Tn(x)), f = {
        layers: Object.entries(o.layers).reduce((d, [v, m]) => ({
          ...d,
          [v]: {
            ...m,
            feature: (S) => {
              const F = m.feature(S), w = F.loadGeometry().flat(1 / 0).some(
                (L) => L.x >= m.extent - 1 || L.y >= m.extent - 1 || L.x <= 1 || L.y <= 1
              );
              return F.properties.clipped = w, F;
            }
          }
        }), {})
      };
...
maplibregl.VectorTileSource.prototype.ProperLabels = function(r) {
  return this._proper || (this._proper = new xe({
    map: this._map,
    source: this
  })), this._proper;
};
