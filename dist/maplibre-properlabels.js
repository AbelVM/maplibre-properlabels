...
`,U=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",q],{type:"text/javascript;charset=utf-8"});function X(u){let e;try{if(e=U&&(self.URL||self.webkitURL).createObjectURL(U),!e)throw"";const n=new Worker(e,{type:"module",name:u?.name});return n.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(e)}),n}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(q),{type:"module",name:u?.name})}}const D=`let ue, he;
function Dt() {
