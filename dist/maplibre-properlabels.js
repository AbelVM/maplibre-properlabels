(function(H,Z){typeof exports=="object"&&typeof module<"u"?module.exports=Z():typeof define=="function"&&define.amd?define(Z):(H=typeof globalThis<"u"?globalThis:H||self,H.ProperLabels=Z())})(this,(function(){"use strict";var H=typeof document<"u"?document.currentScript:null;const Z=65536*65536,Fn=1/Z,ft=12,_n=typeof TextDecoder>"u"?null:new TextDecoder("utf-8"),pn=0,fn=1,on=2,an=5;class at{constructor(t=new Uint8Array(16)){this.buf=ArrayBuffer.isView(t)?t:new Uint8Array(t),this.dataView=new DataView(this.buf.buffer),this.pos=0,this.type=0,this.length=this.buf.length}readFields(t,r,a=this.length){for(;this.pos<a;){const f=this.readVarint(),y=f>>3,p=this.pos;this.type=f&7,t(y,r,this),this.pos===p&&this.skip(f)}return r}readMessage(t,r){return this.readFields(t,r,this.readVarint()+this.pos)}readFixed32(){const t=this.dataView.getUint32(this.pos,!0);return this.pos+=4,t}readSFixed32(){const t=this.dataView.getInt32(this.pos,!0);return this.pos+=4,t}readFixed64(){const t=this.dataView.getUint32(this.pos,!0)+this.dataView.getUint32(this.pos+4,!0)*Z;return this.pos+=8,t}readSFixed64(){const t=this.dataView.getUint32(this.pos,!0)+this.dataView.getInt32(this.pos+4,!0)*Z;return this.pos+=8,t}readFloat(){const t=this.dataView.getFloat32(this.pos,!0);return this.pos+=4,t}readDouble(){const t=this.dataView.getFloat64(this.pos,!0);return this.pos+=8,t}readVarint(t){const r=this.buf;let a,f;return f=r[this.pos++],a=f&127,f<128||(f=r[this.pos++],a|=(f&127)<<7,f<128)||(f=r[this.pos++],a|=(f&127)<<14,f<128)||(f=r[this.pos++],a|=(f&127)<<21,f<128)?a:(f=r[this.pos],a|=(f&15)<<28,lt(a,t,this))}readVarint64(){return this.readVarint(!0)}readSVarint(){const t=this.readVarint();return t%2===1?(t+1)/-2:t/2}readBoolean(){return!!this.readVarint()}readString(){const t=this.readVarint()+this.pos,r=this.pos;return this.pos=t,t-r>=ft&&_n?_n.decode(this.buf.subarray(r,t)):It(this.buf,r,t)}readBytes(){const t=this.readVarint()+this.pos,r=this.buf.subarray(this.pos,t);return this.pos=t,r}readPackedVarint(t=[],r){const a=this.readPackedEnd();for(;this.pos<a;)t.push(this.readVarint(r));return t}readPackedSVarint(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readSVarint());return t}readPackedBoolean(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readBoolean());return t}readPackedFloat(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readFloat());return t}readPackedDouble(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readDouble());return t}readPackedFixed32(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readFixed32());return t}readPackedSFixed32(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readSFixed32());return t}readPackedFixed64(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readFixed64());return t}readPackedSFixed64(t=[]){const r=this.readPackedEnd();for(;this.pos<r;)t.push(this.readSFixed64());return t}readPackedEnd(){return this.type===on?this.readVarint()+this.pos:this.pos+1}skip(t){const r=t&7;if(r===pn)for(;this.buf[this.pos++]>127;);else if(r===on)this.pos=this.readVarint()+this.pos;else if(r===an)this.pos+=4;else if(r===fn)this.pos+=8;else throw new Error(`Unimplemented type: ${r}`)}writeTag(t,r){this.writeVarint(t<<3|r)}realloc(t){let r=this.length||16;for(;r<this.pos+t;)r*=2;if(r!==this.length){const a=new Uint8Array(r);a.set(this.buf),this.buf=a,this.dataView=new DataView(a.buffer),this.length=r}}finish(){return this.length=this.pos,this.pos=0,this.buf.subarray(0,this.length)}writeFixed32(t){this.realloc(4),this.dataView.setInt32(this.pos,t,!0),this.pos+=4}writeSFixed32(t){this.realloc(4),this.dataView.setInt32(this.pos,t,!0),this.pos+=4}writeFixed64(t){this.realloc(8),this.dataView.setInt32(this.pos,t&-1,!0),this.dataView.setInt32(this.pos+4,Math.floor(t*Fn),!0),this.pos+=8}writeSFixed64(t){this.realloc(8),this.dataView.setInt32(this.pos,t&-1,!0),this.dataView.setInt32(this.pos+4,Math.floor(t*Fn),!0),this.pos+=8}writeVarint(t){if(t=+t||0,t>268435455||t<0){ct(t,this);return}this.realloc(4),this.buf[this.pos++]=t&127|(t>127?128:0),!(t<=127)&&(this.buf[this.pos++]=(t>>>=7)&127|(t>127?128:0),!(t<=127)&&(this.buf[this.pos++]=(t>>>=7)&127|(t>127?128:0),!(t<=127)&&(this.buf[this.pos++]=t>>>7&127)))}writeSVarint(t){this.writeVarint(t<0?-t*2-1:t*2)}writeBoolean(t){this.writeVarint(+t)}writeString(t){t=String(t),this.realloc(t.length*4),this.pos++;const r=this.pos;this.pos=St(this.buf,t,this.pos);const a=this.pos-r;a>=128&&An(r,a,this),this.pos=r-1,this.writeVarint(a),this.pos+=a}writeFloat(t){this.realloc(4),this.dataView.setFloat32(this.pos,t,!0),this.pos+=4}writeDouble(t){this.realloc(8),this.dataView.setFloat64(this.pos,t,!0),this.pos+=8}writeBytes(t){const r=t.length;this.writeVarint(r),this.realloc(r);for(let a=0;a<r;a++)this.buf[this.pos++]=t[a]}writeRawMessage(t,r){this.pos++;const a=this.pos;t(r,this);const f=this.pos-a;f>=128&&An(a,f,this),this.pos=a-1,this.writeVarint(f),this.pos+=f}writeMessage(t,r,a){this.writeTag(t,on),this.writeRawMessage(r,a)}writePackedVarint(t,r){r.length&&this.writeMessage(t,dt,r)}writePackedSVarint(t,r){r.length&&this.writeMessage(t,gt,r)}writePackedBoolean(t,r){r.length&&this.writeMessage(t,mt,r)}writePackedFloat(t,r){r.length&&this.writeMessage(t,wt,r)}writePackedDouble(t,r){r.length&&this.writeMessage(t,xt,r)}writePackedFixed32(t,r){r.length&&this.writeMessage(t,Et,r)}writePackedSFixed32(t,r){r.length&&this.writeMessage(t,bt,r)}writePackedFixed64(t,r){r.length&&this.writeMessage(t,Bt,r)}writePackedSFixed64(t,r){r.length&&this.writeMessage(t,vt,r)}writeBytesField(t,r){this.writeTag(t,on),this.writeBytes(r)}writeFixed32Field(t,r){this.writeTag(t,an),this.writeFixed32(r)}writeSFixed32Field(t,r){this.writeTag(t,an),this.writeSFixed32(r)}writeFixed64Field(t,r){this.writeTag(t,fn),this.writeFixed64(r)}writeSFixed64Field(t,r){this.writeTag(t,fn),this.writeSFixed64(r)}writeVarintField(t,r){this.writeTag(t,pn),this.writeVarint(r)}writeSVarintField(t,r){this.writeTag(t,pn),this.writeSVarint(r)}writeStringField(t,r){this.writeTag(t,on),this.writeString(r)}writeFloatField(t,r){this.writeTag(t,an),this.writeFloat(r)}writeDoubleField(t,r){this.writeTag(t,fn),this.writeDouble(r)}writeBooleanField(t,r){this.writeVarintField(t,+r)}}function lt(s,t,r){const a=r.buf;let f,y;if(y=a[r.pos++],f=(y&112)>>4,y<128||(y=a[r.pos++],f|=(y&127)<<3,y<128)||(y=a[r.pos++],f|=(y&127)<<10,y<128)||(y=a[r.pos++],f|=(y&127)<<17,y<128)||(y=a[r.pos++],f|=(y&127)<<24,y<128)||(y=a[r.pos++],f|=(y&1)<<31,y<128))return Q(s,f,t);throw new Error("Expected varint not more than 10 bytes")}function Q(s,t,r){return r?t*4294967296+(s>>>0):(t>>>0)*4294967296+(s>>>0)}function ct(s,t){let r,a;if(s>=0?(r=s%4294967296|0,a=s/4294967296|0):(r=~(-s%4294967296),a=~(-s/4294967296),r^4294967295?r=r+1|0:(r=0,a=a+1|0)),s>=18446744073709552e3||s<-18446744073709552e3)throw new Error("Given varint doesn't fit into 10 bytes");t.realloc(10),pt(r,a,t),yt(a,t)}function pt(s,t,r){r.buf[r.pos++]=s&127|128,s>>>=7,r.buf[r.pos++]=s&127|128,s>>>=7,r.buf[r.pos++]=s&127|128,s>>>=7,r.buf[r.pos++]=s&127|128,s>>>=7,r.buf[r.pos]=s&127}function yt(s,t){const r=(s&7)<<4;t.buf[t.pos++]|=r|((s>>>=3)?128:0),s&&(t.buf[t.pos++]=s&127|((s>>>=7)?128:0),s&&(t.buf[t.pos++]=s&127|((s>>>=7)?128:0),s&&(t.buf[t.pos++]=s&127|((s>>>=7)?128:0),s&&(t.buf[t.pos++]=s&127|((s>>>=7)?128:0),s&&(t.buf[t.pos++]=s&127)))))}function An(s,t,r){const a=t<=16383?1:t<=2097151?2:t<=268435455?3:Math.floor(Math.log(t)/(Math.LN2*7));r.realloc(a);for(let f=r.pos-1;f>=s;f--)r.buf[f+a]=r.buf[f]}function dt(s,t){for(let r=0;r<s.length;r++)t.writeVarint(s[r])}function gt(s,t){for(let r=0;r<s.length;r++)t.writeSVarint(s[r])}function wt(s,t){for(let r=0;r<s.length;r++)t.writeFloat(s[r])}function xt(s,t){for(let r=0;r<s.length;r++)t.writeDouble(s[r])}function mt(s,t){for(let r=0;r<s.length;r++)t.writeBoolean(s[r])}function Et(s,t){for(let r=0;r<s.length;r++)t.writeFixed32(s[r])}function bt(s,t){for(let r=0;r<s.length;r++)t.writeSFixed32(s[r])}function Bt(s,t){for(let r=0;r<s.length;r++)t.writeFixed64(s[r])}function vt(s,t){for(let r=0;r<s.length;r++)t.writeSFixed64(s[r])}function It(s,t,r){let a="",f=t;for(;f<r;){const y=s[f];let p=null,h=y>239?4:y>223?3:y>191?2:1;if(f+h>r)break;let b,B,v;h===1?y<128&&(p=y):h===2?(b=s[f+1],(b&192)===128&&(p=(y&31)<<6|b&63,p<=127&&(p=null))):h===3?(b=s[f+1],B=s[f+2],(b&192)===128&&(B&192)===128&&(p=(y&15)<<12|(b&63)<<6|B&63,(p<=2047||p>=55296&&p<=57343)&&(p=null))):h===4&&(b=s[f+1],B=s[f+2],v=s[f+3],(b&192)===128&&(B&192)===128&&(v&192)===128&&(p=(y&15)<<18|(b&63)<<12|(B&63)<<6|v&63,(p<=65535||p>=1114112)&&(p=null))),p===null?(p=65533,h=1):p>65535&&(p-=65536,a+=String.fromCharCode(p>>>10&1023|55296),p=56320|p&1023),a+=String.fromCharCode(p),f+=h}return a}function St(s,t,r){for(let a=0,f,y;a<t.length;a++){if(f=t.charCodeAt(a),f>55295&&f<57344)if(y)if(f<56320){s[r++]=239,s[r++]=191,s[r++]=189,y=f;continue}else f=y-55296<<10|f-56320|65536,y=null;else{f>56319||a+1===t.length?(s[r++]=239,s[r++]=191,s[r++]=189):y=f;continue}else y&&(s[r++]=239,s[r++]=191,s[r++]=189,y=null);f<128?s[r++]=f:(f<2048?s[r++]=f>>6|192:(f<65536?s[r++]=f>>12|224:(s[r++]=f>>18|240,s[r++]=f>>12&63|128),s[r++]=f>>6&63|128),s[r++]=f&63|128)}return r}function J(s,t){this.x=s,this.y=t}J.prototype={clone(){return new J(this.x,this.y)},add(s){return this.clone()._add(s)},sub(s){return this.clone()._sub(s)},multByPoint(s){return this.clone()._multByPoint(s)},divByPoint(s){return this.clone()._divByPoint(s)},mult(s){return this.clone()._mult(s)},div(s){return this.clone()._div(s)},rotate(s){return this.clone()._rotate(s)},rotateAround(s,t){return this.clone()._rotateAround(s,t)},matMult(s){return this.clone()._matMult(s)},unit(){return this.clone()._unit()},perp(){return this.clone()._perp()},round(){return this.clone()._round()},mag(){return Math.sqrt(this.x*this.x+this.y*this.y)},equals(s){return this.x===s.x&&this.y===s.y},dist(s){return Math.sqrt(this.distSqr(s))},distSqr(s){const t=s.x-this.x,r=s.y-this.y;return t*t+r*r},angle(){return Math.atan2(this.y,this.x)},angleTo(s){return Math.atan2(this.y-s.y,this.x-s.x)},angleWith(s){return this.angleWithSep(s.x,s.y)},angleWithSep(s,t){return Math.atan2(this.x*t-this.y*s,this.x*s+this.y*t)},_matMult(s){const t=s[0]*this.x+s[1]*this.y,r=s[2]*this.x+s[3]*this.y;return this.x=t,this.y=r,this},_add(s){return this.x+=s.x,this.y+=s.y,this},_sub(s){return this.x-=s.x,this.y-=s.y,this},_mult(s){return this.x*=s,this.y*=s,this},_div(s){return this.x/=s,this.y/=s,this},_multByPoint(s){return this.x*=s.x,this.y*=s.y,this},_divByPoint(s){return this.x/=s.x,this.y/=s.y,this},_unit(){return this._div(this.mag()),this},_perp(){const s=this.y;return this.y=this.x,this.x=-s,this},_rotate(s){const t=Math.cos(s),r=Math.sin(s),a=t*this.x-r*this.y,f=r*this.x+t*this.y;return this.x=a,this.y=f,this},_rotateAround(s,t){const r=Math.cos(s),a=Math.sin(s),f=t.x+r*(this.x-t.x)-a*(this.y-t.y),y=t.y+a*(this.x-t.x)+r*(this.y-t.y);return this.x=f,this.y=y,this},_round(){return this.x=Math.round(this.x),this.y=Math.round(this.y),this},constructor:J},J.convert=function(s){if(s instanceof J)return s;if(Array.isArray(s))return new J(+s[0],+s[1]);if(s.x!==void 0&&s.y!==void 0)return new J(+s.x,+s.y);throw new Error("Expected [x, y] or {x, y} point format")};class Tn{constructor(t,r,a,f,y){this.properties={},this.extent=a,this.type=0,this.id=void 0,this._pbf=t,this._geometry=-1,this._keys=f,this._values=y,t.readFields(Ft,this,r)}loadGeometry(){const t=this._pbf;t.pos=this._geometry;const r=t.readVarint()+t.pos,a=[];let f,y=1,p=0,h=0,b=0;for(;t.pos<r;){if(p<=0){const B=t.readVarint();y=B&7,p=B>>3}if(p--,y===1||y===2)h+=t.readSVarint(),b+=t.readSVarint(),y===1&&(f&&a.push(f),f=[]),f&&f.push(new J(h,b));else if(y===7)f&&f.push(f[0].clone());else throw new Error(`unknown command ${y}`)}return f&&a.push(f),a}bbox(){const t=this._pbf;t.pos=this._geometry;const r=t.readVarint()+t.pos;let a=1,f=0,y=0,p=0,h=1/0,b=-1/0,B=1/0,v=-1/0;for(;t.pos<r;){if(f<=0){const S=t.readVarint();a=S&7,f=S>>3}if(f--,a===1||a===2)y+=t.readSVarint(),p+=t.readSVarint(),y<h&&(h=y),y>b&&(b=y),p<B&&(B=p),p>v&&(v=p);else if(a!==7)throw new Error(`unknown command ${a}`)}return[h,B,b,v]}toGeoJSON(t,r,a){const f=this.extent*Math.pow(2,a),y=this.extent*t,p=this.extent*r,h=this.loadGeometry();function b(x){return[(x.x+y)*360/f-180,360/Math.PI*Math.atan(Math.exp((1-(x.y+p)*2/f)*Math.PI))-90]}function B(x){return x.map(b)}let v;if(this.type===1){const x=[];for(const E of h)x.push(E[0]);const w=B(x);v=x.length===1?{type:"Point",coordinates:w[0]}:{type:"MultiPoint",coordinates:w}}else if(this.type===2){const x=h.map(B);v=x.length===1?{type:"LineString",coordinates:x[0]}:{type:"MultiLineString",coordinates:x}}else if(this.type===3){const x=At(h),w=[];for(const E of x)w.push(E.map(B));v=w.length===1?{type:"Polygon",coordinates:w[0]}:{type:"MultiPolygon",coordinates:w}}else throw new Error("unknown feature type");const S={type:"Feature",geometry:v,properties:this.properties};return this.id!=null&&(S.id=this.id),S}}Tn.types=["Unknown","Point","LineString","Polygon"];function Ft(s,t,r){s===1?t.id=r.readVarint():s===2?_t(r,t):s===3?t.type=r.readVarint():s===4&&(t._geometry=r.pos)}function _t(s,t){const r=s.readVarint()+s.pos;for(;s.pos<r;){const a=t._keys[s.readVarint()],f=t._values[s.readVarint()];t.properties[a]=f}}function At(s){const t=s.length;if(t<=1)return[s];const r=[];let a,f;for(let y=0;y<t;y++){const p=Tt(s[y]);p!==0&&(f===void 0&&(f=p<0),f===p<0?(a&&r.push(a),a=[s[y]]):a&&a.push(s[y]))}return a&&r.push(a),r}function Tt(s){let t=0;for(let r=0,a=s.length,f=a-1,y,p;r<a;f=r++)y=s[r],p=s[f],t+=(p.x-y.x)*(y.y+p.y);return t}class Pt{constructor(t,r){this.version=1,this.name="",this.extent=4096,this.length=0,this._pbf=t,this._keys=[],this._values=[],this._features=[],t.readFields(Rt,this,r),this.length=this._features.length}feature(t){if(t<0||t>=this._features.length)throw new Error("feature index out of bounds");this._pbf.pos=this._features[t];const r=this._pbf.readVarint()+this._pbf.pos;return new Tn(this._pbf,r,this.extent,this._keys,this._values)}}function Rt(s,t,r){s===15?t.version=r.readVarint():s===1?t.name=r.readString():s===5?t.extent=r.readVarint():s===2?t._features.push(r.pos):s===3?t._keys.push(r.readString()):s===4&&t._values.push(Mt(r))}function Mt(s){let t=null;const r=s.readVarint()+s.pos;for(;s.pos<r;){const a=s.readVarint()>>3;t=a===1?s.readString():a===2?s.readFloat():a===3?s.readDouble():a===4?s.readVarint64():a===5?s.readVarint():a===6?s.readSVarint():a===7?s.readBoolean():null}if(t==null)throw new Error("unknown feature value");return t}class kt{constructor(t,r){this.layers=t.readFields(Ut,{},r)}}function Ut(s,t,r){if(s===3){const a=new Pt(r,r.readVarint()+r.pos);a.length&&(t[a.name]=a)}}function Lt(s){return s&&s.__esModule&&Object.prototype.hasOwnProperty.call(s,"default")?s.default:s}var nn={exports:{}},ln={};var Pn;function Rn(){return Pn||(Pn=1,ln.read=function(s,t,r,a,f){var y,p,h=f*8-a-1,b=(1<<h)-1,B=b>>1,v=-7,S=r?f-1:0,x=r?-1:1,w=s[t+S];for(S+=x,y=w&(1<<-v)-1,w>>=-v,v+=h;v>0;y=y*256+s[t+S],S+=x,v-=8);for(p=y&(1<<-v)-1,y>>=-v,v+=a;v>0;p=p*256+s[t+S],S+=x,v-=8);if(y===0)y=1-B;else{if(y===b)return p?NaN:(w?-1:1)*(1/0);p=p+Math.pow(2,a),y=y-B}return(w?-1:1)*p*Math.pow(2,y-a)},ln.write=function(s,t,r,a,f,y){var p,h,b,B=y*8-f-1,v=(1<<B)-1,S=v>>1,x=f===23?Math.pow(2,-24)-Math.pow(2,-77):0,w=a?0:y-1,E=a?1:-1,I=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(h=isNaN(t)?1:0,p=v):(p=Math.floor(Math.log(t)/Math.LN2),t*(b=Math.pow(2,-p))<1&&(p--,b*=2),p+S>=1?t+=x/b:t+=x*Math.pow(2,1-S),t*b>=2&&(p++,b/=2),p+S>=v?(h=0,p=v):p+S>=1?(h=(t*b-1)*Math.pow(2,f),p=p+S):(h=t*Math.pow(2,S-1)*Math.pow(2,f),p=0));f>=8;s[r+w]=h&255,w+=E,h/=256,f-=8);for(p=p<<f|h,B+=f;B>0;s[r+w]=p&255,w+=E,p/=256,B-=8);s[r+w-E]|=I*128}),ln}var yn,Mn;function Ct(){if(Mn)return yn;Mn=1,yn=t;var s=Rn();function t(o){this.buf=ArrayBuffer.isView&&ArrayBuffer.isView(o)?o:new Uint8Array(o||0),this.pos=0,this.type=0,this.length=this.buf.length}t.Varint=0,t.Fixed64=1,t.Bytes=2,t.Fixed32=5;var r=65536*65536,a=1/r,f=12,y=typeof TextDecoder>"u"?null:new TextDecoder("utf-8");t.prototype={destroy:function(){this.buf=null},readFields:function(o,l,g){for(g=g||this.length;this.pos<g;){var F=this.readVarint(),_=F>>3,T=this.pos;this.type=F&7,o(_,l,this),this.pos===T&&this.skip(F)}return l},readMessage:function(o,l){return this.readFields(o,l,this.readVarint()+this.pos)},readFixed32:function(){var o=j(this.buf,this.pos);return this.pos+=4,o},readSFixed32:function(){var o=z(this.buf,this.pos);return this.pos+=4,o},readFixed64:function(){var o=j(this.buf,this.pos)+j(this.buf,this.pos+4)*r;return this.pos+=8,o},readSFixed64:function(){var o=j(this.buf,this.pos)+z(this.buf,this.pos+4)*r;return this.pos+=8,o},readFloat:function(){var o=s.read(this.buf,this.pos,!0,23,4);return this.pos+=4,o},readDouble:function(){var o=s.read(this.buf,this.pos,!0,52,8);return this.pos+=8,o},readVarint:function(o){var l=this.buf,g,F;return F=l[this.pos++],g=F&127,F<128||(F=l[this.pos++],g|=(F&127)<<7,F<128)||(F=l[this.pos++],g|=(F&127)<<14,F<128)||(F=l[this.pos++],g|=(F&127)<<21,F<128)?g:(F=l[this.pos],g|=(F&15)<<28,p(g,o,this))},readVarint64:function(){return this.readVarint(!0)},readSVarint:function(){var o=this.readVarint();return o%2===1?(o+1)/-2:o/2},readBoolean:function(){return!!this.readVarint()},readString:function(){var o=this.readVarint()+this.pos,l=this.pos;return this.pos=o,o-l>=f&&y?bn(this.buf,l,o):tn(this.buf,l,o)},readBytes:function(){var o=this.readVarint()+this.pos,l=this.buf.subarray(this.pos,o);return this.pos=o,l},readPackedVarint:function(o,l){if(this.type!==t.Bytes)return o.push(this.readVarint(l));var g=h(this);for(o=o||[];this.pos<g;)o.push(this.readVarint(l));return o},readPackedSVarint:function(o){if(this.type!==t.Bytes)return o.push(this.readSVarint());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readSVarint());return o},readPackedBoolean:function(o){if(this.type!==t.Bytes)return o.push(this.readBoolean());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readBoolean());return o},readPackedFloat:function(o){if(this.type!==t.Bytes)return o.push(this.readFloat());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readFloat());return o},readPackedDouble:function(o){if(this.type!==t.Bytes)return o.push(this.readDouble());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readDouble());return o},readPackedFixed32:function(o){if(this.type!==t.Bytes)return o.push(this.readFixed32());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readFixed32());return o},readPackedSFixed32:function(o){if(this.type!==t.Bytes)return o.push(this.readSFixed32());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readSFixed32());return o},readPackedFixed64:function(o){if(this.type!==t.Bytes)return o.push(this.readFixed64());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readFixed64());return o},readPackedSFixed64:function(o){if(this.type!==t.Bytes)return o.push(this.readSFixed64());var l=h(this);for(o=o||[];this.pos<l;)o.push(this.readSFixed64());return o},skip:function(o){var l=o&7;if(l===t.Varint)for(;this.buf[this.pos++]>127;);else if(l===t.Bytes)this.pos=this.readVarint()+this.pos;else if(l===t.Fixed32)this.pos+=4;else if(l===t.Fixed64)this.pos+=8;else throw new Error("Unimplemented type: "+l)},writeTag:function(o,l){this.writeVarint(o<<3|l)},realloc:function(o){for(var l=this.length||16;l<this.pos+o;)l*=2;if(l!==this.length){var g=new Uint8Array(l);g.set(this.buf),this.buf=g,this.length=l}},finish:function(){return this.length=this.pos,this.pos=0,this.buf.subarray(0,this.length)},writeFixed32:function(o){this.realloc(4),q(this.buf,o,this.pos),this.pos+=4},writeSFixed32:function(o){this.realloc(4),q(this.buf,o,this.pos),this.pos+=4},writeFixed64:function(o){this.realloc(8),q(this.buf,o&-1,this.pos),q(this.buf,Math.floor(o*a),this.pos+4),this.pos+=8},writeSFixed64:function(o){this.realloc(8),q(this.buf,o&-1,this.pos),q(this.buf,Math.floor(o*a),this.pos+4),this.pos+=8},writeVarint:function(o){if(o=+o||0,o>268435455||o<0){B(o,this);return}this.realloc(4),this.buf[this.pos++]=o&127|(o>127?128:0),!(o<=127)&&(this.buf[this.pos++]=(o>>>=7)&127|(o>127?128:0),!(o<=127)&&(this.buf[this.pos++]=(o>>>=7)&127|(o>127?128:0),!(o<=127)&&(this.buf[this.pos++]=o>>>7&127)))},writeSVarint:function(o){this.writeVarint(o<0?-o*2-1:o*2)},writeBoolean:function(o){this.writeVarint(!!o)},writeString:function(o){o=String(o),this.realloc(o.length*4),this.pos++;var l=this.pos;this.pos=Bn(this.buf,o,this.pos);var g=this.pos-l;g>=128&&x(l,g,this),this.pos=l-1,this.writeVarint(g),this.pos+=g},writeFloat:function(o){this.realloc(4),s.write(this.buf,o,this.pos,!0,23,4),this.pos+=4},writeDouble:function(o){this.realloc(8),s.write(this.buf,o,this.pos,!0,52,8),this.pos+=8},writeBytes:function(o){var l=o.length;this.writeVarint(l),this.realloc(l);for(var g=0;g<l;g++)this.buf[this.pos++]=o[g]},writeRawMessage:function(o,l){this.pos++;var g=this.pos;o(l,this);var F=this.pos-g;F>=128&&x(g,F,this),this.pos=g-1,this.writeVarint(F),this.pos+=F},writeMessage:function(o,l,g){this.writeTag(o,t.Bytes),this.writeRawMessage(l,g)},writePackedVarint:function(o,l){l.length&&this.writeMessage(o,w,l)},writePackedSVarint:function(o,l){l.length&&this.writeMessage(o,E,l)},writePackedBoolean:function(o,l){l.length&&this.writeMessage(o,k,l)},writePackedFloat:function(o,l){l.length&&this.writeMessage(o,I,l)},writePackedDouble:function(o,l){l.length&&this.writeMessage(o,A,l)},writePackedFixed32:function(o,l){l.length&&this.writeMessage(o,M,l)},writePackedSFixed32:function(o,l){l.length&&this.writeMessage(o,U,l)},writePackedFixed64:function(o,l){l.length&&this.writeMessage(o,L,l)},writePackedSFixed64:function(o,l){l.length&&this.writeMessage(o,P,l)},writeBytesField:function(o,l){this.writeTag(o,t.Bytes),this.writeBytes(l)},writeFixed32Field:function(o,l){this.writeTag(o,t.Fixed32),this.writeFixed32(l)},writeSFixed32Field:function(o,l){this.writeTag(o,t.Fixed32),this.writeSFixed32(l)},writeFixed64Field:function(o,l){this.writeTag(o,t.Fixed64),this.writeFixed64(l)},writeSFixed64Field:function(o,l){this.writeTag(o,t.Fixed64),this.writeSFixed64(l)},writeVarintField:function(o,l){this.writeTag(o,t.Varint),this.writeVarint(l)},writeSVarintField:function(o,l){this.writeTag(o,t.Varint),this.writeSVarint(l)},writeStringField:function(o,l){this.writeTag(o,t.Bytes),this.writeString(l)},writeFloatField:function(o,l){this.writeTag(o,t.Fixed32),this.writeFloat(l)},writeDoubleField:function(o,l){this.writeTag(o,t.Fixed64),this.writeDouble(l)},writeBooleanField:function(o,l){this.writeVarintField(o,!!l)}};function p(o,l,g){var F=g.buf,_,T;if(T=F[g.pos++],_=(T&112)>>4,T<128||(T=F[g.pos++],_|=(T&127)<<3,T<128)||(T=F[g.pos++],_|=(T&127)<<10,T<128)||(T=F[g.pos++],_|=(T&127)<<17,T<128)||(T=F[g.pos++],_|=(T&127)<<24,T<128)||(T=F[g.pos++],_|=(T&1)<<31,T<128))return b(o,_,l);throw new Error("Expected varint not more than 10 bytes")}function h(o){return o.type===t.Bytes?o.readVarint()+o.pos:o.pos+1}function b(o,l,g){return g?l*4294967296+(o>>>0):(l>>>0)*4294967296+(o>>>0)}function B(o,l){var g,F;if(o>=0?(g=o%4294967296|0,F=o/4294967296|0):(g=~(-o%4294967296),F=~(-o/4294967296),g^4294967295?g=g+1|0:(g=0,F=F+1|0)),o>=18446744073709552e3||o<-18446744073709552e3)throw new Error("Given varint doesn't fit into 10 bytes");l.realloc(10),v(g,F,l),S(F,l)}function v(o,l,g){g.buf[g.pos++]=o&127|128,o>>>=7,g.buf[g.pos++]=o&127|128,o>>>=7,g.buf[g.pos++]=o&127|128,o>>>=7,g.buf[g.pos++]=o&127|128,o>>>=7,g.buf[g.pos]=o&127}function S(o,l){var g=(o&7)<<4;l.buf[l.pos++]|=g|((o>>>=3)?128:0),o&&(l.buf[l.pos++]=o&127|((o>>>=7)?128:0),o&&(l.buf[l.pos++]=o&127|((o>>>=7)?128:0),o&&(l.buf[l.pos++]=o&127|((o>>>=7)?128:0),o&&(l.buf[l.pos++]=o&127|((o>>>=7)?128:0),o&&(l.buf[l.pos++]=o&127)))))}function x(o,l,g){var F=l<=16383?1:l<=2097151?2:l<=268435455?3:Math.floor(Math.log(l)/(Math.LN2*7));g.realloc(F);for(var _=g.pos-1;_>=o;_--)g.buf[_+F]=g.buf[_]}function w(o,l){for(var g=0;g<o.length;g++)l.writeVarint(o[g])}function E(o,l){for(var g=0;g<o.length;g++)l.writeSVarint(o[g])}function I(o,l){for(var g=0;g<o.length;g++)l.writeFloat(o[g])}function A(o,l){for(var g=0;g<o.length;g++)l.writeDouble(o[g])}function k(o,l){for(var g=0;g<o.length;g++)l.writeBoolean(o[g])}function M(o,l){for(var g=0;g<o.length;g++)l.writeFixed32(o[g])}function U(o,l){for(var g=0;g<o.length;g++)l.writeSFixed32(o[g])}function L(o,l){for(var g=0;g<o.length;g++)l.writeFixed64(o[g])}function P(o,l){for(var g=0;g<o.length;g++)l.writeSFixed64(o[g])}function j(o,l){return(o[l]|o[l+1]<<8|o[l+2]<<16)+o[l+3]*16777216}function q(o,l,g){o[g]=l,o[g+1]=l>>>8,o[g+2]=l>>>16,o[g+3]=l>>>24}function z(o,l){return(o[l]|o[l+1]<<8|o[l+2]<<16)+(o[l+3]<<24)}function tn(o,l,g){for(var F="",_=l;_<g;){var T=o[_],V=null,Y=T>239?4:T>223?3:T>191?2:1;if(_+Y>g)break;var W,O,$;Y===1?T<128&&(V=T):Y===2?(W=o[_+1],(W&192)===128&&(V=(T&31)<<6|W&63,V<=127&&(V=null))):Y===3?(W=o[_+1],O=o[_+2],(W&192)===128&&(O&192)===128&&(V=(T&15)<<12|(W&63)<<6|O&63,(V<=2047||V>=55296&&V<=57343)&&(V=null))):Y===4&&(W=o[_+1],O=o[_+2],$=o[_+3],(W&192)===128&&(O&192)===128&&($&192)===128&&(V=(T&15)<<18|(W&63)<<12|(O&63)<<6|$&63,(V<=65535||V>=1114112)&&(V=null))),V===null?(V=65533,Y=1):V>65535&&(V-=65536,F+=String.fromCharCode(V>>>10&1023|55296),V=56320|V&1023),F+=String.fromCharCode(V),_+=Y}return F}function bn(o,l,g){return y.decode(o.subarray(l,g))}function Bn(o,l,g){for(var F=0,_,T;F<l.length;F++){if(_=l.charCodeAt(F),_>55295&&_<57344)if(T)if(_<56320){o[g++]=239,o[g++]=191,o[g++]=189,T=_;continue}else _=T-55296<<10|_-56320|65536,T=null;else{_>56319||F+1===l.length?(o[g++]=239,o[g++]=191,o[g++]=189):T=_;continue}else T&&(o[g++]=239,o[g++]=191,o[g++]=189,T=null);_<128?o[g++]=_:(_<2048?o[g++]=_>>6|192:(_<65536?o[g++]=_>>12|224:(o[g++]=_>>18|240,o[g++]=_>>12&63|128),o[g++]=_>>6&63|128),o[g++]=_&63|128)}return g}return yn}var dn,kn;function Un(){if(kn)return dn;kn=1,dn=s;function s(t,r){this.x=t,this.y=r}return s.prototype={clone:function(){return new s(this.x,this.y)},add:function(t){return this.clone()._add(t)},sub:function(t){return this.clone()._sub(t)},multByPoint:function(t){return this.clone()._multByPoint(t)},divByPoint:function(t){return this.clone()._divByPoint(t)},mult:function(t){return this.clone()._mult(t)},div:function(t){return this.clone()._div(t)},rotate:function(t){return this.clone()._rotate(t)},rotateAround:function(t,r){return this.clone()._rotateAround(t,r)},matMult:function(t){return this.clone()._matMult(t)},unit:function(){return this.clone()._unit()},perp:function(){return this.clone()._perp()},round:function(){return this.clone()._round()},mag:function(){return Math.sqrt(this.x*this.x+this.y*this.y)},equals:function(t){return this.x===t.x&&this.y===t.y},dist:function(t){return Math.sqrt(this.distSqr(t))},distSqr:function(t){var r=t.x-this.x,a=t.y-this.y;return r*r+a*a},angle:function(){return Math.atan2(this.y,this.x)},angleTo:function(t){return Math.atan2(this.y-t.y,this.x-t.x)},angleWith:function(t){return this.angleWithSep(t.x,t.y)},angleWithSep:function(t,r){return Math.atan2(this.x*r-this.y*t,this.x*t+this.y*r)},_matMult:function(t){var r=t[0]*this.x+t[1]*this.y,a=t[2]*this.x+t[3]*this.y;return this.x=r,this.y=a,this},_add:function(t){return this.x+=t.x,this.y+=t.y,this},_sub:function(t){return this.x-=t.x,this.y-=t.y,this},_mult:function(t){return this.x*=t,this.y*=t,this},_div:function(t){return this.x/=t,this.y/=t,this},_multByPoint:function(t){return this.x*=t.x,this.y*=t.y,this},_divByPoint:function(t){return this.x/=t.x,this.y/=t.y,this},_unit:function(){return this._div(this.mag()),this},_perp:function(){var t=this.y;return this.y=this.x,this.x=-t,this},_rotate:function(t){var r=Math.cos(t),a=Math.sin(t),f=r*this.x-a*this.y,y=a*this.x+r*this.y;return this.x=f,this.y=y,this},_rotateAround:function(t,r){var a=Math.cos(t),f=Math.sin(t),y=r.x+a*(this.x-r.x)-f*(this.y-r.y),p=r.y+f*(this.x-r.x)+a*(this.y-r.y);return this.x=y,this.y=p,this},_round:function(){return this.x=Math.round(this.x),this.y=Math.round(this.y),this}},s.convert=function(t){return t instanceof s?t:Array.isArray(t)?new s(t[0],t[1]):t},dn}var sn={},gn,Ln;function Cn(){if(Ln)return gn;Ln=1;var s=Un();gn=t;function t(p,h,b,B,v){this.properties={},this.extent=b,this.type=0,this._pbf=p,this._geometry=-1,this._keys=B,this._values=v,p.readFields(r,this,h)}function r(p,h,b){p==1?h.id=b.readVarint():p==2?a(b,h):p==3?h.type=b.readVarint():p==4&&(h._geometry=b.pos)}function a(p,h){for(var b=p.readVarint()+p.pos;p.pos<b;){var B=h._keys[p.readVarint()],v=h._values[p.readVarint()];h.properties[B]=v}}t.types=["Unknown","Point","LineString","Polygon"],t.prototype.loadGeometry=function(){var p=this._pbf;p.pos=this._geometry;for(var h=p.readVarint()+p.pos,b=1,B=0,v=0,S=0,x=[],w;p.pos<h;){if(B<=0){var E=p.readVarint();b=E&7,B=E>>3}if(B--,b===1||b===2)v+=p.readSVarint(),S+=p.readSVarint(),b===1&&(w&&x.push(w),w=[]),w.push(new s(v,S));else if(b===7)w&&w.push(w[0].clone());else throw new Error("unknown command "+b)}return w&&x.push(w),x},t.prototype.bbox=function(){var p=this._pbf;p.pos=this._geometry;for(var h=p.readVarint()+p.pos,b=1,B=0,v=0,S=0,x=1/0,w=-1/0,E=1/0,I=-1/0;p.pos<h;){if(B<=0){var A=p.readVarint();b=A&7,B=A>>3}if(B--,b===1||b===2)v+=p.readSVarint(),S+=p.readSVarint(),v<x&&(x=v),v>w&&(w=v),S<E&&(E=S),S>I&&(I=S);else if(b!==7)throw new Error("unknown command "+b)}return[x,E,w,I]},t.prototype.toGeoJSON=function(p,h,b){var B=this.extent*Math.pow(2,b),v=this.extent*p,S=this.extent*h,x=this.loadGeometry(),w=t.types[this.type],E,I;function A(U){for(var L=0;L<U.length;L++){var P=U[L],j=180-(P.y+S)*360/B;U[L]=[(P.x+v)*360/B-180,360/Math.PI*Math.atan(Math.exp(j*Math.PI/180))-90]}}switch(this.type){case 1:var k=[];for(E=0;E<x.length;E++)k[E]=x[E][0];x=k,A(x);break;case 2:for(E=0;E<x.length;E++)A(x[E]);break;case 3:for(x=f(x),E=0;E<x.length;E++)for(I=0;I<x[E].length;I++)A(x[E][I]);break}x.length===1?x=x[0]:w="Multi"+w;var M={type:"Feature",geometry:{type:w,coordinates:x},properties:this.properties};return"id"in this&&(M.id=this.id),M};function f(p){var h=p.length;if(h<=1)return[p];for(var b=[],B,v,S=0;S<h;S++){var x=y(p[S]);x!==0&&(v===void 0&&(v=x<0),v===x<0?(B&&b.push(B),B=[p[S]]):B.push(p[S]))}return B&&b.push(B),b}function y(p){for(var h=0,b=0,B=p.length,v=B-1,S,x;b<B;v=b++)S=p[b],x=p[v],h+=(x.x-S.x)*(S.y+x.y);return h}return gn}var wn,On;function Nn(){if(On)return wn;On=1;var s=Cn();wn=t;function t(f,y){this.version=1,this.name=null,this.extent=4096,this.length=0,this._pbf=f,this._keys=[],this._values=[],this._features=[],f.readFields(r,this,y),this.length=this._features.length}function r(f,y,p){f===15?y.version=p.readVarint():f===1?y.name=p.readString():f===5?y.extent=p.readVarint():f===2?y._features.push(p.pos):f===3?y._keys.push(p.readString()):f===4&&y._values.push(a(p))}function a(f){for(var y=null,p=f.readVarint()+f.pos;f.pos<p;){var h=f.readVarint()>>3;y=h===1?f.readString():h===2?f.readFloat():h===3?f.readDouble():h===4?f.readVarint64():h===5?f.readVarint():h===6?f.readSVarint():h===7?f.readBoolean():null}return y}return t.prototype.feature=function(f){if(f<0||f>=this._features.length)throw new Error("feature index out of bounds");this._pbf.pos=this._features[f];var y=this._pbf.readVarint()+this._pbf.pos;return new s(this._pbf,y,this.extent,this._keys,this._values)},wn}var xn,Vn;function Ot(){if(Vn)return xn;Vn=1;var s=Nn();xn=t;function t(a,f){this.layers=a.readFields(r,{},f)}function r(a,f,y){if(a===3){var p=new s(y,y.readVarint()+y.pos);p.length&&(f[p.name]=p)}}return xn}var Dn;function Nt(){return Dn||(Dn=1,sn.VectorTile=Ot(),sn.VectorTileFeature=Cn(),sn.VectorTileLayer=Nn()),sn}var mn,Gn;function Vt(){if(Gn)return mn;Gn=1;var s=Un(),t=Nt().VectorTileFeature;mn=r;function r(f,y){this.options=y||{},this.features=f,this.length=f.length}r.prototype.feature=function(f){return new a(this.features[f],this.options.extent)};function a(f,y){this.id=typeof f.id=="number"?f.id:void 0,this.type=f.type,this.rawGeometry=f.type===1?[f.geometry]:f.geometry,this.properties=f.tags,this.extent=y||4096}return a.prototype.loadGeometry=function(){var f=this.rawGeometry;this.geometry=[];for(var y=0;y<f.length;y++){for(var p=f[y],h=[],b=0;b<p.length;b++)h.push(new s(p[b][0],p[b][1]));this.geometry.push(h)}return this.geometry},a.prototype.bbox=function(){this.geometry||this.loadGeometry();for(var f=this.geometry,y=1/0,p=-1/0,h=1/0,b=-1/0,B=0;B<f.length;B++)for(var v=f[B],S=0;S<v.length;S++){var x=v[S];y=Math.min(y,x.x),p=Math.max(p,x.x),h=Math.min(h,x.y),b=Math.max(b,x.y)}return[y,h,p,b]},a.prototype.toGeoJSON=t.prototype.toGeoJSON,mn}var qn;function Dt(){if(qn)return nn.exports;qn=1;var s=Ct(),t=Vt();nn.exports=r,nn.exports.fromVectorTileJs=r,nn.exports.fromGeojsonVt=a,nn.exports.GeoJSONWrapper=t;function r(x){var w=new s;return f(x,w),w.finish()}function a(x,w){w=w||{};var E={};for(var I in x)E[I]=new t(x[I].features,w),E[I].name=I,E[I].version=w.version,E[I].extent=w.extent;return r({layers:E})}function f(x,w){for(var E in x.layers)w.writeMessage(3,y,x.layers[E])}function y(x,w){w.writeVarintField(15,x.version||1),w.writeStringField(1,x.name||""),w.writeVarintField(5,x.extent||4096);var E,I={keys:[],values:[],keycache:{},valuecache:{}};for(E=0;E<x.length;E++)I.feature=x.feature(E),w.writeMessage(2,p,I);var A=I.keys;for(E=0;E<A.length;E++)w.writeStringField(3,A[E]);var k=I.values;for(E=0;E<k.length;E++)w.writeMessage(4,S,k[E])}function p(x,w){var E=x.feature;E.id!==void 0&&w.writeVarintField(1,E.id),w.writeMessage(2,h,x),w.writeVarintField(3,E.type),w.writeMessage(4,v,E)}function h(x,w){var E=x.feature,I=x.keys,A=x.values,k=x.keycache,M=x.valuecache;for(var U in E.properties){var L=E.properties[U],P=k[U];if(L!==null){typeof P>"u"&&(I.push(U),P=I.length-1,k[U]=P),w.writeVarint(P);var j=typeof L;j!=="string"&&j!=="boolean"&&j!=="number"&&(L=JSON.stringify(L));var q=j+":"+L,z=M[q];typeof z>"u"&&(A.push(L),z=A.length-1,M[q]=z),w.writeVarint(z)}}}function b(x,w){return(w<<3)+(x&7)}function B(x){return x<<1^x>>31}function v(x,w){for(var E=x.loadGeometry(),I=x.type,A=0,k=0,M=E.length,U=0;U<M;U++){var L=E[U],P=1;I===1&&(P=L.length),w.writeVarint(b(1,P));for(var j=I===3?L.length-1:L.length,q=0;q<j;q++){q===1&&I!==1&&w.writeVarint(b(2,j-1));var z=L[q].x-A,tn=L[q].y-k;w.writeVarint(B(z)),w.writeVarint(B(tn)),A+=z,k+=tn}I===3&&w.writeVarint(b(7,1))}}function S(x,w){var E=typeof x;E==="string"?w.writeStringField(1,x):E==="boolean"?w.writeBooleanField(7,x):E==="number"&&(x%1!==0?w.writeDoubleField(3,x):x<0?w.writeSVarintField(6,x):w.writeVarintField(5,x))}return nn.exports}var Gt=Dt();const $n=Lt(Gt),jn=`function W(i, c, a = {}) {
...
`,zn=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",jn],{type:"text/javascript;charset=utf-8"});function qt(s){let t;try{if(t=zn&&(self.URL||self.webkitURL).createObjectURL(zn),!t)throw"";const r=new Worker(t,{type:"module",name:s?.name});return r.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(t)}),r}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(jn),{type:"module",name:s?.name})}}const Wn=`var Qe = /^-?(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+-]?\\d+)?$/i, te = Math.ceil, gt = Math.floor, ht = "[BigNumber Error] ", ye = ht + "Number primitive has more than 15 significant digits: ", wt = 1e14, V = 14, ee = 9007199254740991, re = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], At = 1e7, lt = 1e9;
function ke(n) {
...
`,Kn=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",Wn],{type:"text/javascript;charset=utf-8"});function $t(s){let t;try{if(t=Kn&&(self.URL||self.webkitURL).createObjectURL(Kn),!t)throw"";const r=new Worker(t,{type:"module",name:s?.name});return r.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(t)}),r}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(Wn),{type:"module",name:s?.name})}}class Yn{constructor(t,r={}){const a=typeof navigator<"u"&&navigator.hardwareConcurrency||2,{size:f=Math.min(a,2),minSize:y=1,maxSize:p=Math.max(f,a),workerOptions:h={},maxTasksPerWorker:b=1/0,idleTimeout:B=6e4,taskQueue:v=!0}=r;this._workerSource=t,this._workerOptions=h,this._maxTasksPerWorker=b,this.minSize=Math.max(0,y),this.maxSize=Math.max(this.minSize,p),this.idleTimeout=Math.max(0,B),this.taskQueueEnabled=!!v,this.workers=[],this.queue=[],this._listeners={message:new Set,error:new Set,messageerror:new Set,idle:new Set},this._onmessage=null,this._onerror=null,this._onidle=null,this._nextIndex=0,this._isIdle=!0;const S=Math.min(Math.max(f,this.minSize),this.maxSize);for(let x=0;x<S;x++)this._addWorkerInstance(x);this._reaperInterval=setInterval(()=>this._reapIdleWorkers(),Math.max(1e3,Math.floor(this.idleTimeout/2)))}_createWorkerInstance(){if(typeof this._workerSource=="function")return new this._workerSource;if(typeof this._workerSource=="string")return new Worker(new URL(this._workerSource,typeof document>"u"&&typeof location>"u"?require("url").pathToFileURL(__filename).href:typeof document>"u"?location.href:H&&H.tagName.toUpperCase()==="SCRIPT"&&H.src||new URL("maplibre-properlabels.js",document.baseURI).href),this._workerOptions);throw new Error("Invalid workerSource: expected Worker factory or relative path string")}_addWorkerInstance(t){const r=this._createWorkerInstance(),a={id:t,worker:r,tasks:0,lastActive:Date.now()};return this.workers.push(a),r.onmessage=f=>{if(a.tasks=Math.max(0,a.tasks-1),a.lastActive=Date.now(),this.queue.length>0&&a.tasks<this._maxTasksPerWorker){const y=this.queue.shift();try{y.transfer?r.postMessage(y.message,y.transfer):r.postMessage(y.message),a.tasks++}catch(p){console.error("Failed to dispatch queued message to worker",p)}}if(this._onmessage)try{this._onmessage(f)}catch(y){console.error("Pool onmessage handler error",y)}for(const y of this._listeners.message)try{y(f)}catch(p){console.error("pool listener error",p)}this._updateIdleState()},r.onerror=f=>{if(this._onerror)try{this._onerror(f)}catch(y){console.error("Pool onerror handler error",y)}for(const y of this._listeners.error)try{y(f)}catch(p){console.error("pool error listener error",p)}},r.onmessageerror=f=>{for(const y of this._listeners.messageerror)try{y(f)}catch(p){console.error("pool messageerror listener error",p)}},a}_findLeastLoadedWorker(){if(!this.workers.length)return null;let t=this.workers[0];for(let r=1;r<this.workers.length;r++)this.workers[r].tasks<t.tasks&&(t=this.workers[r]);return t}postMessage(t,r){const a=this._findLeastLoadedWorker();if(a&&a.tasks<this._maxTasksPerWorker)try{return r?a.worker.postMessage(t,r):a.worker.postMessage(t),a.tasks++,a.lastActive=Date.now(),this._updateIdleState(),!0}catch(y){return console.error("Failed to postMessage to worker",y),!1}if(this.workers.length<this.maxSize){const y=this.workers.length,p=this._addWorkerInstance(y);try{return r?p.worker.postMessage(t,r):p.worker.postMessage(t),p.tasks++,p.lastActive=Date.now(),this._updateIdleState(),!0}catch(h){return console.error("Failed to postMessage to new worker",h),!1}}if(this.taskQueueEnabled)return this.queue.push({message:t,transfer:r}),this._updateIdleState(),!0;const f=this.workers[this._nextIndex%this.workers.length];this._nextIndex++;try{return r?f.worker.postMessage(t,r):f.worker.postMessage(t),f.tasks++,f.lastActive=Date.now(),this._updateIdleState(),!0}catch(y){return console.error("Failed to postMessage to fallback worker",y),!1}}broadcast(t,r){for(const a of this.workers)try{r?a.worker.postMessage(t,r):a.worker.postMessage(t),a.tasks++,a.lastActive=Date.now()}catch(f){console.error("broadcast error",f)}this._updateIdleState()}addWorker(){return this._addWorkerInstance(this.workers.length)}removeWorker(){const t=this.workers.pop();if(t)try{t.worker.terminate()}catch{}}_reapIdleWorkers(){if(this.idleTimeout<=0)return;const t=Date.now();for(let r=this.workers.length-1;r>=0;r--){const a=this.workers[r];if(this.workers.length<=this.minSize)break;if(a.tasks===0&&t-(a.lastActive||0)>this.idleTimeout){try{a.worker.terminate()}catch{}this.workers.splice(r,1)}}this._updateIdleState()}_emitIdle(){const t={data:{type:"pool:idle",stats:this.getStats()}};if(this._isIdle=!0,this._onmessage)try{this._onmessage(t)}catch(r){console.error("Pool onmessage handler error",r)}if(this._onidle)try{this._onidle(t)}catch(r){console.error("Pool onidle handler error",r)}for(const r of this._listeners.message)try{r(t)}catch(a){console.error("pool listener error",a)}for(const r of this._listeners.idle)try{r(t)}catch(a){console.error("pool idle listener error",a)}}_updateIdleState(){const r=this.workers.length>0&&this.workers.every(y=>y.tasks===0),a=this.queue.length===0,f=r&&a;f&&!this._isIdle?this._emitIdle():!f&&this._isIdle&&(this._isIdle=!1)}terminate(){this._reaperInterval&&(clearInterval(this._reaperInterval),this._reaperInterval=null);for(const t of this.workers)try{t.worker.terminate()}catch{}this.workers=[],this.queue=[]}getStats(){return this.workers.map(t=>({id:t.id,tasks:t.tasks,lastActive:t.lastActive}))}addEventListener(t,r){if(t in this._listeners&&(this._listeners[t].add(r),t==="idle"&&this._isIdle)){const a={data:{type:"pool:idle",stats:this.getStats()}};try{r(a)}catch(f){console.error("pool idle listener error",f)}}}removeEventListener(t,r){t in this._listeners&&this._listeners[t].delete(r)}get onmessage(){return this._onmessage}set onmessage(t){this._onmessage=t}get onerror(){return this._onerror}set onerror(t){this._onerror=t}get onidle(){return this._onidle}set onidle(t){if(this._onidle=t,typeof t=="function"&&this._isIdle){const r={data:{type:"pool:idle",stats:this.getStats()}};try{t(r)}catch(a){console.error("Pool onidle handler error",a)}}}}var En={},un={},Jn;function jt(){if(Jn)return un;Jn=1,un.byteLength=h,un.toByteArray=B,un.fromByteArray=x;for(var s=[],t=[],r=typeof Uint8Array<"u"?Uint8Array:Array,a="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",f=0,y=a.length;f<y;++f)s[f]=a[f],t[a.charCodeAt(f)]=f;t[45]=62,t[95]=63;function p(w){var E=w.length;if(E%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var I=w.indexOf("=");I===-1&&(I=E);var A=I===E?0:4-I%4;return[I,A]}function h(w){var E=p(w),I=E[0],A=E[1];return(I+A)*3/4-A}function b(w,E,I){return(E+I)*3/4-I}function B(w){var E,I=p(w),A=I[0],k=I[1],M=new r(b(w,A,k)),U=0,L=k>0?A-4:A,P;for(P=0;P<L;P+=4)E=t[w.charCodeAt(P)]<<18|t[w.charCodeAt(P+1)]<<12|t[w.charCodeAt(P+2)]<<6|t[w.charCodeAt(P+3)],M[U++]=E>>16&255,M[U++]=E>>8&255,M[U++]=E&255;return k===2&&(E=t[w.charCodeAt(P)]<<2|t[w.charCodeAt(P+1)]>>4,M[U++]=E&255),k===1&&(E=t[w.charCodeAt(P)]<<10|t[w.charCodeAt(P+1)]<<4|t[w.charCodeAt(P+2)]>>2,M[U++]=E>>8&255,M[U++]=E&255),M}function v(w){return s[w>>18&63]+s[w>>12&63]+s[w>>6&63]+s[w&63]}function S(w,E,I){for(var A,k=[],M=E;M<I;M+=3)A=(w[M]<<16&16711680)+(w[M+1]<<8&65280)+(w[M+2]&255),k.push(v(A));return k.join("")}function x(w){for(var E,I=w.length,A=I%3,k=[],M=16383,U=0,L=I-A;U<L;U+=M)k.push(S(w,U,U+M>L?L:U+M));return A===1?(E=w[I-1],k.push(s[E>>2]+s[E<<4&63]+"==")):A===2&&(E=(w[I-2]<<8)+w[I-1],k.push(s[E>>10]+s[E>>4&63]+s[E<<2&63]+"=")),k.join("")}return un}var Xn;function zt(){return Xn||(Xn=1,(function(s){const t=jt(),r=Rn(),a=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;s.Buffer=h,s.SlowBuffer=M,s.INSPECT_MAX_BYTES=50;const f=2147483647;s.kMaxLength=f,h.TYPED_ARRAY_SUPPORT=y(),!h.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function y(){try{const i=new Uint8Array(1),n={foo:function(){return 42}};return Object.setPrototypeOf(n,Uint8Array.prototype),Object.setPrototypeOf(i,n),i.foo()===42}catch{return!1}}Object.defineProperty(h.prototype,"parent",{enumerable:!0,get:function(){if(h.isBuffer(this))return this.buffer}}),Object.defineProperty(h.prototype,"offset",{enumerable:!0,get:function(){if(h.isBuffer(this))return this.byteOffset}});function p(i){if(i>f)throw new RangeError('The value "'+i+'" is invalid for option "size"');const n=new Uint8Array(i);return Object.setPrototypeOf(n,h.prototype),n}function h(i,n,e){if(typeof i=="number"){if(typeof n=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return S(i)}return b(i,n,e)}h.poolSize=8192;function b(i,n,e){if(typeof i=="string")return x(i,n);if(ArrayBuffer.isView(i))return E(i);if(i==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof i);if(K(i,ArrayBuffer)||i&&K(i.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(K(i,SharedArrayBuffer)||i&&K(i.buffer,SharedArrayBuffer)))return I(i,n,e);if(typeof i=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const u=i.valueOf&&i.valueOf();if(u!=null&&u!==i)return h.from(u,n,e);const c=A(i);if(c)return c;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof i[Symbol.toPrimitive]=="function")return h.from(i[Symbol.toPrimitive]("string"),n,e);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof i)}h.from=function(i,n,e){return b(i,n,e)},Object.setPrototypeOf(h.prototype,Uint8Array.prototype),Object.setPrototypeOf(h,Uint8Array);function B(i){if(typeof i!="number")throw new TypeError('"size" argument must be of type number');if(i<0)throw new RangeError('The value "'+i+'" is invalid for option "size"')}function v(i,n,e){return B(i),i<=0?p(i):n!==void 0?typeof e=="string"?p(i).fill(n,e):p(i).fill(n):p(i)}h.alloc=function(i,n,e){return v(i,n,e)};function S(i){return B(i),p(i<0?0:k(i)|0)}h.allocUnsafe=function(i){return S(i)},h.allocUnsafeSlow=function(i){return S(i)};function x(i,n){if((typeof n!="string"||n==="")&&(n="utf8"),!h.isEncoding(n))throw new TypeError("Unknown encoding: "+n);const e=U(i,n)|0;let u=p(e);const c=u.write(i,n);return c!==e&&(u=u.slice(0,c)),u}function w(i){const n=i.length<0?0:k(i.length)|0,e=p(n);for(let u=0;u<n;u+=1)e[u]=i[u]&255;return e}function E(i){if(K(i,Uint8Array)){const n=new Uint8Array(i);return I(n.buffer,n.byteOffset,n.byteLength)}return w(i)}function I(i,n,e){if(n<0||i.byteLength<n)throw new RangeError('"offset" is outside of buffer bounds');if(i.byteLength<n+(e||0))throw new RangeError('"length" is outside of buffer bounds');let u;return n===void 0&&e===void 0?u=new Uint8Array(i):e===void 0?u=new Uint8Array(i,n):u=new Uint8Array(i,n,e),Object.setPrototypeOf(u,h.prototype),u}function A(i){if(h.isBuffer(i)){const n=k(i.length)|0,e=p(n);return e.length===0||i.copy(e,0,0,n),e}if(i.length!==void 0)return typeof i.length!="number"||Sn(i.length)?p(0):w(i);if(i.type==="Buffer"&&Array.isArray(i.data))return w(i.data)}function k(i){if(i>=f)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+f.toString(16)+" bytes");return i|0}function M(i){return+i!=i&&(i=0),h.alloc(+i)}h.isBuffer=function(n){return n!=null&&n._isBuffer===!0&&n!==h.prototype},h.compare=function(n,e){if(K(n,Uint8Array)&&(n=h.from(n,n.offset,n.byteLength)),K(e,Uint8Array)&&(e=h.from(e,e.offset,e.byteLength)),!h.isBuffer(n)||!h.isBuffer(e))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(n===e)return 0;let u=n.length,c=e.length;for(let d=0,m=Math.min(u,c);d<m;++d)if(n[d]!==e[d]){u=n[d],c=e[d];break}return u<c?-1:c<u?1:0},h.isEncoding=function(n){switch(String(n).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},h.concat=function(n,e){if(!Array.isArray(n))throw new TypeError('"list" argument must be an Array of Buffers');if(n.length===0)return h.alloc(0);let u;if(e===void 0)for(e=0,u=0;u<n.length;++u)e+=n[u].length;const c=h.allocUnsafe(e);let d=0;for(u=0;u<n.length;++u){let m=n[u];if(K(m,Uint8Array))d+m.length>c.length?(h.isBuffer(m)||(m=h.from(m)),m.copy(c,d)):Uint8Array.prototype.set.call(c,m,d);else if(h.isBuffer(m))m.copy(c,d);else throw new TypeError('"list" argument must be an Array of Buffers');d+=m.length}return c};function U(i,n){if(h.isBuffer(i))return i.length;if(ArrayBuffer.isView(i)||K(i,ArrayBuffer))return i.byteLength;if(typeof i!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof i);const e=i.length,u=arguments.length>2&&arguments[2]===!0;if(!u&&e===0)return 0;let c=!1;for(;;)switch(n){case"ascii":case"latin1":case"binary":return e;case"utf8":case"utf-8":return In(i).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return e*2;case"hex":return e>>>1;case"base64":return ht(i).length;default:if(c)return u?-1:In(i).length;n=(""+n).toLowerCase(),c=!0}}h.byteLength=U;function L(i,n,e){let u=!1;if((n===void 0||n<0)&&(n=0),n>this.length||((e===void 0||e>this.length)&&(e=this.length),e<=0)||(e>>>=0,n>>>=0,e<=n))return"";for(i||(i="utf8");;)switch(i){case"hex":return Y(this,n,e);case"utf8":case"utf-8":return g(this,n,e);case"ascii":return T(this,n,e);case"latin1":case"binary":return V(this,n,e);case"base64":return l(this,n,e);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return W(this,n,e);default:if(u)throw new TypeError("Unknown encoding: "+i);i=(i+"").toLowerCase(),u=!0}}h.prototype._isBuffer=!0;function P(i,n,e){const u=i[n];i[n]=i[e],i[e]=u}h.prototype.swap16=function(){const n=this.length;if(n%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let e=0;e<n;e+=2)P(this,e,e+1);return this},h.prototype.swap32=function(){const n=this.length;if(n%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let e=0;e<n;e+=4)P(this,e,e+3),P(this,e+1,e+2);return this},h.prototype.swap64=function(){const n=this.length;if(n%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let e=0;e<n;e+=8)P(this,e,e+7),P(this,e+1,e+6),P(this,e+2,e+5),P(this,e+3,e+4);return this},h.prototype.toString=function(){const n=this.length;return n===0?"":arguments.length===0?g(this,0,n):L.apply(this,arguments)},h.prototype.toLocaleString=h.prototype.toString,h.prototype.equals=function(n){if(!h.isBuffer(n))throw new TypeError("Argument must be a Buffer");return this===n?!0:h.compare(this,n)===0},h.prototype.inspect=function(){let n="";const e=s.INSPECT_MAX_BYTES;return n=this.toString("hex",0,e).replace(/(.{2})/g,"$1 ").trim(),this.length>e&&(n+=" ... "),"<Buffer "+n+">"},a&&(h.prototype[a]=h.prototype.inspect),h.prototype.compare=function(n,e,u,c,d){if(K(n,Uint8Array)&&(n=h.from(n,n.offset,n.byteLength)),!h.isBuffer(n))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof n);if(e===void 0&&(e=0),u===void 0&&(u=n?n.length:0),c===void 0&&(c=0),d===void 0&&(d=this.length),e<0||u>n.length||c<0||d>this.length)throw new RangeError("out of range index");if(c>=d&&e>=u)return 0;if(c>=d)return-1;if(e>=u)return 1;if(e>>>=0,u>>>=0,c>>>=0,d>>>=0,this===n)return 0;let m=d-c,R=u-e;const D=Math.min(m,R),N=this.slice(c,d),G=n.slice(e,u);for(let C=0;C<D;++C)if(N[C]!==G[C]){m=N[C],R=G[C];break}return m<R?-1:R<m?1:0};function j(i,n,e,u,c){if(i.length===0)return-1;if(typeof e=="string"?(u=e,e=0):e>2147483647?e=2147483647:e<-2147483648&&(e=-2147483648),e=+e,Sn(e)&&(e=c?0:i.length-1),e<0&&(e=i.length+e),e>=i.length){if(c)return-1;e=i.length-1}else if(e<0)if(c)e=0;else return-1;if(typeof n=="string"&&(n=h.from(n,u)),h.isBuffer(n))return n.length===0?-1:q(i,n,e,u,c);if(typeof n=="number")return n=n&255,typeof Uint8Array.prototype.indexOf=="function"?c?Uint8Array.prototype.indexOf.call(i,n,e):Uint8Array.prototype.lastIndexOf.call(i,n,e):q(i,[n],e,u,c);throw new TypeError("val must be string, number or Buffer")}function q(i,n,e,u,c){let d=1,m=i.length,R=n.length;if(u!==void 0&&(u=String(u).toLowerCase(),u==="ucs2"||u==="ucs-2"||u==="utf16le"||u==="utf-16le")){if(i.length<2||n.length<2)return-1;d=2,m/=2,R/=2,e/=2}function D(G,C){return d===1?G[C]:G.readUInt16BE(C*d)}let N;if(c){let G=-1;for(N=e;N<m;N++)if(D(i,N)===D(n,G===-1?0:N-G)){if(G===-1&&(G=N),N-G+1===R)return G*d}else G!==-1&&(N-=N-G),G=-1}else for(e+R>m&&(e=m-R),N=e;N>=0;N--){let G=!0;for(let C=0;C<R;C++)if(D(i,N+C)!==D(n,C)){G=!1;break}if(G)return N}return-1}h.prototype.includes=function(n,e,u){return this.indexOf(n,e,u)!==-1},h.prototype.indexOf=function(n,e,u){return j(this,n,e,u,!0)},h.prototype.lastIndexOf=function(n,e,u){return j(this,n,e,u,!1)};function z(i,n,e,u){e=Number(e)||0;const c=i.length-e;u?(u=Number(u),u>c&&(u=c)):u=c;const d=n.length;u>d/2&&(u=d/2);let m;for(m=0;m<u;++m){const R=parseInt(n.substr(m*2,2),16);if(Sn(R))return m;i[e+m]=R}return m}function tn(i,n,e,u){return cn(In(n,i.length-e),i,e,u)}function bn(i,n,e,u){return cn(Xt(n),i,e,u)}function Bn(i,n,e,u){return cn(ht(n),i,e,u)}function o(i,n,e,u){return cn(Ht(n,i.length-e),i,e,u)}h.prototype.write=function(n,e,u,c){if(e===void 0)c="utf8",u=this.length,e=0;else if(u===void 0&&typeof e=="string")c=e,u=this.length,e=0;else if(isFinite(e))e=e>>>0,isFinite(u)?(u=u>>>0,c===void 0&&(c="utf8")):(c=u,u=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const d=this.length-e;if((u===void 0||u>d)&&(u=d),n.length>0&&(u<0||e<0)||e>this.length)throw new RangeError("Attempt to write outside buffer bounds");c||(c="utf8");let m=!1;for(;;)switch(c){case"hex":return z(this,n,e,u);case"utf8":case"utf-8":return tn(this,n,e,u);case"ascii":case"latin1":case"binary":return bn(this,n,e,u);case"base64":return Bn(this,n,e,u);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o(this,n,e,u);default:if(m)throw new TypeError("Unknown encoding: "+c);c=(""+c).toLowerCase(),m=!0}},h.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function l(i,n,e){return n===0&&e===i.length?t.fromByteArray(i):t.fromByteArray(i.slice(n,e))}function g(i,n,e){e=Math.min(i.length,e);const u=[];let c=n;for(;c<e;){const d=i[c];let m=null,R=d>239?4:d>223?3:d>191?2:1;if(c+R<=e){let D,N,G,C;switch(R){case 1:d<128&&(m=d);break;case 2:D=i[c+1],(D&192)===128&&(C=(d&31)<<6|D&63,C>127&&(m=C));break;case 3:D=i[c+1],N=i[c+2],(D&192)===128&&(N&192)===128&&(C=(d&15)<<12|(D&63)<<6|N&63,C>2047&&(C<55296||C>57343)&&(m=C));break;case 4:D=i[c+1],N=i[c+2],G=i[c+3],(D&192)===128&&(N&192)===128&&(G&192)===128&&(C=(d&15)<<18|(D&63)<<12|(N&63)<<6|G&63,C>65535&&C<1114112&&(m=C))}}m===null?(m=65533,R=1):m>65535&&(m-=65536,u.push(m>>>10&1023|55296),m=56320|m&1023),u.push(m),c+=R}return _(u)}const F=4096;function _(i){const n=i.length;if(n<=F)return String.fromCharCode.apply(String,i);let e="",u=0;for(;u<n;)e+=String.fromCharCode.apply(String,i.slice(u,u+=F));return e}function T(i,n,e){let u="";e=Math.min(i.length,e);for(let c=n;c<e;++c)u+=String.fromCharCode(i[c]&127);return u}function V(i,n,e){let u="";e=Math.min(i.length,e);for(let c=n;c<e;++c)u+=String.fromCharCode(i[c]);return u}function Y(i,n,e){const u=i.length;(!n||n<0)&&(n=0),(!e||e<0||e>u)&&(e=u);let c="";for(let d=n;d<e;++d)c+=Zt[i[d]];return c}function W(i,n,e){const u=i.slice(n,e);let c="";for(let d=0;d<u.length-1;d+=2)c+=String.fromCharCode(u[d]+u[d+1]*256);return c}h.prototype.slice=function(n,e){const u=this.length;n=~~n,e=e===void 0?u:~~e,n<0?(n+=u,n<0&&(n=0)):n>u&&(n=u),e<0?(e+=u,e<0&&(e=0)):e>u&&(e=u),e<n&&(e=n);const c=this.subarray(n,e);return Object.setPrototypeOf(c,h.prototype),c};function O(i,n,e){if(i%1!==0||i<0)throw new RangeError("offset is not uint");if(i+n>e)throw new RangeError("Trying to access beyond buffer length")}h.prototype.readUintLE=h.prototype.readUIntLE=function(n,e,u){n=n>>>0,e=e>>>0,u||O(n,e,this.length);let c=this[n],d=1,m=0;for(;++m<e&&(d*=256);)c+=this[n+m]*d;return c},h.prototype.readUintBE=h.prototype.readUIntBE=function(n,e,u){n=n>>>0,e=e>>>0,u||O(n,e,this.length);let c=this[n+--e],d=1;for(;e>0&&(d*=256);)c+=this[n+--e]*d;return c},h.prototype.readUint8=h.prototype.readUInt8=function(n,e){return n=n>>>0,e||O(n,1,this.length),this[n]},h.prototype.readUint16LE=h.prototype.readUInt16LE=function(n,e){return n=n>>>0,e||O(n,2,this.length),this[n]|this[n+1]<<8},h.prototype.readUint16BE=h.prototype.readUInt16BE=function(n,e){return n=n>>>0,e||O(n,2,this.length),this[n]<<8|this[n+1]},h.prototype.readUint32LE=h.prototype.readUInt32LE=function(n,e){return n=n>>>0,e||O(n,4,this.length),(this[n]|this[n+1]<<8|this[n+2]<<16)+this[n+3]*16777216},h.prototype.readUint32BE=h.prototype.readUInt32BE=function(n,e){return n=n>>>0,e||O(n,4,this.length),this[n]*16777216+(this[n+1]<<16|this[n+2]<<8|this[n+3])},h.prototype.readBigUInt64LE=X(function(n){n=n>>>0,rn(n,"offset");const e=this[n],u=this[n+7];(e===void 0||u===void 0)&&hn(n,this.length-8);const c=e+this[++n]*2**8+this[++n]*2**16+this[++n]*2**24,d=this[++n]+this[++n]*2**8+this[++n]*2**16+u*2**24;return BigInt(c)+(BigInt(d)<<BigInt(32))}),h.prototype.readBigUInt64BE=X(function(n){n=n>>>0,rn(n,"offset");const e=this[n],u=this[n+7];(e===void 0||u===void 0)&&hn(n,this.length-8);const c=e*2**24+this[++n]*2**16+this[++n]*2**8+this[++n],d=this[++n]*2**24+this[++n]*2**16+this[++n]*2**8+u;return(BigInt(c)<<BigInt(32))+BigInt(d)}),h.prototype.readIntLE=function(n,e,u){n=n>>>0,e=e>>>0,u||O(n,e,this.length);let c=this[n],d=1,m=0;for(;++m<e&&(d*=256);)c+=this[n+m]*d;return d*=128,c>=d&&(c-=Math.pow(2,8*e)),c},h.prototype.readIntBE=function(n,e,u){n=n>>>0,e=e>>>0,u||O(n,e,this.length);let c=e,d=1,m=this[n+--c];for(;c>0&&(d*=256);)m+=this[n+--c]*d;return d*=128,m>=d&&(m-=Math.pow(2,8*e)),m},h.prototype.readInt8=function(n,e){return n=n>>>0,e||O(n,1,this.length),this[n]&128?(255-this[n]+1)*-1:this[n]},h.prototype.readInt16LE=function(n,e){n=n>>>0,e||O(n,2,this.length);const u=this[n]|this[n+1]<<8;return u&32768?u|4294901760:u},h.prototype.readInt16BE=function(n,e){n=n>>>0,e||O(n,2,this.length);const u=this[n+1]|this[n]<<8;return u&32768?u|4294901760:u},h.prototype.readInt32LE=function(n,e){return n=n>>>0,e||O(n,4,this.length),this[n]|this[n+1]<<8|this[n+2]<<16|this[n+3]<<24},h.prototype.readInt32BE=function(n,e){return n=n>>>0,e||O(n,4,this.length),this[n]<<24|this[n+1]<<16|this[n+2]<<8|this[n+3]},h.prototype.readBigInt64LE=X(function(n){n=n>>>0,rn(n,"offset");const e=this[n],u=this[n+7];(e===void 0||u===void 0)&&hn(n,this.length-8);const c=this[n+4]+this[n+5]*2**8+this[n+6]*2**16+(u<<24);return(BigInt(c)<<BigInt(32))+BigInt(e+this[++n]*2**8+this[++n]*2**16+this[++n]*2**24)}),h.prototype.readBigInt64BE=X(function(n){n=n>>>0,rn(n,"offset");const e=this[n],u=this[n+7];(e===void 0||u===void 0)&&hn(n,this.length-8);const c=(e<<24)+this[++n]*2**16+this[++n]*2**8+this[++n];return(BigInt(c)<<BigInt(32))+BigInt(this[++n]*2**24+this[++n]*2**16+this[++n]*2**8+u)}),h.prototype.readFloatLE=function(n,e){return n=n>>>0,e||O(n,4,this.length),r.read(this,n,!0,23,4)},h.prototype.readFloatBE=function(n,e){return n=n>>>0,e||O(n,4,this.length),r.read(this,n,!1,23,4)},h.prototype.readDoubleLE=function(n,e){return n=n>>>0,e||O(n,8,this.length),r.read(this,n,!0,52,8)},h.prototype.readDoubleBE=function(n,e){return n=n>>>0,e||O(n,8,this.length),r.read(this,n,!1,52,8)};function $(i,n,e,u,c,d){if(!h.isBuffer(i))throw new TypeError('"buffer" argument must be a Buffer instance');if(n>c||n<d)throw new RangeError('"value" argument is out of bounds');if(e+u>i.length)throw new RangeError("Index out of range")}h.prototype.writeUintLE=h.prototype.writeUIntLE=function(n,e,u,c){if(n=+n,e=e>>>0,u=u>>>0,!c){const R=Math.pow(2,8*u)-1;$(this,n,e,u,R,0)}let d=1,m=0;for(this[e]=n&255;++m<u&&(d*=256);)this[e+m]=n/d&255;return e+u},h.prototype.writeUintBE=h.prototype.writeUIntBE=function(n,e,u,c){if(n=+n,e=e>>>0,u=u>>>0,!c){const R=Math.pow(2,8*u)-1;$(this,n,e,u,R,0)}let d=u-1,m=1;for(this[e+d]=n&255;--d>=0&&(m*=256);)this[e+d]=n/m&255;return e+u},h.prototype.writeUint8=h.prototype.writeUInt8=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,1,255,0),this[e]=n&255,e+1},h.prototype.writeUint16LE=h.prototype.writeUInt16LE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,2,65535,0),this[e]=n&255,this[e+1]=n>>>8,e+2},h.prototype.writeUint16BE=h.prototype.writeUInt16BE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,2,65535,0),this[e]=n>>>8,this[e+1]=n&255,e+2},h.prototype.writeUint32LE=h.prototype.writeUInt32LE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,4,4294967295,0),this[e+3]=n>>>24,this[e+2]=n>>>16,this[e+1]=n>>>8,this[e]=n&255,e+4},h.prototype.writeUint32BE=h.prototype.writeUInt32BE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,4,4294967295,0),this[e]=n>>>24,this[e+1]=n>>>16,this[e+2]=n>>>8,this[e+3]=n&255,e+4};function tt(i,n,e,u,c){ut(n,u,c,i,e,7);let d=Number(n&BigInt(4294967295));i[e++]=d,d=d>>8,i[e++]=d,d=d>>8,i[e++]=d,d=d>>8,i[e++]=d;let m=Number(n>>BigInt(32)&BigInt(4294967295));return i[e++]=m,m=m>>8,i[e++]=m,m=m>>8,i[e++]=m,m=m>>8,i[e++]=m,e}function et(i,n,e,u,c){ut(n,u,c,i,e,7);let d=Number(n&BigInt(4294967295));i[e+7]=d,d=d>>8,i[e+6]=d,d=d>>8,i[e+5]=d,d=d>>8,i[e+4]=d;let m=Number(n>>BigInt(32)&BigInt(4294967295));return i[e+3]=m,m=m>>8,i[e+2]=m,m=m>>8,i[e+1]=m,m=m>>8,i[e]=m,e+8}h.prototype.writeBigUInt64LE=X(function(n,e=0){return tt(this,n,e,BigInt(0),BigInt("0xffffffffffffffff"))}),h.prototype.writeBigUInt64BE=X(function(n,e=0){return et(this,n,e,BigInt(0),BigInt("0xffffffffffffffff"))}),h.prototype.writeIntLE=function(n,e,u,c){if(n=+n,e=e>>>0,!c){const D=Math.pow(2,8*u-1);$(this,n,e,u,D-1,-D)}let d=0,m=1,R=0;for(this[e]=n&255;++d<u&&(m*=256);)n<0&&R===0&&this[e+d-1]!==0&&(R=1),this[e+d]=(n/m>>0)-R&255;return e+u},h.prototype.writeIntBE=function(n,e,u,c){if(n=+n,e=e>>>0,!c){const D=Math.pow(2,8*u-1);$(this,n,e,u,D-1,-D)}let d=u-1,m=1,R=0;for(this[e+d]=n&255;--d>=0&&(m*=256);)n<0&&R===0&&this[e+d+1]!==0&&(R=1),this[e+d]=(n/m>>0)-R&255;return e+u},h.prototype.writeInt8=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,1,127,-128),n<0&&(n=255+n+1),this[e]=n&255,e+1},h.prototype.writeInt16LE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,2,32767,-32768),this[e]=n&255,this[e+1]=n>>>8,e+2},h.prototype.writeInt16BE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,2,32767,-32768),this[e]=n>>>8,this[e+1]=n&255,e+2},h.prototype.writeInt32LE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,4,2147483647,-2147483648),this[e]=n&255,this[e+1]=n>>>8,this[e+2]=n>>>16,this[e+3]=n>>>24,e+4},h.prototype.writeInt32BE=function(n,e,u){return n=+n,e=e>>>0,u||$(this,n,e,4,2147483647,-2147483648),n<0&&(n=4294967295+n+1),this[e]=n>>>24,this[e+1]=n>>>16,this[e+2]=n>>>8,this[e+3]=n&255,e+4},h.prototype.writeBigInt64LE=X(function(n,e=0){return tt(this,n,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),h.prototype.writeBigInt64BE=X(function(n,e=0){return et(this,n,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function rt(i,n,e,u,c,d){if(e+u>i.length)throw new RangeError("Index out of range");if(e<0)throw new RangeError("Index out of range")}function it(i,n,e,u,c){return n=+n,e=e>>>0,c||rt(i,n,e,4),r.write(i,n,e,u,23,4),e+4}h.prototype.writeFloatLE=function(n,e,u){return it(this,n,e,!0,u)},h.prototype.writeFloatBE=function(n,e,u){return it(this,n,e,!1,u)};function ot(i,n,e,u,c){return n=+n,e=e>>>0,c||rt(i,n,e,8),r.write(i,n,e,u,52,8),e+8}h.prototype.writeDoubleLE=function(n,e,u){return ot(this,n,e,!0,u)},h.prototype.writeDoubleBE=function(n,e,u){return ot(this,n,e,!1,u)},h.prototype.copy=function(n,e,u,c){if(!h.isBuffer(n))throw new TypeError("argument should be a Buffer");if(u||(u=0),!c&&c!==0&&(c=this.length),e>=n.length&&(e=n.length),e||(e=0),c>0&&c<u&&(c=u),c===u||n.length===0||this.length===0)return 0;if(e<0)throw new RangeError("targetStart out of bounds");if(u<0||u>=this.length)throw new RangeError("Index out of range");if(c<0)throw new RangeError("sourceEnd out of bounds");c>this.length&&(c=this.length),n.length-e<c-u&&(c=n.length-e+u);const d=c-u;return this===n&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(e,u,c):Uint8Array.prototype.set.call(n,this.subarray(u,c),e),d},h.prototype.fill=function(n,e,u,c){if(typeof n=="string"){if(typeof e=="string"?(c=e,e=0,u=this.length):typeof u=="string"&&(c=u,u=this.length),c!==void 0&&typeof c!="string")throw new TypeError("encoding must be a string");if(typeof c=="string"&&!h.isEncoding(c))throw new TypeError("Unknown encoding: "+c);if(n.length===1){const m=n.charCodeAt(0);(c==="utf8"&&m<128||c==="latin1")&&(n=m)}}else typeof n=="number"?n=n&255:typeof n=="boolean"&&(n=Number(n));if(e<0||this.length<e||this.length<u)throw new RangeError("Out of range index");if(u<=e)return this;e=e>>>0,u=u===void 0?this.length:u>>>0,n||(n=0);let d;if(typeof n=="number")for(d=e;d<u;++d)this[d]=n;else{const m=h.isBuffer(n)?n:h.from(n,c),R=m.length;if(R===0)throw new TypeError('The value "'+n+'" is invalid for argument "value"');for(d=0;d<u-e;++d)this[d+e]=m[d%R]}return this};const en={};function vn(i,n,e){en[i]=class extends e{constructor(){super(),Object.defineProperty(this,"message",{value:n.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${i}]`,this.stack,delete this.name}get code(){return i}set code(c){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:c,writable:!0})}toString(){return`${this.name} [${i}]: ${this.message}`}}}vn("ERR_BUFFER_OUT_OF_BOUNDS",function(i){return i?`${i} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),vn("ERR_INVALID_ARG_TYPE",function(i,n){return`The "${i}" argument must be of type number. Received type ${typeof n}`},TypeError),vn("ERR_OUT_OF_RANGE",function(i,n,e){let u=`The value of "${i}" is out of range.`,c=e;return Number.isInteger(e)&&Math.abs(e)>2**32?c=st(String(e)):typeof e=="bigint"&&(c=String(e),(e>BigInt(2)**BigInt(32)||e<-(BigInt(2)**BigInt(32)))&&(c=st(c)),c+="n"),u+=` It must be ${n}. Received ${c}`,u},RangeError);function st(i){let n="",e=i.length;const u=i[0]==="-"?1:0;for(;e>=u+4;e-=3)n=`_${i.slice(e-3,e)}${n}`;return`${i.slice(0,e)}${n}`}function Kt(i,n,e){rn(n,"offset"),(i[n]===void 0||i[n+e]===void 0)&&hn(n,i.length-(e+1))}function ut(i,n,e,u,c,d){if(i>e||i<n){const m=typeof n=="bigint"?"n":"";let R;throw n===0||n===BigInt(0)?R=`>= 0${m} and < 2${m} ** ${(d+1)*8}${m}`:R=`>= -(2${m} ** ${(d+1)*8-1}${m}) and < 2 ** ${(d+1)*8-1}${m}`,new en.ERR_OUT_OF_RANGE("value",R,i)}Kt(u,c,d)}function rn(i,n){if(typeof i!="number")throw new en.ERR_INVALID_ARG_TYPE(n,"number",i)}function hn(i,n,e){throw Math.floor(i)!==i?(rn(i,e),new en.ERR_OUT_OF_RANGE("offset","an integer",i)):n<0?new en.ERR_BUFFER_OUT_OF_BOUNDS:new en.ERR_OUT_OF_RANGE("offset",`>= 0 and <= ${n}`,i)}const Yt=/[^+/0-9A-Za-z-_]/g;function Jt(i){if(i=i.split("=")[0],i=i.trim().replace(Yt,""),i.length<2)return"";for(;i.length%4!==0;)i=i+"=";return i}function In(i,n){n=n||1/0;let e;const u=i.length;let c=null;const d=[];for(let m=0;m<u;++m){if(e=i.charCodeAt(m),e>55295&&e<57344){if(!c){if(e>56319){(n-=3)>-1&&d.push(239,191,189);continue}else if(m+1===u){(n-=3)>-1&&d.push(239,191,189);continue}c=e;continue}if(e<56320){(n-=3)>-1&&d.push(239,191,189),c=e;continue}e=(c-55296<<10|e-56320)+65536}else c&&(n-=3)>-1&&d.push(239,191,189);if(c=null,e<128){if((n-=1)<0)break;d.push(e)}else if(e<2048){if((n-=2)<0)break;d.push(e>>6|192,e&63|128)}else if(e<65536){if((n-=3)<0)break;d.push(e>>12|224,e>>6&63|128,e&63|128)}else if(e<1114112){if((n-=4)<0)break;d.push(e>>18|240,e>>12&63|128,e>>6&63|128,e&63|128)}else throw new Error("Invalid code point")}return d}function Xt(i){const n=[];for(let e=0;e<i.length;++e)n.push(i.charCodeAt(e)&255);return n}function Ht(i,n){let e,u,c;const d=[];for(let m=0;m<i.length&&!((n-=2)<0);++m)e=i.charCodeAt(m),u=e>>8,c=e%256,d.push(c),d.push(u);return d}function ht(i){return t.toByteArray(Jt(i))}function cn(i,n,e,u){let c;for(c=0;c<u&&!(c+e>=n.length||c>=i.length);++c)n[c+e]=i[c];return c}function K(i,n){return i instanceof n||i!=null&&i.constructor!=null&&i.constructor.name!=null&&i.constructor.name===n.name}function Sn(i){return i!==i}const Zt=(function(){const i="0123456789abcdef",n=new Array(256);for(let e=0;e<16;++e){const u=e*16;for(let c=0;c<16;++c)n[u+c]=i[e]+i[c]}return n})();function X(i){return typeof BigInt>"u"?Qt:i}function Qt(){throw new Error("BigInt not supported")}})(En)),En}var Hn=zt();const Wt=typeof self<"u"?self:typeof globalThis<"u"?globalThis:{};Wt.Buffer=Hn.Buffer;const Zn=s=>Hn.Buffer.from(JSON.stringify(s)).buffer,Qn=s=>JSON.parse(new TextDecoder().decode(s));class nt{constructor(t){this.map=t.map,this.source=t.source instanceof maplibregl.VectorTileSource?t.source:this.map.getSource(t.source),this.sourceLayer=t.sourceLayer,this.fid=t.fid||"id",this.tiles=this.source.tiles.map(y=>y.split("{z}")[0]),this.tileSize=this.source.tileSize||512,this.tolerance=t.tolerance||1e-5,this.cacheSize=t.cacheSize||1e4,this.units=t.units||"meters",this.seed=!1,this.map.addSource(this.source.id+"-proper",{type:"geojson",maxzoom:this.source.maxzoom,promoteId:"_index",data:{}}),this.gjsource=this.map.getSource(this.source.id+"-proper"),maplibregl.addProtocol("proper",this._protocol),this.map.setTransformRequest((y,p)=>this.tiles.some(b=>y.startsWith(b))&&p==="Tile"?{url:"proper://"+y}:{url:y});const r=new Yn(qt,{size:6}),a=new Yn($t,{size:4}),f=new Map;return r.onmessage=y=>{if(y.data instanceof ArrayBuffer){const p=y.data,h=Qn(p);if(h.type!=="simplified")return 0;const{unique:b,type:B,...v}=h;f.set(b,v)}},r.onmessage=y=>{if(y.data instanceof ArrayBuffer){const p=y.data,h=Qn(p);if(h.type!=="simplified")return 0;const{unique:b,type:B,...v}=h;f.set(b,v)}},this.map.on("sourcedata",y=>{if(y.sourceId===this.source.id){const{z:p,x:h,y:b}=y.tile.tileID.canonical,B=`${p}|${h}|${b}`;if(!f.has(B)){const v=this.tolerance*Math.pow(10,-.301*p+5.19),S=[],x=this.source.type==="vector"?{sourceLayer:this.sourceLayer}:{};y.tile.querySourceFeatures(S,x);const w={collection:{type:"FeatureCollection",features:S.map((I,A)=>({id:I.properties[this.fid]||I.id,geometry:I.geometry,properties:{...I.properties,_index:`${B}|${A}`,_tile:B}}))},tolerance:v,unique:B,tilesize:this.tileSize},E=Zn(w);r.postMessage(E)}y.isSourceLoaded&&r.addEventListener("idle",v=>{const x={pieces:Object.fromEntries(f),tolerance:this.tolerance,unit:this.units},w=Zn(x);a.postMessage(w)})}}),this.map.refreshTiles(this.source.id),this.gjsource}_protocol=async t=>{const a=t.url.replace("proper://",""),f=t.url.split(/\/|\./i);if(f===null||f.length<4)return console.warn(`Malformed URL: ${t.url}`),{data:null};const y=await fetch(a);let p;if(y.status===200){const h=f.length,[b,B,v]=f.slice(h-4,h-1).map(E=>E*1),S=await y.arrayBuffer(),x=new kt(new at(S)),w={layers:Object.entries(x.layers).reduce((E,[I,A])=>({...E,[I]:{...A,feature:k=>{const M=A.feature(k),L=M.loadGeometry().flat(1/0).some(P=>P.x>=A.extent-1||P.y>=A.extent-1||P.x<=1||P.y<=1);return M.properties.clipped=L,M}}}),{})};p=$n(w).buffer}else p=$n({}).buffer;return{data:p}}}return maplibregl.VectorTileSource.prototype.ProperLabels=function(s){const t=Object.assign({},s,{map:this._map,source:this});return this._proper||(this._proper=new nt(t)),this._proper},nt}));
