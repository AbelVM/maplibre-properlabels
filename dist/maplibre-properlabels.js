(function(w,b){typeof exports=="object"&&typeof module<"u"?module.exports=b():typeof define=="function"&&define.amd?define(b):(w=typeof globalThis<"u"?globalThis:w||self,w.ProperLabels=b())})(this,(function(){"use strict";var w=typeof document<"u"?document.currentScript:null;const b=`function x(e, r, t = {}) {
...
`,E=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",b],{type:"text/javascript;charset=utf-8"});function I(a){let n;try{if(n=E&&(self.URL||self.webkitURL).createObjectURL(E),!n)throw"";const e=new Worker(n,{type:"module",name:a?.name});return e.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(n)}),e}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(b),{type:"module",name:a?.name})}}const S=`var et = /^-?(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+-]?\\d+)?$/i, Oe = Math.ceil, H = Math.floor, V = "[BigNumber Error] ", Be = V + "Number primitive has more than 15 significant digits: ", J = 1e14, P = 14, Re = 9007199254740991, _e = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], se = 1e7, U = 1e9;
function Ze(i) {
