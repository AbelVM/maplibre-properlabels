"use strict";const Q=23283064365386963e-26,bn=12,nn=typeof TextDecoder>"u"?null:new TextDecoder("utf-8"),K=0,U=1,D=2,q=5;class En{constructor(n=new Uint8Array(16)){this.buf=ArrayBuffer.isView(n)?n:new Uint8Array(n),this.dataView=new DataView(this.buf.buffer),this.pos=0,this.type=0,this.length=this.buf.length}readFields(n,t,o=this.length){for(;this.pos<o;){const r=this.readVarint(),l=r>>3,a=this.pos;this.type=r&7,n(l,t,this),this.pos===a&&this.skip(r)}return t}readMessage(n,t){return this.readFields(n,t,this.readVarint()+this.pos)}readFixed32(){const n=this.dataView.getUint32(this.pos,!0);return this.pos+=4,n}readSFixed32(){const n=this.dataView.getInt32(this.pos,!0);return this.pos+=4,n}readFixed64(){const n=this.dataView.getUint32(this.pos,!0)+this.dataView.getUint32(this.pos+4,!0)*4294967296;return this.pos+=8,n}readSFixed64(){const n=this.dataView.getUint32(this.pos,!0)+this.dataView.getInt32(this.pos+4,!0)*4294967296;return this.pos+=8,n}readFloat(){const n=this.dataView.getFloat32(this.pos,!0);return this.pos+=4,n}readDouble(){const n=this.dataView.getFloat64(this.pos,!0);return this.pos+=8,n}readVarint(n){const t=this.buf;let o,r;return r=t[this.pos++],o=r&127,r<128||(r=t[this.pos++],o|=(r&127)<<7,r<128)||(r=t[this.pos++],o|=(r&127)<<14,r<128)||(r=t[this.pos++],o|=(r&127)<<21,r<128)?o:(r=t[this.pos],o|=(r&15)<<28,Sn(o,n,this))}readVarint64(){return this.readVarint(!0)}readSVarint(){const n=this.readVarint();return n%2===1?(n+1)/-2:n/2}readBoolean(){return!!this.readVarint()}readString(){const n=this.readVarint()+this.pos,t=this.pos;return this.pos=n,n-t>=bn&&nn?nn.decode(this.buf.subarray(t,n)):Cn(this.buf,t,n)}readBytes(){const n=this.readVarint()+this.pos,t=this.buf.subarray(this.pos,n);return this.pos=n,t}readPackedVarint(n=[],t){const o=this.readPackedEnd();for(;this.pos<o;)n.push(this.readVarint(t));return n}readPackedSVarint(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readSVarint());return n}readPackedBoolean(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readBoolean());return n}readPackedFloat(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readFloat());return n}readPackedDouble(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readDouble());return n}readPackedFixed32(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readFixed32());return n}readPackedSFixed32(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readSFixed32());return n}readPackedFixed64(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readFixed64());return n}readPackedSFixed64(n=[]){const t=this.readPackedEnd();for(;this.pos<t;)n.push(this.readSFixed64());return n}readPackedEnd(){return this.type===D?this.readVarint()+this.pos:this.pos+1}skip(n){const t=n&7;if(t===K)for(;this.buf[this.pos++]>127;);else if(t===D)this.pos=this.readVarint()+this.pos;else if(t===q)this.pos+=4;else if(t===U)this.pos+=8;else throw new Error(`Unimplemented type: ${t}`)}writeTag(n,t){this.writeVarint(n<<3|t)}realloc(n){let t=this.length||16;for(;t<this.pos+n;)t*=2;if(t!==this.length){const o=new Uint8Array(t);o.set(this.buf),this.buf=o,this.dataView=new DataView(o.buffer),this.length=t}}finish(){return this.length=this.pos,this.pos=0,this.buf.subarray(0,this.length)}writeFixed32(n){this.realloc(4),this.dataView.setInt32(this.pos,n,!0),this.pos+=4}writeSFixed32(n){this.realloc(4),this.dataView.setInt32(this.pos,n,!0),this.pos+=4}writeFixed64(n){this.realloc(8),this.dataView.setInt32(this.pos,n&-1,!0),this.dataView.setInt32(this.pos+4,Math.floor(n*Q),!0),this.pos+=8}writeSFixed64(n){this.realloc(8),this.dataView.setInt32(this.pos,n&-1,!0),this.dataView.setInt32(this.pos+4,Math.floor(n*Q),!0),this.pos+=8}writeVarint(n){if(n=+n||0,n>268435455||n<0){Pn(n,this);return}this.realloc(4),this.buf[this.pos++]=n&127|(n>127?128:0),!(n<=127)&&(this.buf[this.pos++]=(n>>>=7)&127|(n>127?128:0),!(n<=127)&&(this.buf[this.pos++]=(n>>>=7)&127|(n>127?128:0),!(n<=127)&&(this.buf[this.pos++]=n>>>7&127)))}writeSVarint(n){this.writeVarint(n<0?-n*2-1:n*2)}writeBoolean(n){this.writeVarint(+n)}writeString(n){n=String(n),this.realloc(n.length*4),this.pos++;const t=this.pos;this.pos=In(this.buf,n,this.pos);const o=this.pos-t;o>=128&&tn(t,o,this),this.pos=t-1,this.writeVarint(o),this.pos+=o}writeFloat(n){this.realloc(4),this.dataView.setFloat32(this.pos,n,!0),this.pos+=4}writeDouble(n){this.realloc(8),this.dataView.setFloat64(this.pos,n,!0),this.pos+=8}writeBytes(n){const t=n.length;this.writeVarint(t),this.realloc(t);for(let o=0;o<t;o++)this.buf[this.pos++]=n[o]}writeRawMessage(n,t){this.pos++;const o=this.pos;n(t,this);const r=this.pos-o;r>=128&&tn(o,r,this),this.pos=o-1,this.writeVarint(r),this.pos+=r}writeMessage(n,t,o){this.writeTag(n,D),this.writeRawMessage(t,o)}writePackedVarint(n,t){t.length&&this.writeMessage(n,Mn,t)}writePackedSVarint(n,t){t.length&&this.writeMessage(n,Tn,t)}writePackedBoolean(n,t){t.length&&this.writeMessage(n,Vn,t)}writePackedFloat(n,t){t.length&&this.writeMessage(n,Ln,t)}writePackedDouble(n,t){t.length&&this.writeMessage(n,kn,t)}writePackedFixed32(n,t){t.length&&this.writeMessage(n,An,t)}writePackedSFixed32(n,t){t.length&&this.writeMessage(n,Bn,t)}writePackedFixed64(n,t){t.length&&this.writeMessage(n,Rn,t)}writePackedSFixed64(n,t){t.length&&this.writeMessage(n,On,t)}writeBytesField(n,t){this.writeTag(n,D),this.writeBytes(t)}writeFixed32Field(n,t){this.writeTag(n,q),this.writeFixed32(t)}writeSFixed32Field(n,t){this.writeTag(n,q),this.writeSFixed32(t)}writeFixed64Field(n,t){this.writeTag(n,U),this.writeFixed64(t)}writeSFixed64Field(n,t){this.writeTag(n,U),this.writeSFixed64(t)}writeVarintField(n,t){this.writeTag(n,K),this.writeVarint(t)}writeSVarintField(n,t){this.writeTag(n,K),this.writeSVarint(t)}writeStringField(n,t){this.writeTag(n,D),this.writeString(t)}writeFloatField(n,t){this.writeTag(n,q),this.writeFloat(t)}writeDoubleField(n,t){this.writeTag(n,U),this.writeDouble(t)}writeBooleanField(n,t){this.writeVarintField(n,+t)}}function Sn(i,n,t){const o=t.buf;let r,l;if(l=o[t.pos++],r=(l&112)>>4,l<128||(l=o[t.pos++],r|=(l&127)<<3,l<128)||(l=o[t.pos++],r|=(l&127)<<10,l<128)||(l=o[t.pos++],r|=(l&127)<<17,l<128)||(l=o[t.pos++],r|=(l&127)<<24,l<128)||(l=o[t.pos++],r|=(l&1)<<31,l<128))return I(i,r,n);throw new Error("Expected varint not more than 10 bytes")}function I(i,n,t){return t?n*4294967296+(i>>>0):(n>>>0)*4294967296+(i>>>0)}function Pn(i,n){let t,o;if(i>=0?(t=i%4294967296|0,o=i/4294967296|0):(t=~(-i%4294967296),o=~(-i/4294967296),t^4294967295?t=t+1|0:(t=0,o=o+1|0)),i>=18446744073709552e3||i<-18446744073709552e3)throw new Error("Given varint doesn't fit into 10 bytes");n.realloc(10),Fn(t,o,n),_n(o,n)}function Fn(i,n,t){t.buf[t.pos++]=i&127|128,i>>>=7,t.buf[t.pos++]=i&127|128,i>>>=7,t.buf[t.pos++]=i&127|128,i>>>=7,t.buf[t.pos++]=i&127|128,i>>>=7,t.buf[t.pos]=i&127}function _n(i,n){const t=(i&7)<<4;n.buf[n.pos++]|=t|((i>>>=3)?128:0),i&&(n.buf[n.pos++]=i&127|((i>>>=7)?128:0),i&&(n.buf[n.pos++]=i&127|((i>>>=7)?128:0),i&&(n.buf[n.pos++]=i&127|((i>>>=7)?128:0),i&&(n.buf[n.pos++]=i&127|((i>>>=7)?128:0),i&&(n.buf[n.pos++]=i&127)))))}function tn(i,n,t){const o=n<=16383?1:n<=2097151?2:n<=268435455?3:Math.floor(Math.log(n)/(Math.LN2*7));t.realloc(o);for(let r=t.pos-1;r>=i;r--)t.buf[r+o]=t.buf[r]}function Mn(i,n){for(let t=0;t<i.length;t++)n.writeVarint(i[t])}function Tn(i,n){for(let t=0;t<i.length;t++)n.writeSVarint(i[t])}function Ln(i,n){for(let t=0;t<i.length;t++)n.writeFloat(i[t])}function kn(i,n){for(let t=0;t<i.length;t++)n.writeDouble(i[t])}function Vn(i,n){for(let t=0;t<i.length;t++)n.writeBoolean(i[t])}function An(i,n){for(let t=0;t<i.length;t++)n.writeFixed32(i[t])}function Bn(i,n){for(let t=0;t<i.length;t++)n.writeSFixed32(i[t])}function Rn(i,n){for(let t=0;t<i.length;t++)n.writeFixed64(i[t])}function On(i,n){for(let t=0;t<i.length;t++)n.writeSFixed64(i[t])}function Cn(i,n,t){let o="",r=n;for(;r<t;){const l=i[r];let a=null,c=l>239?4:l>223?3:l>191?2:1;if(r+c>t)break;let p,d,y;c===1?l<128&&(a=l):c===2?(p=i[r+1],(p&192)===128&&(a=(l&31)<<6|p&63,a<=127&&(a=null))):c===3?(p=i[r+1],d=i[r+2],(p&192)===128&&(d&192)===128&&(a=(l&15)<<12|(p&63)<<6|d&63,(a<=2047||a>=55296&&a<=57343)&&(a=null))):c===4&&(p=i[r+1],d=i[r+2],y=i[r+3],(p&192)===128&&(d&192)===128&&(y&192)===128&&(a=(l&15)<<18|(p&63)<<12|(d&63)<<6|y&63,(a<=65535||a>=1114112)&&(a=null))),a===null?(a=65533,c=1):a>65535&&(a-=65536,o+=String.fromCharCode(a>>>10&1023|55296),a=56320|a&1023),o+=String.fromCharCode(a),r+=c}return o}function In(i,n,t){for(let o=0,r,l;o<n.length;o++){if(r=n.charCodeAt(o),r>55295&&r<57344)if(l)if(r<56320){i[t++]=239,i[t++]=191,i[t++]=189,l=r;continue}else r=l-55296<<10|r-56320|65536,l=null;else{r>56319||o+1===n.length?(i[t++]=239,i[t++]=191,i[t++]=189):l=r;continue}else l&&(i[t++]=239,i[t++]=191,i[t++]=189,l=null);r<128?i[t++]=r:(r<2048?i[t++]=r>>6|192:(r<65536?i[t++]=r>>12|224:(i[t++]=r>>18|240,i[t++]=r>>12&63|128),i[t++]=r>>6&63|128),i[t++]=r&63|128)}return t}function R(i,n){this.x=i,this.y=n}R.prototype={clone(){return new R(this.x,this.y)},add(i){return this.clone()._add(i)},sub(i){return this.clone()._sub(i)},multByPoint(i){return this.clone()._multByPoint(i)},divByPoint(i){return this.clone()._divByPoint(i)},mult(i){return this.clone()._mult(i)},div(i){return this.clone()._div(i)},rotate(i){return this.clone()._rotate(i)},rotateAround(i,n){return this.clone()._rotateAround(i,n)},matMult(i){return this.clone()._matMult(i)},unit(){return this.clone()._unit()},perp(){return this.clone()._perp()},round(){return this.clone()._round()},mag(){return Math.sqrt(this.x*this.x+this.y*this.y)},equals(i){return this.x===i.x&&this.y===i.y},dist(i){return Math.sqrt(this.distSqr(i))},distSqr(i){const n=i.x-this.x,t=i.y-this.y;return n*n+t*t},angle(){return Math.atan2(this.y,this.x)},angleTo(i){return Math.atan2(this.y-i.y,this.x-i.x)},angleWith(i){return this.angleWithSep(i.x,i.y)},angleWithSep(i,n){return Math.atan2(this.x*n-this.y*i,this.x*i+this.y*n)},_matMult(i){const n=i[0]*this.x+i[1]*this.y,t=i[2]*this.x+i[3]*this.y;return this.x=n,this.y=t,this},_add(i){return this.x+=i.x,this.y+=i.y,this},_sub(i){return this.x-=i.x,this.y-=i.y,this},_mult(i){return this.x*=i,this.y*=i,this},_div(i){return this.x/=i,this.y/=i,this},_multByPoint(i){return this.x*=i.x,this.y*=i.y,this},_divByPoint(i){return this.x/=i.x,this.y/=i.y,this},_unit(){return this._div(this.mag()),this},_perp(){const i=this.y;return this.y=this.x,this.x=-i,this},_rotate(i){const n=Math.cos(i),t=Math.sin(i),o=n*this.x-t*this.y,r=t*this.x+n*this.y;return this.x=o,this.y=r,this},_rotateAround(i,n){const t=Math.cos(i),o=Math.sin(i),r=n.x+t*(this.x-n.x)-o*(this.y-n.y),l=n.y+o*(this.x-n.x)+t*(this.y-n.y);return this.x=r,this.y=l,this},_round(){return this.x=Math.round(this.x),this.y=Math.round(this.y),this},constructor:R};R.convert=function(i){if(i instanceof R)return i;if(Array.isArray(i))return new R(+i[0],+i[1]);if(i.x!==void 0&&i.y!==void 0)return new R(+i.x,+i.y);throw new Error("Expected [x, y] or {x, y} point format")};class pn{constructor(n,t,o,r,l){this.properties={},this.extent=o,this.type=0,this.id=void 0,this._pbf=n,this._geometry=-1,this._keys=r,this._values=l,n.readFields(Nn,this,t)}loadGeometry(){const n=this._pbf;n.pos=this._geometry;const t=n.readVarint()+n.pos,o=[];let r,l=1,a=0,c=0,p=0;for(;n.pos<t;){if(a<=0){const d=n.readVarint();l=d&7,a=d>>3}if(a--,l===1||l===2)c+=n.readSVarint(),p+=n.readSVarint(),l===1&&(r&&o.push(r),r=[]),r&&r.push(new R(c,p));else if(l===7)r&&r.push(r[0].clone());else throw new Error(`unknown command ${l}`)}return r&&o.push(r),o}bbox(){const n=this._pbf;n.pos=this._geometry;const t=n.readVarint()+n.pos;let o=1,r=0,l=0,a=0,c=1/0,p=-1/0,d=1/0,y=-1/0;for(;n.pos<t;){if(r<=0){const w=n.readVarint();o=w&7,r=w>>3}if(r--,o===1||o===2)l+=n.readSVarint(),a+=n.readSVarint(),l<c&&(c=l),l>p&&(p=l),a<d&&(d=a),a>y&&(y=a);else if(o!==7)throw new Error(`unknown command ${o}`)}return[c,d,p,y]}toGeoJSON(n,t,o){const r=this.extent*Math.pow(2,o),l=this.extent*n,a=this.extent*t,c=this.loadGeometry();function p(u){return[(u.x+l)*360/r-180,360/Math.PI*Math.atan(Math.exp((1-(u.y+a)*2/r)*Math.PI))-90]}function d(u){return u.map(p)}let y;if(this.type===1){const u=[];for(const g of c)u.push(g[0]);const f=d(u);y=u.length===1?{type:"Point",coordinates:f[0]}:{type:"MultiPoint",coordinates:f}}else if(this.type===2){const u=c.map(d);y=u.length===1?{type:"LineString",coordinates:u[0]}:{type:"MultiLineString",coordinates:u}}else if(this.type===3){const u=Gn(c),f=[];for(const g of u)f.push(g.map(d));y=f.length===1?{type:"Polygon",coordinates:f[0]}:{type:"MultiPolygon",coordinates:f}}else throw new Error("unknown feature type");const w={type:"Feature",geometry:y,properties:this.properties};return this.id!=null&&(w.id=this.id),w}}pn.types=["Unknown","Point","LineString","Polygon"];function Nn(i,n,t){i===1?n.id=t.readVarint():i===2?Dn(t,n):i===3?n.type=t.readVarint():i===4&&(n._geometry=t.pos)}function Dn(i,n){const t=i.readVarint()+i.pos;for(;i.pos<t;){const o=n._keys[i.readVarint()],r=n._values[i.readVarint()];n.properties[o]=r}}function Gn(i){const n=i.length;if(n<=1)return[i];const t=[];let o,r;for(let l=0;l<n;l++){const a=Un(i[l]);a!==0&&(r===void 0&&(r=a<0),r===a<0?(o&&t.push(o),o=[i[l]]):o&&o.push(i[l]))}return o&&t.push(o),t}function Un(i){let n=0;for(let t=0,o=i.length,r=o-1,l,a;t<o;r=t++)l=i[t],a=i[r],n+=(a.x-l.x)*(l.y+a.y);return n}class qn{constructor(n,t){this.version=1,this.name="",this.extent=4096,this.length=0,this._pbf=n,this._keys=[],this._values=[],this._features=[],n.readFields(jn,this,t),this.length=this._features.length}feature(n){if(n<0||n>=this._features.length)throw new Error("feature index out of bounds");this._pbf.pos=this._features[n];const t=this._pbf.readVarint()+this._pbf.pos;return new pn(this._pbf,t,this.extent,this._keys,this._values)}}function jn(i,n,t){i===15?n.version=t.readVarint():i===1?n.name=t.readString():i===5?n.extent=t.readVarint():i===2?n._features.push(t.pos):i===3?n._keys.push(t.readString()):i===4&&n._values.push(zn(t))}function zn(i){let n=null;const t=i.readVarint()+i.pos;for(;i.pos<t;){const o=i.readVarint()>>3;n=o===1?i.readString():o===2?i.readFloat():o===3?i.readDouble():o===4?i.readVarint64():o===5?i.readVarint():o===6?i.readSVarint():o===7?i.readBoolean():null}if(n==null)throw new Error("unknown feature value");return n}class $n{constructor(n,t){this.layers=n.readFields(Kn,{},t)}}function Kn(i,n,t){if(i===3){const o=new qn(t,t.readVarint()+t.pos);o.length&&(n[o.name]=o)}}function Wn(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var N={exports:{}},j={};var en;function Jn(){return en||(en=1,j.read=function(i,n,t,o,r){var l,a,c=r*8-o-1,p=(1<<c)-1,d=p>>1,y=-7,w=t?r-1:0,u=t?-1:1,f=i[n+w];for(w+=u,l=f&(1<<-y)-1,f>>=-y,y+=c;y>0;l=l*256+i[n+w],w+=u,y-=8);for(a=l&(1<<-y)-1,l>>=-y,y+=o;y>0;a=a*256+i[n+w],w+=u,y-=8);if(l===0)l=1-d;else{if(l===p)return a?NaN:(f?-1:1)*(1/0);a=a+Math.pow(2,o),l=l-d}return(f?-1:1)*a*Math.pow(2,l-o)},j.write=function(i,n,t,o,r,l){var a,c,p,d=l*8-r-1,y=(1<<d)-1,w=y>>1,u=r===23?Math.pow(2,-24)-Math.pow(2,-77):0,f=o?0:l-1,g=o?1:-1,x=n<0||n===0&&1/n<0?1:0;for(n=Math.abs(n),isNaN(n)||n===1/0?(c=isNaN(n)?1:0,a=y):(a=Math.floor(Math.log(n)/Math.LN2),n*(p=Math.pow(2,-a))<1&&(a--,p*=2),a+w>=1?n+=u/p:n+=u*Math.pow(2,1-w),n*p>=2&&(a++,p/=2),a+w>=y?(c=0,a=y):a+w>=1?(c=(n*p-1)*Math.pow(2,r),a=a+w):(c=n*Math.pow(2,w-1)*Math.pow(2,r),a=0));r>=8;i[t+f]=c&255,f+=g,c/=256,r-=8);for(a=a<<r|c,d+=r;d>0;i[t+f]=a&255,f+=g,a/=256,d-=8);i[t+f-g]|=x*128}),j}var W,rn;function Hn(){if(rn)return W;rn=1,W=n;var i=Jn();function n(e){this.buf=ArrayBuffer.isView&&ArrayBuffer.isView(e)?e:new Uint8Array(e||0),this.pos=0,this.type=0,this.length=this.buf.length}n.Varint=0,n.Fixed64=1,n.Bytes=2,n.Fixed32=5;var t=65536*65536,o=1/t,r=12,l=typeof TextDecoder>"u"?null:new TextDecoder("utf-8");n.prototype={destroy:function(){this.buf=null},readFields:function(e,s,h){for(h=h||this.length;this.pos<h;){var v=this.readVarint(),m=v>>3,E=this.pos;this.type=v&7,e(m,s,this),this.pos===E&&this.skip(v)}return s},readMessage:function(e,s){return this.readFields(e,s,this.readVarint()+this.pos)},readFixed32:function(){var e=S(this.buf,this.pos);return this.pos+=4,e},readSFixed32:function(){var e=L(this.buf,this.pos);return this.pos+=4,e},readFixed64:function(){var e=S(this.buf,this.pos)+S(this.buf,this.pos+4)*t;return this.pos+=8,e},readSFixed64:function(){var e=S(this.buf,this.pos)+L(this.buf,this.pos+4)*t;return this.pos+=8,e},readFloat:function(){var e=i.read(this.buf,this.pos,!0,23,4);return this.pos+=4,e},readDouble:function(){var e=i.read(this.buf,this.pos,!0,52,8);return this.pos+=8,e},readVarint:function(e){var s=this.buf,h,v;return v=s[this.pos++],h=v&127,v<128||(v=s[this.pos++],h|=(v&127)<<7,v<128)||(v=s[this.pos++],h|=(v&127)<<14,v<128)||(v=s[this.pos++],h|=(v&127)<<21,v<128)?h:(v=s[this.pos],h|=(v&15)<<28,a(h,e,this))},readVarint64:function(){return this.readVarint(!0)},readSVarint:function(){var e=this.readVarint();return e%2===1?(e+1)/-2:e/2},readBoolean:function(){return!!this.readVarint()},readString:function(){var e=this.readVarint()+this.pos,s=this.pos;return this.pos=e,e-s>=r&&l?mn(this.buf,s,e):A(this.buf,s,e)},readBytes:function(){var e=this.readVarint()+this.pos,s=this.buf.subarray(this.pos,e);return this.pos=e,s},readPackedVarint:function(e,s){if(this.type!==n.Bytes)return e.push(this.readVarint(s));var h=c(this);for(e=e||[];this.pos<h;)e.push(this.readVarint(s));return e},readPackedSVarint:function(e){if(this.type!==n.Bytes)return e.push(this.readSVarint());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readSVarint());return e},readPackedBoolean:function(e){if(this.type!==n.Bytes)return e.push(this.readBoolean());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readBoolean());return e},readPackedFloat:function(e){if(this.type!==n.Bytes)return e.push(this.readFloat());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readFloat());return e},readPackedDouble:function(e){if(this.type!==n.Bytes)return e.push(this.readDouble());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readDouble());return e},readPackedFixed32:function(e){if(this.type!==n.Bytes)return e.push(this.readFixed32());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readFixed32());return e},readPackedSFixed32:function(e){if(this.type!==n.Bytes)return e.push(this.readSFixed32());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readSFixed32());return e},readPackedFixed64:function(e){if(this.type!==n.Bytes)return e.push(this.readFixed64());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readFixed64());return e},readPackedSFixed64:function(e){if(this.type!==n.Bytes)return e.push(this.readSFixed64());var s=c(this);for(e=e||[];this.pos<s;)e.push(this.readSFixed64());return e},skip:function(e){var s=e&7;if(s===n.Varint)for(;this.buf[this.pos++]>127;);else if(s===n.Bytes)this.pos=this.readVarint()+this.pos;else if(s===n.Fixed32)this.pos+=4;else if(s===n.Fixed64)this.pos+=8;else throw new Error("Unimplemented type: "+s)},writeTag:function(e,s){this.writeVarint(e<<3|s)},realloc:function(e){for(var s=this.length||16;s<this.pos+e;)s*=2;if(s!==this.length){var h=new Uint8Array(s);h.set(this.buf),this.buf=h,this.length=s}},finish:function(){return this.length=this.pos,this.pos=0,this.buf.subarray(0,this.length)},writeFixed32:function(e){this.realloc(4),P(this.buf,e,this.pos),this.pos+=4},writeSFixed32:function(e){this.realloc(4),P(this.buf,e,this.pos),this.pos+=4},writeFixed64:function(e){this.realloc(8),P(this.buf,e&-1,this.pos),P(this.buf,Math.floor(e*o),this.pos+4),this.pos+=8},writeSFixed64:function(e){this.realloc(8),P(this.buf,e&-1,this.pos),P(this.buf,Math.floor(e*o),this.pos+4),this.pos+=8},writeVarint:function(e){if(e=+e||0,e>268435455||e<0){d(e,this);return}this.realloc(4),this.buf[this.pos++]=e&127|(e>127?128:0),!(e<=127)&&(this.buf[this.pos++]=(e>>>=7)&127|(e>127?128:0),!(e<=127)&&(this.buf[this.pos++]=(e>>>=7)&127|(e>127?128:0),!(e<=127)&&(this.buf[this.pos++]=e>>>7&127)))},writeSVarint:function(e){this.writeVarint(e<0?-e*2-1:e*2)},writeBoolean:function(e){this.writeVarint(!!e)},writeString:function(e){e=String(e),this.realloc(e.length*4),this.pos++;var s=this.pos;this.pos=vn(this.buf,e,this.pos);var h=this.pos-s;h>=128&&u(s,h,this),this.pos=s-1,this.writeVarint(h),this.pos+=h},writeFloat:function(e){this.realloc(4),i.write(this.buf,e,this.pos,!0,23,4),this.pos+=4},writeDouble:function(e){this.realloc(8),i.write(this.buf,e,this.pos,!0,52,8),this.pos+=8},writeBytes:function(e){var s=e.length;this.writeVarint(s),this.realloc(s);for(var h=0;h<s;h++)this.buf[this.pos++]=e[h]},writeRawMessage:function(e,s){this.pos++;var h=this.pos;e(s,this);var v=this.pos-h;v>=128&&u(h,v,this),this.pos=h-1,this.writeVarint(v),this.pos+=v},writeMessage:function(e,s,h){this.writeTag(e,n.Bytes),this.writeRawMessage(s,h)},writePackedVarint:function(e,s){s.length&&this.writeMessage(e,f,s)},writePackedSVarint:function(e,s){s.length&&this.writeMessage(e,g,s)},writePackedBoolean:function(e,s){s.length&&this.writeMessage(e,M,s)},writePackedFloat:function(e,s){s.length&&this.writeMessage(e,x,s)},writePackedDouble:function(e,s){s.length&&this.writeMessage(e,F,s)},writePackedFixed32:function(e,s){s.length&&this.writeMessage(e,T,s)},writePackedSFixed32:function(e,s){s.length&&this.writeMessage(e,b,s)},writePackedFixed64:function(e,s){s.length&&this.writeMessage(e,_,s)},writePackedSFixed64:function(e,s){s.length&&this.writeMessage(e,V,s)},writeBytesField:function(e,s){this.writeTag(e,n.Bytes),this.writeBytes(s)},writeFixed32Field:function(e,s){this.writeTag(e,n.Fixed32),this.writeFixed32(s)},writeSFixed32Field:function(e,s){this.writeTag(e,n.Fixed32),this.writeSFixed32(s)},writeFixed64Field:function(e,s){this.writeTag(e,n.Fixed64),this.writeFixed64(s)},writeSFixed64Field:function(e,s){this.writeTag(e,n.Fixed64),this.writeSFixed64(s)},writeVarintField:function(e,s){this.writeTag(e,n.Varint),this.writeVarint(s)},writeSVarintField:function(e,s){this.writeTag(e,n.Varint),this.writeSVarint(s)},writeStringField:function(e,s){this.writeTag(e,n.Bytes),this.writeString(s)},writeFloatField:function(e,s){this.writeTag(e,n.Fixed32),this.writeFloat(s)},writeDoubleField:function(e,s){this.writeTag(e,n.Fixed64),this.writeDouble(s)},writeBooleanField:function(e,s){this.writeVarintField(e,!!s)}};function a(e,s,h){var v=h.buf,m,E;if(E=v[h.pos++],m=(E&112)>>4,E<128||(E=v[h.pos++],m|=(E&127)<<3,E<128)||(E=v[h.pos++],m|=(E&127)<<10,E<128)||(E=v[h.pos++],m|=(E&127)<<17,E<128)||(E=v[h.pos++],m|=(E&127)<<24,E<128)||(E=v[h.pos++],m|=(E&1)<<31,E<128))return p(e,m,s);throw new Error("Expected varint not more than 10 bytes")}function c(e){return e.type===n.Bytes?e.readVarint()+e.pos:e.pos+1}function p(e,s,h){return h?s*4294967296+(e>>>0):(s>>>0)*4294967296+(e>>>0)}function d(e,s){var h,v;if(e>=0?(h=e%4294967296|0,v=e/4294967296|0):(h=~(-e%4294967296),v=~(-e/4294967296),h^4294967295?h=h+1|0:(h=0,v=v+1|0)),e>=18446744073709552e3||e<-18446744073709552e3)throw new Error("Given varint doesn't fit into 10 bytes");s.realloc(10),y(h,v,s),w(v,s)}function y(e,s,h){h.buf[h.pos++]=e&127|128,e>>>=7,h.buf[h.pos++]=e&127|128,e>>>=7,h.buf[h.pos++]=e&127|128,e>>>=7,h.buf[h.pos++]=e&127|128,e>>>=7,h.buf[h.pos]=e&127}function w(e,s){var h=(e&7)<<4;s.buf[s.pos++]|=h|((e>>>=3)?128:0),e&&(s.buf[s.pos++]=e&127|((e>>>=7)?128:0),e&&(s.buf[s.pos++]=e&127|((e>>>=7)?128:0),e&&(s.buf[s.pos++]=e&127|((e>>>=7)?128:0),e&&(s.buf[s.pos++]=e&127|((e>>>=7)?128:0),e&&(s.buf[s.pos++]=e&127)))))}function u(e,s,h){var v=s<=16383?1:s<=2097151?2:s<=268435455?3:Math.floor(Math.log(s)/(Math.LN2*7));h.realloc(v);for(var m=h.pos-1;m>=e;m--)h.buf[m+v]=h.buf[m]}function f(e,s){for(var h=0;h<e.length;h++)s.writeVarint(e[h])}function g(e,s){for(var h=0;h<e.length;h++)s.writeSVarint(e[h])}function x(e,s){for(var h=0;h<e.length;h++)s.writeFloat(e[h])}function F(e,s){for(var h=0;h<e.length;h++)s.writeDouble(e[h])}function M(e,s){for(var h=0;h<e.length;h++)s.writeBoolean(e[h])}function T(e,s){for(var h=0;h<e.length;h++)s.writeFixed32(e[h])}function b(e,s){for(var h=0;h<e.length;h++)s.writeSFixed32(e[h])}function _(e,s){for(var h=0;h<e.length;h++)s.writeFixed64(e[h])}function V(e,s){for(var h=0;h<e.length;h++)s.writeSFixed64(e[h])}function S(e,s){return(e[s]|e[s+1]<<8|e[s+2]<<16)+e[s+3]*16777216}function P(e,s,h){e[h]=s,e[h+1]=s>>>8,e[h+2]=s>>>16,e[h+3]=s>>>24}function L(e,s){return(e[s]|e[s+1]<<8|e[s+2]<<16)+(e[s+3]<<24)}function A(e,s,h){for(var v="",m=s;m<h;){var E=e[m],k=null,O=E>239?4:E>223?3:E>191?2:1;if(m+O>h)break;var B,C,$;O===1?E<128&&(k=E):O===2?(B=e[m+1],(B&192)===128&&(k=(E&31)<<6|B&63,k<=127&&(k=null))):O===3?(B=e[m+1],C=e[m+2],(B&192)===128&&(C&192)===128&&(k=(E&15)<<12|(B&63)<<6|C&63,(k<=2047||k>=55296&&k<=57343)&&(k=null))):O===4&&(B=e[m+1],C=e[m+2],$=e[m+3],(B&192)===128&&(C&192)===128&&($&192)===128&&(k=(E&15)<<18|(B&63)<<12|(C&63)<<6|$&63,(k<=65535||k>=1114112)&&(k=null))),k===null?(k=65533,O=1):k>65535&&(k-=65536,v+=String.fromCharCode(k>>>10&1023|55296),k=56320|k&1023),v+=String.fromCharCode(k),m+=O}return v}function mn(e,s,h){return l.decode(e.subarray(s,h))}function vn(e,s,h){for(var v=0,m,E;v<s.length;v++){if(m=s.charCodeAt(v),m>55295&&m<57344)if(E)if(m<56320){e[h++]=239,e[h++]=191,e[h++]=189,E=m;continue}else m=E-55296<<10|m-56320|65536,E=null;else{m>56319||v+1===s.length?(e[h++]=239,e[h++]=191,e[h++]=189):E=m;continue}else E&&(e[h++]=239,e[h++]=191,e[h++]=189,E=null);m<128?e[h++]=m:(m<2048?e[h++]=m>>6|192:(m<65536?e[h++]=m>>12|224:(e[h++]=m>>18|240,e[h++]=m>>12&63|128),e[h++]=m>>6&63|128),e[h++]=m&63|128)}return h}return W}var J,sn;function dn(){if(sn)return J;sn=1,J=i;function i(n,t){this.x=n,this.y=t}return i.prototype={clone:function(){return new i(this.x,this.y)},add:function(n){return this.clone()._add(n)},sub:function(n){return this.clone()._sub(n)},multByPoint:function(n){return this.clone()._multByPoint(n)},divByPoint:function(n){return this.clone()._divByPoint(n)},mult:function(n){return this.clone()._mult(n)},div:function(n){return this.clone()._div(n)},rotate:function(n){return this.clone()._rotate(n)},rotateAround:function(n,t){return this.clone()._rotateAround(n,t)},matMult:function(n){return this.clone()._matMult(n)},unit:function(){return this.clone()._unit()},perp:function(){return this.clone()._perp()},round:function(){return this.clone()._round()},mag:function(){return Math.sqrt(this.x*this.x+this.y*this.y)},equals:function(n){return this.x===n.x&&this.y===n.y},dist:function(n){return Math.sqrt(this.distSqr(n))},distSqr:function(n){var t=n.x-this.x,o=n.y-this.y;return t*t+o*o},angle:function(){return Math.atan2(this.y,this.x)},angleTo:function(n){return Math.atan2(this.y-n.y,this.x-n.x)},angleWith:function(n){return this.angleWithSep(n.x,n.y)},angleWithSep:function(n,t){return Math.atan2(this.x*t-this.y*n,this.x*n+this.y*t)},_matMult:function(n){var t=n[0]*this.x+n[1]*this.y,o=n[2]*this.x+n[3]*this.y;return this.x=t,this.y=o,this},_add:function(n){return this.x+=n.x,this.y+=n.y,this},_sub:function(n){return this.x-=n.x,this.y-=n.y,this},_mult:function(n){return this.x*=n,this.y*=n,this},_div:function(n){return this.x/=n,this.y/=n,this},_multByPoint:function(n){return this.x*=n.x,this.y*=n.y,this},_divByPoint:function(n){return this.x/=n.x,this.y/=n.y,this},_unit:function(){return this._div(this.mag()),this},_perp:function(){var n=this.y;return this.y=this.x,this.x=-n,this},_rotate:function(n){var t=Math.cos(n),o=Math.sin(n),r=t*this.x-o*this.y,l=o*this.x+t*this.y;return this.x=r,this.y=l,this},_rotateAround:function(n,t){var o=Math.cos(n),r=Math.sin(n),l=t.x+o*(this.x-t.x)-r*(this.y-t.y),a=t.y+r*(this.x-t.x)+o*(this.y-t.y);return this.x=l,this.y=a,this},_round:function(){return this.x=Math.round(this.x),this.y=Math.round(this.y),this}},i.convert=function(n){return n instanceof i?n:Array.isArray(n)?new i(n[0],n[1]):n},J}var G={},H,on;function gn(){if(on)return H;on=1;var i=dn();H=n;function n(a,c,p,d,y){this.properties={},this.extent=p,this.type=0,this._pbf=a,this._geometry=-1,this._keys=d,this._values=y,a.readFields(t,this,c)}function t(a,c,p){a==1?c.id=p.readVarint():a==2?o(p,c):a==3?c.type=p.readVarint():a==4&&(c._geometry=p.pos)}function o(a,c){for(var p=a.readVarint()+a.pos;a.pos<p;){var d=c._keys[a.readVarint()],y=c._values[a.readVarint()];c.properties[d]=y}}n.types=["Unknown","Point","LineString","Polygon"],n.prototype.loadGeometry=function(){var a=this._pbf;a.pos=this._geometry;for(var c=a.readVarint()+a.pos,p=1,d=0,y=0,w=0,u=[],f;a.pos<c;){if(d<=0){var g=a.readVarint();p=g&7,d=g>>3}if(d--,p===1||p===2)y+=a.readSVarint(),w+=a.readSVarint(),p===1&&(f&&u.push(f),f=[]),f.push(new i(y,w));else if(p===7)f&&f.push(f[0].clone());else throw new Error("unknown command "+p)}return f&&u.push(f),u},n.prototype.bbox=function(){var a=this._pbf;a.pos=this._geometry;for(var c=a.readVarint()+a.pos,p=1,d=0,y=0,w=0,u=1/0,f=-1/0,g=1/0,x=-1/0;a.pos<c;){if(d<=0){var F=a.readVarint();p=F&7,d=F>>3}if(d--,p===1||p===2)y+=a.readSVarint(),w+=a.readSVarint(),y<u&&(u=y),y>f&&(f=y),w<g&&(g=w),w>x&&(x=w);else if(p!==7)throw new Error("unknown command "+p)}return[u,g,f,x]},n.prototype.toGeoJSON=function(a,c,p){var d=this.extent*Math.pow(2,p),y=this.extent*a,w=this.extent*c,u=this.loadGeometry(),f=n.types[this.type],g,x;function F(b){for(var _=0;_<b.length;_++){var V=b[_],S=180-(V.y+w)*360/d;b[_]=[(V.x+y)*360/d-180,360/Math.PI*Math.atan(Math.exp(S*Math.PI/180))-90]}}switch(this.type){case 1:var M=[];for(g=0;g<u.length;g++)M[g]=u[g][0];u=M,F(u);break;case 2:for(g=0;g<u.length;g++)F(u[g]);break;case 3:for(u=r(u),g=0;g<u.length;g++)for(x=0;x<u[g].length;x++)F(u[g][x]);break}u.length===1?u=u[0]:f="Multi"+f;var T={type:"Feature",geometry:{type:f,coordinates:u},properties:this.properties};return"id"in this&&(T.id=this.id),T};function r(a){var c=a.length;if(c<=1)return[a];for(var p=[],d,y,w=0;w<c;w++){var u=l(a[w]);u!==0&&(y===void 0&&(y=u<0),y===u<0?(d&&p.push(d),d=[a[w]]):d.push(a[w]))}return d&&p.push(d),p}function l(a){for(var c=0,p=0,d=a.length,y=d-1,w,u;p<d;y=p++)w=a[p],u=a[y],c+=(u.x-w.x)*(w.y+u.y);return c}return H}var X,an;function yn(){if(an)return X;an=1;var i=gn();X=n;function n(r,l){this.version=1,this.name=null,this.extent=4096,this.length=0,this._pbf=r,this._keys=[],this._values=[],this._features=[],r.readFields(t,this,l),this.length=this._features.length}function t(r,l,a){r===15?l.version=a.readVarint():r===1?l.name=a.readString():r===5?l.extent=a.readVarint():r===2?l._features.push(a.pos):r===3?l._keys.push(a.readString()):r===4&&l._values.push(o(a))}function o(r){for(var l=null,a=r.readVarint()+r.pos;r.pos<a;){var c=r.readVarint()>>3;l=c===1?r.readString():c===2?r.readFloat():c===3?r.readDouble():c===4?r.readVarint64():c===5?r.readVarint():c===6?r.readSVarint():c===7?r.readBoolean():null}return l}return n.prototype.feature=function(r){if(r<0||r>=this._features.length)throw new Error("feature index out of bounds");this._pbf.pos=this._features[r];var l=this._pbf.readVarint()+this._pbf.pos;return new i(this._pbf,l,this.extent,this._keys,this._values)},X}var Y,ln;function Xn(){if(ln)return Y;ln=1;var i=yn();Y=n;function n(o,r){this.layers=o.readFields(t,{},r)}function t(o,r,l){if(o===3){var a=new i(l,l.readVarint()+l.pos);a.length&&(r[a.name]=a)}}return Y}var hn;function Yn(){return hn||(hn=1,G.VectorTile=Xn(),G.VectorTileFeature=gn(),G.VectorTileLayer=yn()),G}var Z,un;function Zn(){if(un)return Z;un=1;var i=dn(),n=Yn().VectorTileFeature;Z=t;function t(r,l){this.options=l||{},this.features=r,this.length=r.length}t.prototype.feature=function(r){return new o(this.features[r],this.options.extent)};function o(r,l){this.id=typeof r.id=="number"?r.id:void 0,this.type=r.type,this.rawGeometry=r.type===1?[r.geometry]:r.geometry,this.properties=r.tags,this.extent=l||4096}return o.prototype.loadGeometry=function(){var r=this.rawGeometry;this.geometry=[];for(var l=0;l<r.length;l++){for(var a=r[l],c=[],p=0;p<a.length;p++)c.push(new i(a[p][0],a[p][1]));this.geometry.push(c)}return this.geometry},o.prototype.bbox=function(){this.geometry||this.loadGeometry();for(var r=this.geometry,l=1/0,a=-1/0,c=1/0,p=-1/0,d=0;d<r.length;d++)for(var y=r[d],w=0;w<y.length;w++){var u=y[w];l=Math.min(l,u.x),a=Math.max(a,u.x),c=Math.min(c,u.y),p=Math.max(p,u.y)}return[l,c,a,p]},o.prototype.toGeoJSON=n.prototype.toGeoJSON,Z}var fn;function Qn(){if(fn)return N.exports;fn=1;var i=Hn(),n=Zn();N.exports=t,N.exports.fromVectorTileJs=t,N.exports.fromGeojsonVt=o,N.exports.GeoJSONWrapper=n;function t(u){var f=new i;return r(u,f),f.finish()}function o(u,f){f=f||{};var g={};for(var x in u)g[x]=new n(u[x].features,f),g[x].name=x,g[x].version=f.version,g[x].extent=f.extent;return t({layers:g})}function r(u,f){for(var g in u.layers)f.writeMessage(3,l,u.layers[g])}function l(u,f){f.writeVarintField(15,u.version||1),f.writeStringField(1,u.name||""),f.writeVarintField(5,u.extent||4096);var g,x={keys:[],values:[],keycache:{},valuecache:{}};for(g=0;g<u.length;g++)x.feature=u.feature(g),f.writeMessage(2,a,x);var F=x.keys;for(g=0;g<F.length;g++)f.writeStringField(3,F[g]);var M=x.values;for(g=0;g<M.length;g++)f.writeMessage(4,w,M[g])}function a(u,f){var g=u.feature;g.id!==void 0&&f.writeVarintField(1,g.id),f.writeMessage(2,c,u),f.writeVarintField(3,g.type),f.writeMessage(4,y,g)}function c(u,f){var g=u.feature,x=u.keys,F=u.values,M=u.keycache,T=u.valuecache;for(var b in g.properties){var _=g.properties[b],V=M[b];if(_!==null){typeof V>"u"&&(x.push(b),V=x.length-1,M[b]=V),f.writeVarint(V);var S=typeof _;S!=="string"&&S!=="boolean"&&S!=="number"&&(_=JSON.stringify(_));var P=S+":"+_,L=T[P];typeof L>"u"&&(F.push(_),L=F.length-1,T[P]=L),f.writeVarint(L)}}}function p(u,f){return(f<<3)+(u&7)}function d(u){return u<<1^u>>31}function y(u,f){for(var g=u.loadGeometry(),x=u.type,F=0,M=0,T=g.length,b=0;b<T;b++){var _=g[b],V=1;x===1&&(V=_.length),f.writeVarint(p(1,V));for(var S=x===3?_.length-1:_.length,P=0;P<S;P++){P===1&&x!==1&&f.writeVarint(p(2,S-1));var L=_[P].x-F,A=_[P].y-M;f.writeVarint(d(L)),f.writeVarint(d(A)),F+=L,M+=A}x===3&&f.writeVarint(p(7,1))}}function w(u,f){var g=typeof u;g==="string"?f.writeStringField(1,u):g==="boolean"?f.writeBooleanField(7,u):g==="number"&&(u%1!==0?f.writeDoubleField(3,u):u<0?f.writeSVarintField(6,u):f.writeVarintField(5,u))}return N.exports}var nt=Qn();const tt=Wn(nt),xn=`var ut = /^-?(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+-]?\\d+)?$/i, Oe = Math.ceil, W = Math.floor, J = "[BigNumber Error] ", De = J + "Number primitive has more than 15 significant digits: ", j = 1e14, C = 14, Ae = 9007199254740991, Re = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], oe = 1e7, K = 1e9;
function je(n) {
...
`,cn=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",xn],{type:"text/javascript;charset=utf-8"});function et(i){let n;try{if(n=cn&&(self.URL||self.webkitURL).createObjectURL(cn),!n)throw"";const t=new Worker(n,{type:"module",name:i?.name});return t.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(n)}),t}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(xn),{type:"module",name:i?.name})}}class z{constructor(){this.map=new Map}static _nextPow2(n){return n<=0?0:(n=n-1>>>0,n|=n>>1,n|=n>>2,n|=n>>4,n|=n>>8,n|=n>>16,n+1>>>0)}rent(n){const t=z._nextPow2(n||1),o=this.map.get(t);return o&&o.length?o.pop():new ArrayBuffer(t)}release(n){if(!n||!n.byteLength)return;const t=z._nextPow2(n.byteLength);let o=this.map.get(t);o||(o=[],this.map.set(t,o)),o.push(n)}}function it(i,n={}){const t=[],o=[],r=[],l=new TextEncoder,a=[],c=new Map;let p=0,d=0;const y=x=>{Array.isArray(x)?o.push(x[0]||0,x[1]||0):x&&typeof x.x=="number"&&typeof x.y=="number"?o.push(x.x,x.y):o.push(0,0)};for(const x of i){const F=x.id==null?"":String(x.id),M=x.geometry||{},T=M.type||"Unknown",b={id:F,type:T,coordsOffset:p,coordsLength:0};if(T==="Point"){const S=M.coordinates||[];y(S),b.coordsLength=2}else if(T==="LineString"||T==="MultiPoint"){const S=M.coordinates||[];for(const P of S)y(P);b.coordsLength=(S.length||0)*2}else if(T==="Polygon"){const S=M.coordinates||[];b.ringLengths=[];for(const P of S){b.ringLengths.push(P.length||0);for(const L of P)y(L)}b.coordsLength=b.ringLengths.reduce((P,L)=>P+L,0)*2}else if(T==="MultiPolygon"){const S=M.coordinates||[];b.polygonRingCounts=[],b.ringLengths=[];for(const P of S){b.polygonRingCounts.push(P.length||0);for(const L of P){b.ringLengths.push(L.length||0);for(const A of L)y(A)}}b.coordsLength=b.ringLengths.reduce((P,L)=>P+L,0)*2}else b.coordsLength=0;const _=x.properties||{},V=[];for(const S of Object.keys(_)){let P=c.get(S);P===void 0&&(P=a.length,a.push(S),c.set(S,P));const L=JSON.stringify(_[S]),A=l.encode(L);r.push(A),V.push([P,d,A.length]),d+=A.length}b.props=V,p+=b.coordsLength,t.push(b)}let w;if(n.propsBuffer)n.propsBuffer instanceof Uint8Array?w=n.propsBuffer.subarray(0,d):w=new Uint8Array(n.propsBuffer,0,d),w.byteLength<d&&(w=new Uint8Array(d));else if(n.pool){const x=n.pool.rent(d||1);w=new Uint8Array(x,0,d)}else w=new Uint8Array(d);let u=0;for(const x of r)w.set(x,u),u+=x.length;const f=o.length;let g;if(n.coordsBuffer)n.coordsBuffer instanceof ArrayBuffer?g=new Float32Array(n.coordsBuffer,0,f):n.coordsBuffer instanceof Float32Array?g=n.coordsBuffer.subarray(0,f):g=new Float32Array(f),g.length<f&&(g=new Float32Array(f));else if(n.pool){const x=n.pool.rent(f*4||4);g=new Float32Array(x,0,f)}else g=new Float32Array(f);return g.length>0&&g.set(o),{meta:t,keys:a,propsBuffer:w,coordsArray:g}}function rt(i,n,t,o){const r=t instanceof Float32Array?t:new Float32Array(t),l=n instanceof Uint8Array?n:n?new Uint8Array(n):new Uint8Array(0),a=new TextDecoder,c=[];for(let p=0;p<(i.length||0);p++){const d=i[p]||{},y=d.id,w={};if(Array.isArray(d.props)&&d.props.length&&o&&o.length)for(const F of d.props){const[M,T,b]=F;try{const _=l.subarray(T,T+b);w[o[M]]=JSON.parse(a.decode(_))}catch{}}const u=d.type||"Unknown";let f=d.coordsOffset||0;const g=f+(d.coordsLength||0);let x=null;if(u==="Point")x={type:"Point",coordinates:[r[f]||0,r[f+1]||0]};else if(u==="LineString"||u==="MultiPoint"){const F=[];for(;f<g;f+=2)F.push([r[f],r[f+1]]);x={type:u,coordinates:F}}else if(u==="Polygon"){const F=[],M=d.ringLengths||[];for(const T of M){const b=[];for(let _=0;_<T;_++)b.push([r[f],r[f+1]]),f+=2;F.push(b)}x={type:"Polygon",coordinates:F}}else if(u==="MultiPolygon"){const F=[],M=d.polygonRingCounts||[],T=d.ringLengths||[];let b=0;for(const _ of M){const V=[];for(let S=0;S<_;S++){const P=T[b++]||0,L=[];for(let A=0;A<P;A++)L.push([r[f],r[f+1]]),f+=2;V.push(L)}F.push(V)}x={type:"MultiPolygon",coordinates:F}}else f<g&&(x={type:"Point",coordinates:[r[f],r[f+1]]});c.push({id:y,geometry:x,properties:w})}return c}class wn{constructor(n){return this.map=n.map,this.source=n.source instanceof maplibregl.VectorTileSource?n.source:this.map.getSource(n.source),this.sourceLayer=n.sourceLayer,this.fid=n.fid||"id",this.tiles=this.source.tiles.map(t=>t.split("{z}")[0]),this.tileSize=this.source.tileSize||512,this.tolerance=n.tolerance||1e-5,this.minion=new et,this._abPool=new z,this.minion.onmessage=t=>{const o=t&&t.data;if(o)if(o.type==="geojson_bin"&&o.coords)try{const r=o.coords instanceof Uint8Array?o.coords.buffer:o.coords,l=o.propsBuf!==void 0?o.propsBuf:null,a=rt(o.meta||[],l,r,o.keys||[]);this.gjsource.setData({type:"FeatureCollection",features:a});try{l&&this._abPool.release(l instanceof ArrayBuffer?l:l.buffer)}catch{}try{r&&this._abPool.release(r instanceof ArrayBuffer?r:r.buffer)}catch{}}catch(r){console.warn("Failed to decode binary worker response",r)}else if(o.type==="geojson"&&o.payload)try{const r=o.payload instanceof Uint8Array?o.payload.buffer:o.payload,l=new TextDecoder().decode(r),a=JSON.parse(l);this.gjsource.setData(a)}catch(r){console.warn("Failed to decode worker response",r)}else try{this.gjsource.setData(o)}catch(r){console.warn("Failed to set worker data",r)}},this.map.addSource(this.source.id+"-proper",{type:"geojson",maxzoom:this.source.maxzoom,promoteId:this.fid,data:{}}),this.gjsource=this.map.getSource(this.source.id+"-proper"),maplibregl.addProtocol("proper",this._protocol),this.map.setTransformRequest((t,o)=>this.tiles.some(l=>t.startsWith(l))&&o==="Tile"?{url:"proper://"+t}:{url:t}),this._pendingPost=null,this._postTimer=null,this._postDelay=n.postDelay||100,this.map.on("sourcedata",t=>{if(t.sourceId===this.source.id&&t.isSourceLoaded){const o=this.map.querySourceFeatures(this.source.id,{sourceLayer:this.sourceLayer}),r=t.tile.tileID.canonical.z,l=this.tolerance*Math.pow(10,-.301*r+5.19),a={features:o.map(c=>({id:c.id,geometry:c.geometry,properties:c.properties})),tolerance:l};this._pendingPost=a,this._postTimer==null&&(this._postTimer=setTimeout(()=>{try{if(this._pendingPost)try{const{meta:c,keys:p,propsBuffer:d,coordsArray:y}=it(this._pendingPost.features||[],{pool:this._abPool});this.minion.postMessage({type:"features_bin",meta:c,keys:p,propsBuf:d.buffer,tolerance:this._pendingPost.tolerance,coords:y.buffer},[d.buffer,y.buffer])}catch{try{const p=new TextEncoder,d=JSON.stringify(this._pendingPost),y=p.encode(d);this.minion.postMessage({type:"features",payload:y.buffer},[y.buffer])}catch{this.minion.postMessage(this._pendingPost)}}}finally{this._pendingPost=null,this._postTimer=null}},this._postDelay))}}),this.map.refreshTiles(this.source.id),this.gjsource}_protocol=async n=>{const o=n.url.replace("proper://",""),r=n.url.split(/\/|\./i);if(r===null||r.length<4)return console.warn(`Malformed URL: ${n.url}`),{data:null};const l=await fetch(o);if(!l.ok)return console.warn(`Failed to fetch tile: ${l.statusText}`),{data:null};const a=r.length,[c,p,d]=r.slice(a-4,a-1).map(x=>x*1),y=await l.arrayBuffer(),w=new $n(new En(y)),u={layers:Object.entries(w.layers).reduce((x,[F,M])=>({...x,[F]:{...M,feature:T=>{const b=M.feature(T),V=b.loadGeometry().flat(1/0).some(S=>S.x>=M.extent-1||S.y>=M.extent-1||S.x<=1||S.y<=1);return b.properties.clipped=V,b}}}),{})};return{data:tt(u).buffer}}}maplibregl.VectorTileSource.prototype.ProperLabels=function(i){return this._proper||(this._proper=new wn({map:this._map,source:this})),this._proper};module.exports=wn;
