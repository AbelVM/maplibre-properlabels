...
console.log('pending', manager._pendingTiles.size, 'queued', manager._tileQueue.length);
manager._tileScheduler.flush();
console.log('after flush pending', manager._pendingTiles.size, 'queued', manager._tileQueue.length);
